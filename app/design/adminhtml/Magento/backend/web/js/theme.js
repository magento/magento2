...
define('globalNavigationScroll', ['jquery'], function($) {
  'use strict';
...
define('globalNavigation', [
  ...
  $.widget('mage.globalNavigation', {
    ...
    _initOverlay: function() {
      this.overlay = $(this.options.overlayTmpl)
        .appendTo('body')
        .hide(0);
    ...
    _bind: function() {
      ...
      this.menuLinks.on('focus', focus).on('click', open);
...
define('globalSearch', ['jquery', 'jquery/ui'], function($) {
  'use strict';
...
define('modalPopup', ['jquery', 'jquery/ui'], function($) {
  'use strict';
  ...
  $.widget('mage.modalPopup', {
    ...
    _events: function() {
      ...
      this.btnDismiss.on('click.dismissModalPopup', function() {
        self.fade.remove();
      });

      this.btnHide.on('click.hideModalPopup', function() {
        self.fade.hide();
      });
    },
  });
...
define('useDefault', ['jquery', 'jquery/ui'], function($) {
  'use strict';
...
define('loadingPopup', ['jquery', 'jquery/ui'], function($) {
  'use strict';
...
define('collapsable', ['jquery', 'jquery/ui', 'jquery/jquery.tabs'], function(
  $,
) {
  'use strict';
