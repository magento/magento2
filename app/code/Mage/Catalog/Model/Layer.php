...
class Mage_Catalog_Model_Layer extends Varien_Object
{
    ...
    public function setCurrentCategory($category)
    {
        ...
        if (!$category instanceof Mage_Catalog_Model_Category) {
            Mage::throwException(Mage::helper('Mage_Catalog_Helper_Data')->__('The category must be an instance of Mage_Catalog_Model_Category.'));
        }
        if (!$category->getId()) {
            Mage::throwException(Mage::helper('Mage_Catalog_Helper_Data')->__('Please correct the category.'));
        }
