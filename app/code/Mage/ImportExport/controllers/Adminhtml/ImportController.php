...
class Mage_ImportExport_Adminhtml_ImportController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function startAction()
    {
        ...
        if ($data) {
            ...
            $importModel = $this->_objectManager->create('Mage_ImportExport_Model_Import');
    ...
    public function validateAction()
    {
        ...
        if ($data) {
            ...
            try {
                ...
                $import = $this->_objectManager->create('Mage_ImportExport_Model_Import')->setData($data);
     ...
     * @param Mage_ImportExport_Block_Adminhtml_Import_Frame_Result $resultBlock
     */
    protected function _processValidationError(Mage_ImportExport_Model_Import $import,
        Mage_ImportExport_Block_Adminhtml_Import_Frame_Result $resultBlock
    ) {
