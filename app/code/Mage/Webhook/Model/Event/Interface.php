 ...
 */
interface Mage_Webhook_Model_Event_Interface
{
    /**
     * type of Event for synchronous case
     */
    const EVENT_TYPE_CALLBACK = 'callback';

    /**
     * type of Event which has asynchronous nature
     */
    const EVENT_TYPE_INFORM = 'inform';
