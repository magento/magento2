...
class Factory
{
     ...
     */
    protected $_typeMap = [
        self::MAPPER_SORTING => Sorting::class,
        self::MAPPER_PATH => Path::class,
        self::MAPPER_IGNORE => Ignore::class,
        self::MAPPER_DEPENDENCIES => Dependencies::class,
        self::MAPPER_ATTRIBUTE_INHERITANCE => Attribute\Inheritance::class,
        self::MAPPER_EXTENDS => ExtendsMapper::class,
    ];
