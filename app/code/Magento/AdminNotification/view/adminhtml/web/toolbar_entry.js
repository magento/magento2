...
define(['jquery', 'jquery/ui', 'domReady!'], function($) {
  ...
  var markNotificationAsRead = function(notificationId) {
    ...
    notificationCount = $('.notifications-wrapper').attr(
    ...
    removeNotificationFromList = function(notificationEntry) {
      ...
      if (notificationCount == 0) {
        ...
        actionElement = $(
          '.notifications-wrapper .admin__action-dropdown-menu .last .action-more',
        );
        actionElement.text(
          actionElement.text().replace(/\d+/, notificationCount),
        );
      }
    },
    /**
    ...
    showNotificationDetails = function(notificationEntry) {
      var notificationDescription = notificationEntry.find(
          '.notifications-entry-description',
        ),
        notificationDescriptionEnd = notificationEntry.find(
  ...
  $(
    '.notifications-wrapper .admin__action-dropdown-menu .notifications-entry',
  ).on('click.showNotification', function(event) {
