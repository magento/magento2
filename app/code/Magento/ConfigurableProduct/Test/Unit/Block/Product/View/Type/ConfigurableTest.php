...
class ConfigurableTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->product = $this->getMockBuilder(ProductHelper::class)
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->block = new ConfigurableBlock(
            $this->context,
            $this->arrayUtils,
            $this->jsonEncoder,
            $this->helper,
     ...
     * @return MockObject
     */
    protected function getTierPriceMock(MockObject $amountMock, $priceQty, $percentage): MockObject
    {
        $tierPrice = [
            'price_qty' => $priceQty,
            'price' => $amountMock,
