...
define([
  ...
  return dynamicRows.extend({
     ...
     */
    initialize: function() {
      this._super().changeVisibility(this.isEmpty());
    ...
    openModalWithGrid: function(rowIndex) {
      var productSource = this.source.get(
    ...
    processingUnionInsertData: function(data) {
      ...
      _.each(
        ...
        function(row, index) {
          path =
            this.dataScope + '.' + this.index + '.' + (this.startIndex + index);
    ...
    processingInsertDataFromGrid: function(data) {
      ...
      changes.each(function(changedObject) {
        ...
        mappedData['configurable_attribute'] = this._getConfigurableAttribute(
          changedObject,
        );
    ...
    processingInsertDataFromWizard: function(data) {
      ...
      tmpArray = this.unsetArrayItem(tmpArray, {
        id: null,
      });
