...
define(['uiComponent', 'jquery', 'underscore', 'mage/translate'], function(
  Component,
  $,
  _,
) {
  ...
  return Component.extend({
      ...
      _.each(
        ...
        function(attributeId) {
          ...
          if (!this.attributesLabels[attributeId]) {
            ...
            if (attribute) {
              this.attributesLabels[attribute['attribute_id']] =
    ...
    force: function(wizard) {
      ...
      if (
        !wizard.data.attributesIds() ||
        wizard.data.attributesIds().length === 0
      ) {
