...
define(['underscore', 'Magento_Ui/js/form/components/insert-listing'], function(
  _,
  insertListing,
) {
  'use strict';
  ...
  return insertListing.extend({
    defaults: {
      ...
      listens: {
        '${ $.externalProvider }:params':
          '_setFilters _setVisibilityMassActionColumn',
    ...
    initObservable: function() {
      this._super().observe('changeProductData');
    ...
    _setFilters: function(params) {
      ...
      if (!this.paramsUpdated) {
        ...
        if (this.typeGrid === 'changeProduct') {
          ...
          filterModifier = _.extend(
            filterModifier,
            _.mapObject(attributes, function(value) {
              return {
                condition_type: 'eq',
                value: value,
              };
