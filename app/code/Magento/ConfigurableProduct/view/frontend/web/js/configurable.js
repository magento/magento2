...
define([
  ...
  $.widget('mage.configurable', {
        ...
        for (i = 0; i < options.length; i++) {
          ...
          if (prevConfig) {
            ...
            if (
              ...
              allowedProductMinPrice = this._getAllowedProductWithMinPrice(
                allowedProducts,
              );
              optionFinalPrice = parseFloat(
                optionPrices[allowedProductMinPrice].finalPrice.amount,
              );
    ...
    _calculatePrice: function(config) {
      var displayPrices = $(this.options.priceHolderSelector).priceBox('option')
          .prices,
        newPrices = this.options.spConfig.optionPrices[
