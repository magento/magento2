...
class MessagePluginTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAfterRenderResult()
    {
        ...
        $this->cookieManagerMock->expects($this->once())
            ...
            ->with(
                ...
                $this->jsonSerializer->serialize($messages),
                $cookieMetadataMock
            );
        $this->cookieManagerMock->expects($this->once())
            ->method('getCookie')
            ...
            ->willReturn($this->jsonSerializer->serialize($existingMessages));
    ...
    public function testAfterRenderResultWithNoMessages()
    {
        ...
        $this->cookieManagerMock->expects($this->once())
            ...
            ->willReturn($this->jsonSerializer->serialize([]));
    ...
    public function testAfterRenderResultWithWrongArray()
    {
        ...
        $this->cookieManagerMock->expects($this->once())
            ...
            ->willReturn($this->jsonSerializer->serialize('string'));
