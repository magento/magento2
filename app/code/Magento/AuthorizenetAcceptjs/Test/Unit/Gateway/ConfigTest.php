...
class ConfigTest extends TestCase
{
     ...
     * @return void
     */
    public function testConfigGetters(string $getterName, string $configField, $configValue, $expectedValue)
    {
     ...
     * @return void
     */
    public function testGetApiUrl(string $environment, string $expectedUrl)
    {
        $this->scopeConfigMock->method('getValue')
     ...
     * @param string $environment
     * @param string $expectedSolution
     */
    public function testGetSolutionIdSandbox(string $environment, string $expectedSolution)
    {
        $this->scopeConfigMock->method('getValue')
            ->with($this->getPath('environment'), ScopeInterface::SCOPE_STORE, 123)
            ->willReturn($environment);
     ...
     * @return array
     */
    public function configMapProvider(): array
    {
        return [
     ...
     * @return array
     */
    public function environmentUrlProvider(): array
    {
        return [
     ...
     * @return array
     */
    public function environmentSolutionProvider(): array
    {
        return [
            ['sandbox', 'AAA102993'],
