...
/**
 * Test for Magento\AuthorizenetAcceptjs\Test\Unit\Gateway\Request\AddressDataBuilder
 */
class AddressDataBuilderTest extends TestCase
{
     ...
     * @return void
     */
    private function validateAddressData(array $responseData, string $addressPrefix)
    {
     ...
     */
    private function createAddressMock(string $prefix)
    {
