...
class ConfigProviderPayPal implements ConfigProviderInterface
{
     ...
     * @return bool
     */
    private function isCaseSensitive($formId)
    {
     ...
     * @return int
     */
    private function getImageHeight($formId)
    {
     ...
     * @return string
     */
    private function getImageSrc($formId)
    {
     ...
     * @return bool
     */
    private function isRequired($formId)
    {
     ...
     */
    private function getCaptchaModel($formId)
    {
