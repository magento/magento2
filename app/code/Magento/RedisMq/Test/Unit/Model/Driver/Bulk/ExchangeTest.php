...
namespace Magento\RedisMq\Test\Unit\Model\Driver\Bulk;
...
class ExchangeTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \Magento\RedisMq\Model\QueueManagement|\PHPUnit_Framework_MockObject_MockObject
     */
    private $queueManagement;

    /**
     * @var \Magento\RedisMq\Model\Driver\Bulk\Exchange
     */
    private $exchange;
    /**
     * @var \Magento\RedisMq\Model\ConnectionTypeResolver|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    protected function setUp()
    {
        ...
        $this->queueManagement = $this->getMockBuilder(\Magento\RedisMq\Model\QueueManagement::class)
            ->disableOriginalConstructor()->getMock();
        $this->connnectionTypeResolver = $this->getMockBuilder(\Magento\RedisMq\Model\ConnectionTypeResolver::class)
            ->disableOriginalConstructor()->getMock();

        $objectManager = new \Magento\Framework\TestFramework\Unit\Helper\ObjectManager($this);
        $this->exchange = $objectManager->getObject(
            \Magento\RedisMq\Model\Driver\Bulk\Exchange::class,
            [
