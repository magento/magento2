...
define([
  ...
  $.widget('mage.groupedProduct', {
    ...
    _add: function(event, product) {
      var tmpl, productExists;

      productExists = this.$grid
        .find('[data-role=id]')
     ...
     */
    _resort: function() {
      this.element.find('[data-role=position]').each(
      ...
      $('#' + gridPopup.containerId)
        ...
        .on('gridajax', function(event, ajaxRequest) {
          ajaxRequest.done(function() {
            popup
              .find('[data-role=row] [data-column=entity_ids] input')
