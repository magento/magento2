...
/**
 * Test StockRegistryInterface::getStockStatus() for grouped product type.
 */
class GetStockStatusTest extends TestCase
{
    ...
    /**
     * Check, grouped product has correct stock status configuration on default source.
     *
    ...
    public function testGetStatusOnDefaultSource()
    {
        ...
        $productIds = $this->getProductIdsBySkus->execute(['grouped-product']);
