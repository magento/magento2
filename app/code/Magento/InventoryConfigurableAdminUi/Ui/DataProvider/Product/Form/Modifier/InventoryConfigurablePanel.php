...
namespace Magento\InventoryConfigurableAdminUi\Ui\DataProvider\Product\Form\Modifier;
        ...
        return [
            'arguments' => [
                'data' => [
                    'config' => [
                        'componentType' => 'text',
                        'component' => 'Magento_InventoryConfigurableAdminUi/js/form/element/quantity-per-source',
    ...
    public function modifyMeta(array $meta)
    {
        if ($this->isSingleSourceMode->execute() === false) {
            ...
            [ConfigurablePanel::CONFIGURABLE_MATRIX]['arguments']['data']['config']['component']
                = 'Magento_InventoryConfigurableAdminUi/js/components/dynamic-rows-configurable';
        }
