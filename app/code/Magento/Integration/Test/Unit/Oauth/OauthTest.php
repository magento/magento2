...
class OauthTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->setExpectedException(\Magento\Framework\Oauth\OauthInputException::class);
    ...
    {
        $this->setExpectedException(\Magento\Framework\Oauth\OauthInputException::class, '"oauth_verifier" is required. Enter and try again.');
