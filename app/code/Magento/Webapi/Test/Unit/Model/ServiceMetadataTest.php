...
class ServiceMetadataTest extends TestCase
{
    ...
    public function testInitRoutesMetadata()
    {
        ...
        $this->config->method('getServices')
            ->willReturn([
                    'routes' => ['/V1/customers/:customerId' => ['GET' => [
                        'service' => [
                            'class' => 'Magento\\Customer\\Api\\CustomerRepositoryInterface', 'method' => 'getById',],
                        'resources' => ['Magento_Customer::customer' => true,], 'parameters' => [],
                    ], 'PUT' => [
                        'service' => [
                            'class' => 'Magento\\Customer\\Api\\CustomerRepositoryInterface', 'method' => 'save',
                        ],
                        'resources' => ['Magento_Customer::manage' => true,], 'parameters' => [],
                    ], 'DELETE' => [
                        'service' => [
                        ...
                        '/V1/customers/me' => [
                            'PUT' => [
                                ...
                                'resources' => ['self' => true,],
                                'parameters' => [
                                    'customer.id' => ['force' => true, 'value' => '%customer_id%',],
                                ],
                            ],
                            'GET' => [
                                'service' => [
                                ...
                                'resources' => ['self' => true,],
                                'parameters' => [
                                    'customerId' => ['force' => true, 'value' => '%customer_id%',],
                                ],
                            ],
                        ],
                        '/V1/customers/search' => [
                    ...
                    'services' => [
                        'Magento\\Customer\\Api\\CustomerRepositoryInterface' => [
                            'V1' => [
                                'methods' => [
                                    'getById' => [
                                        'resources' => [0 => 'Magento_Customer::customer',],
                                        'realMethod' => 'getById', 'secure' => false, 'parameters' => [],
                                    ],
                                    'save' => [
                                        'resources' => [0 => 'Magento_Customer::manage',],
                                        'realMethod' => 'save', 'secure' => false, 'parameters' => [],
                                    ],
                                    'saveSelf' => [
                                        'resources' => [0 => 'self',], 'realMethod' => 'save', 'secure' => false,
                                        'parameters' => [
                                            'customer.id' => ['force' => true, 'value' => '%customer_id%',],
                                        ],
                                    ],
                                    ...
                                    'getList' => [
                                        'resources' => [0 => 'Magento_Customer::customer',],
                                        'realMethod' => 'getList', 'secure' => false, 'parameters' => [],
                                    ],
                                    'deleteById' => [
                                        'resources' => [0 => 'Magento_Customer::manage',],
                                        'realMethod' => 'deleteById', 'secure' => false, 'parameters' => [],
                                    ],
                                ],
                            ],
                        ],
