...
use Magento\Webapi\Model\Client\Common;
...
class Client implements ClientInterface
{
     ...
     */
    public function __construct(?string $wsdl = null, $options = null)
    {
     ...
     * @throws InvalidArgumentException
     */
    public function setSoapVersion(int $version): Client
    {
     ...
     * @throws InvalidArgumentException
     */
    public function setClassmap(array $classmap): Client
    {
     ...
     * @throws InvalidArgumentException
     */
    public function setTypemap(array $typeMap): Client
    {
     ...
     */
    public function setEncoding(string $encoding): Client
    {
     ...
     * @throws InvalidArgumentException
     */
    public function setStyle(int $style): Client
    {
     ...
     * @throws InvalidArgumentException
     */
    public function setEncodingMethod(int $use): Client
    {
     ...
     * @return Client
     */
    public function setHttpLogin(string $login): Client
    {
        $this->login = $login;
        $this->soapClient = null;
     ...
     * @return Client
     */
    public function setHttpPassword(string $password): Client
    {
     ...
     * @return Client
     */
    public function setProxyHost(string $proxyHost): Client
    {
     ...
     * @return Client
     */
    public function setProxyPort(int $proxyPort): Client
    {
     ...
     * @return Client
     */
    public function setProxyLogin(string $proxyLogin): Client
    {
     ...
     * @return Client
     */
    public function setProxyPassword(string $proxyPassword): Client
    {
     ...
     * @throws InvalidArgumentException
     */
    public function setHttpsCertificate(string $localCert): Client
    {
     ...
     * @return Client
     */
    public function setHttpsCertPassphrase(string $passphrase): Client
    {
     ...
     * @return Client
     */
    public function setCompressionOptions(?int $compressionOptions): Client
    {
     ...
     * @throws InvalidArgumentException
     */
    public function setStreamContext($context): Client
    {
     ...
     * @return Client
     */
    public function setSoapFeatures($feature): Client
    {
     ...
     * @return self
     */
    public function setWSDLCache($caching): Client
    {
        if ($caching === null) {
            $this->cacheWsdl = null;
        } else {
     ...
     * @return Client
     */
    public function addSoapInputHeader(SoapHeader $header,bool $permanent = false): Client
    {
        if ($permanent) {
     ...
     * @return Client
     */
    public function resetSoapInputHeaders(): Client
    {
     ...
     * @throws SoapFault
     */
    public function setCookie(string $cookieName, ?string $cookieValue = null): Client
    {
        $soapClient = $this->getSoapClient();
     ...
     * @return Client
     */
    public function setKeepAlive(bool $keepAlive): Client
    {
     ...
     * @return Client
     */
    public function setSslMethod(int $sslMethod): Client
    {
     ...
     *
     * @return void
     * @throws UnexpectedValueException|SoapFault
     */
     ...
     * @return array
     */
    protected function _preProcessResult(array $result): array
    {
        // Do nothing
        return $result;
    }
