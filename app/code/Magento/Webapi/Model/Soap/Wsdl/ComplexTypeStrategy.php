...
use Magento\Webapi\Model\Soap\Wsdl\ComplexTypeStrategy\AbstractComplexTypeStrategy;

/**
 * Class ComplexTypeStrategy
 */
class ComplexTypeStrategy extends AbstractComplexTypeStrategy
{
     ...
     * @return DomDocument
     */
    protected function _getDom(): DOMDocument
    {
     ...
     */
    public function addComplexType(string $type, array $parentCallInfo = []): string
    {
     ...
     * @return DOMElement
     */
    protected function _processParameters(array $parameters, array $callInfo): DOMElement
    {
     ...
     * @return void
     */
    protected function _processParameter(
        DOMElement $element,
        bool $isRequired,
        array $parameterData,
     ...
     * @return void
     */
    protected function _processArrayParameter(string $type, array $callInfo = []): void
    {
     ...
     * @return void
     */
    protected function _revertRequiredCallInfo(bool $isRequired, array &$callInfo): void
    {
        if (!$isRequired) {
    ...
    public function addAnnotation(
        ...
        $targetNamespace = $this->getContext()->getTargetNamespace();
        ...
        if ($elementType !== null && $default !== null) {
     ...
     * @return void
     */
    protected function _processElementType(
        string $elementType,
        string $documentation,
        DOMElement $appInfoNode
    ): void {
        if ($elementType === 'int') {
     ...
     * @return void
     */
    protected function _processDefaultValueAnnotation(
        string $elementType,
        string $default,
        DOMElement $appInfoNode
    ): void {
     ...
     */
    protected function _getElementType(DOMElement $element): ?string
    {
        $elementType = null;
     ...
     * @return void
     */
    protected function _processRequiredAnnotation(
        string $annotation,
        string $documentation,
        DOMElement $appInfoNode
    ): void {
     ...
     * @return void
     */
    protected function _processCallInfo(DOMElement $appInfoNode, array $callInfo): void
    {
        if (!empty($callInfo)) {
     ...
     * @return void
     */
    protected function _processDocInstructions(DOMElement $appInfoNode, string $tagValue): void
    {
     ...
     * @return void
     */
    protected function _processSeeLink(DOMElement $appInfoNode, string $tagValue): void
    {
     ...
     * @return void
     */
    protected function _overrideCallInfoName(array &$callInfo, string $callName): void
    {
