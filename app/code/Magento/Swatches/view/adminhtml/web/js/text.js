    ...
    var swatchOptionTextDefaultInputType = 'radio',
      swatchTextOption = {
        ...
        updateItemsCountField: function() {
          $('swatch-text-option-count-check').value =
            this.totalItems > 0 ? '1' : '';
        },
        ...
        enableNewOptionDeleteButton: function(id) {
          $$('#delete_button_swatch_container_' + id + ' button').each(function(
            button,
          ) {
            button.enable();
        ...
        bindRemoveButtons: function() {
          jQuery('#swatch-text-options-panel').on(
            'click',
            '.delete-option',
        ...
        render: function() {
          Element.insert(
            $$('[data-role=swatch-text-options-container]')[0],
            this.elements,
          );
          this.elements = '';
        },
    ...
    if (config.isSortable) {
      jQuery(function($) {
        $('[data-role=swatch-text-options-container]').sortable({
          ...
          update: function() {
            $(
              '[data-role=swatch-text-options-container] [data-role=order]',
