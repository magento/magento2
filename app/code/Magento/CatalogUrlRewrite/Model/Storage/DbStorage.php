...
class DbStorage extends BaseDbStorage
{
    ...
    private function findProductRewriteByRequestPath(array $data)
    {
        ...
        if ($categoryPath) {
            ...
            $productFromDb[UrlRewrite::TARGET_PATH] = $productFromDb[UrlRewrite::REDIRECT_TYPE]
                ? str_replace($productUrl, $productFromDb[UrlRewrite::TARGET_PATH], $requestPath)
                : $productFromDb[UrlRewrite::TARGET_PATH] . '/category/' . $categoryFromDb[UrlRewrite::ENTITY_ID];
        }
