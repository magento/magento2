    ...
    initParam: function(container) {
      ...
      if (label) {
        Event.observe(
          label,
          'click',
          this.showParamInputField.bind(this, container),
        );
      }
      ...
      if (elem) {
        ...
        if (trig) {
          Event.observe(
            trig,
            'click',
            this.toggleChooser.bind(this, container),
          );
        }
        ...
        if (apply) {
          Event.observe(
            apply,
            'click',
            this.hideParamInputField.bind(this, container),
          );
        } else {
      ...
      if (remove) {
        Event.observe(
          remove,
          'click',
          this.removeRuleEntry.bind(this, container),
        );
      }
    },
