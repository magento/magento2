...
define(['Magento_Ui/js/form/components/insert-listing', 'underscore'], function(
  Insert,
  _,
) {
  'use strict';
  ...
  return Insert.extend({
    ...
    _delete: function(ids) {
      var defaultShippingId = parseFloat(
          this.source.get('data.default_shipping_address.entity_id'),
        ),
        defaultBillingId = parseFloat(
