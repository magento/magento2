...
/**
 * Test for when the UPS response returns negotiated rates for some, but
 * not all configured shipping methods. Mocked UPS Next Day Air shipping
 * method has NegotiatedRates node, but UPS Ground does
 * not. See _files/ups_rates_response_negotiated.xml
 *
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class CarrierNegotiatedRatesTest extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        return [
            [0, 0, '/_files/ups_rates_response_negotiated.xml', '01', 35.70 ],
            [0, 0, '/_files/ups_rates_response_negotiated.xml', '03', 9.43 ],
            [1, 0, '/_files/ups_rates_response_negotiated.xml', '01', 28.26 ],
            [1, 0, '/_files/ups_rates_response_negotiated.xml', '03', 9.43 ],
            [0, 1, '/_files/ups_rates_response_negotiated.xml', '01', 35.70 ],
            [0, 1, '/_files/ups_rates_response_negotiated.xml', '03', 9.43 ],
            [1, 1, '/_files/ups_rates_response_negotiated.xml', '01', 28.26 ],
