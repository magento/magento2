...
class EnableAdminUsageTest extends TestCase
{
    /**
     * @var EnableAdminUsage
     */
    private $enableAdminUsage;
    ...
    protected function setUp(): void
    {
        ...
        $this->enableAdminUsage = $objectManager->getObject(
            EnableAdminUsage::class,
            [
