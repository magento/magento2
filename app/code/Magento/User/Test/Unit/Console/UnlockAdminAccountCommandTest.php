...
class UnlockAdminAccountCommandTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testConfigure()
    {
        ...
        $this->assertSame(UnlockAdminAccountCommand::COMMAND_ADMIN_ACCOUNT_UNLOCK, $this->command->getName());
        $this->assertSame(UnlockAdminAccountCommand::COMMAND_DESCRIPTION, $this->command->getDescription());
