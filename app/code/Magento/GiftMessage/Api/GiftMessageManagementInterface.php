...
interface GiftMessageManagementInterface
{
     ...
     */
    public function assignToCart($cartId, \Magento\GiftMessage\Service\V1\Data\Message $giftMessage);
     ...
     */
    public function assignToItem($cartId, \Magento\GiftMessage\Service\V1\Data\Message $giftMessage, $itemId);
}
