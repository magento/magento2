    ...
    private function addAdvancedPriceLink()
    {
        ...
        if ($pricePath) {
            ...
            $advancedPricingButton['arguments']['data']['config'] = [
                ...
                'sortOrder' => $this->arrayManager
                        ->get($pricePath . '/arguments/data/config/sortOrder', $this->meta) + 1,
            ];
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'required' => false,
                        'sortOrder' => $this->arrayManager
                            ->get($tierPricePath . '/arguments/data/config/sortOrder', $this->meta),
                    ],
                ],
            ],
            'children' => [
        ...
        if ($pathFrom && $pathTo) {
            $this->meta = $this->arrayManager->merge(
                ...
                [
                    ...
                    'scopeLabel' => $this->arrayManager
                        ->get($pathFrom . '/arguments/data/config/scopeLabel', $this->meta),
                ]
            );
            $this->meta = $this->arrayManager->merge(
