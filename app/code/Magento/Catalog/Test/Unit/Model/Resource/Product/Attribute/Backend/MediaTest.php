...
class MediaTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->adapter = $this->getMock('Magento\Framework\DB\Adapter\AdapterInterface', [], [], '', false);
        ...
        $this->adapter->expects($this->any())->method('setCacheAdapter');
    ...
    public function testLoadGallery()
    {
        ...
        $this->adapter->expects($this->once())->method('getCheckSql')->with(
