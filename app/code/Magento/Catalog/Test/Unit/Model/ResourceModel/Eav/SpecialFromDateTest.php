 ...
 */
class SpecialFromDateTest extends TestCase
{
    /**
     * @var SpecialFromDate
     */
    private SpecialFromDate $specialFromDate;
    ...
    protected function setUp(): void
    {
        ...
        $this->specialFromDate = new SpecialFromDate(
            $context,
            $registry,
            $extensionFactory,
    ...
    {
        self::assertFalse($this->specialFromDate->isAllowedEmptyTextValue($value));
    }

    /**
     * @return array
     */
    public static function disallowedValuesProvider(): iterable
    {
        yield 'empty string' => [''];
        yield 'null' => [null];
        yield 'false' => [false];
    ...
    {
        self::assertTrue($this->specialFromDate->isAllowedEmptyTextValue($value));
    }
