...
class RefreshSpecialPricesTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->_dateTimeMock = $this->getMock(\Magento\Framework\Stdlib\DateTime::class, [], [], '', false);
        $this->_localeDateMock = $this->getMock(\Magento\Framework\Stdlib\DateTime\TimezoneInterface::class);
        $this->_eavConfigMock = $this->getMock(\Magento\Eav\Model\Config::class, [], [], '', false);
