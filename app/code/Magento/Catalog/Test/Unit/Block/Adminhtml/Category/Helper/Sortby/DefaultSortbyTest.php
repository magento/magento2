...
class DefaultSortbyTest extends TestCase
{
    ...
    {
        $this->model->setData('html_id', 'default_sortby_element');
        $this->model->setData('id', 'sortby_id');
        $this->model->setData('name', 'sortby_name');
        $this->model->setValue('position');

        $html = $this->model->getElementHtml();

        $this->assertStringContainsString('use_config_default_sortby_element', $html);
    ...
    /**
     * Test getElementHtml method with empty string value
     *
     * @return void
     */
