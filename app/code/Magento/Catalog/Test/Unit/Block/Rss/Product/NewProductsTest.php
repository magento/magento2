...
class NewProductsTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->newProducts = $this->getMock(\Magento\Catalog\Model\Rss\Product\NewProducts::class, [], [], '', false);
    ...
    protected function getItemMock()
    {
        ...
        $item = $this->getMock(\Magento\Catalog\Model\Product::class, $methods, [], '', false);
