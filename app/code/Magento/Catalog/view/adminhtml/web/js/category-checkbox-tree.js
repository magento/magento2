...
define([
  ...
  return function(config) {
    ...
    Ext.tree.TreePanel.Enhanced = function(el, nodeConfig) {
      Ext.tree.TreePanel.Enhanced.superclass.constructor.call(
        this,
        el,
        nodeConfig,
      );
    ...
    jQuery(function() {
      ...
      categoryLoader.buildHashChildren = function(hash, node) {
        ...
        if (
          ...
          (node.loaded === false && node.loading === false)
        ) {
          hash.children = [];
      ...
      categoryLoader.on('beforeload', function(treeLoader, node) {
        ...
        treeLoader.baseParams.selected =
          options.jsFormObject.updateElement.value;
      });
