...
define(['jquery', 'prototype'], function(jQuery) {
  ...
  var categorySubmit = function() {
    ...
    if (activeTab) {
      if (
        activeTab.tabsJsObject &&
        activeTab.tabsJsObject.tabs('activeAnchor')
      ) {
        activeTab.value = activeTab.tabsJsObject
          .tabs('activeAnchor')
          .prop('id');
      }
    }
