...
define(['jquery', 'jquery/ui'], function($) {
  ...
  $.widget('mage.zoom', {
    ...
    _isZoomable: function() {
      if (
        this.imageWidth <= this.imageParentWidth &&
        this.imageHeight <= this.imageParentHeight
      ) {
    ...
    _initialResize: function() {
      if (this.imageWidth > this.imageHeight) {
        ...
        this.image.css(
          'top',
          (this.imageParentHeight - this.image.height()) / 2 + 'px',
        ); //eslint-disable-line
      } else {
        ...
        this.image.css(
          'left',
          (this.imageParentWidth - this.image.width()) / 2 + 'px',
        ); //eslint-disable-line
      }
    ...
    _draggableImage: function() {
      ...
      if (this.image.width() > this.imageParentWidth) {
        topX =
          this.image.width() -
          (this.imageParent.offset().left - this.image.offset().left) -
          this.imageParentWidth;
      ...
      if (this.image.height() > this.imageParentHeight) {
        topY =
          this.image.height() -
          (this.imageParent.offset().top - this.image.offset().top) -
          this.imageParentHeight;
    ...
    _zoom: function(sliderPosition, sliderLength) {
      ...
      if (overSize) {
        this.imageWidth > this.imageHeight
          ? this.image.width(imageZoom * this.imageParentWidth)
      ...
      if (
        Math.abs(imageNewLeft) >
        Math.abs(this.imageParentWidth - this.image.width())
      ) {
      ...
      if (
        Math.abs(imageNewTop) >
        Math.abs(this.imageParentHeight - this.image.height())
      ) {
