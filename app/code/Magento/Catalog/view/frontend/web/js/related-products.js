...
define(['jquery', 'jquery/ui', 'mage/translate'], function($) {
  ...
  $.widget('mage.relatedProducts', {
     ...
     */
    _create: function() {
      $(this.options.selectAllLink).on(
        'click',
        $.proxy(this._selectAllRelated, this),
      );
      $(this.options.relatedCheckbox).on(
        'click',
        $.proxy(this._addRelatedToProduct, this),
      );
    ...
    _selectAllRelated: function(e) {
      ...
      $(this.options.relatedCheckbox).attr(
        'checked',
        (this.options.relatedProductsCheckFlag = !this.options
          .relatedProductsCheckFlag),
      );
