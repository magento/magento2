    ...
    public function getDefaultEntities()
    {
        return [
            'catalog_category' => [
                ...
                'attributes' => [
                    ...
                    'available_sort_by' => [
                        ...
                        'sort_order' => 40,
                        'input_renderer' => \Magento\Catalog\Block\Adminhtml\Category\Helper\Sortby\Available::class,
                        'global' => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_STORE,
                        'group' => 'Display Settings',
                    ],
                    'default_sort_by' => [
                    ...
                    'filter_price_range' => [
                        ...
                        'required' => false,
                        'sort_order' => 51,
                        'input_renderer' => \Magento\Catalog\Block\Adminhtml\Category\Helper\Pricestep::class,
                        'global' => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_STORE,
                        'group' => 'Display Settings',
                    ],
                ],
            ...
            'catalog_product' => [
                ...
                'entity_model' => \Magento\Catalog\Model\ResourceModel\Product::class,
                'attribute_model' => \Magento\Catalog\Model\ResourceModel\Eav\Attribute::class,
                ...
                'attributes' => [
                    ...
                    'sku' => [
                        ...
                        'backend' => \Magento\Catalog\Model\Product\Attribute\Backend\Sku::class,
                        'unique' => true,
                        'sort_order' => 2,
                        'searchable' => true,
                        'comparable' => true,
                    ...
                    'media_gallery' => [
                        ...
                        'label' => 'Media Gallery',
                        'input' => 'gallery',
                        'backend' => \Magento\Catalog\Model\Product\Attribute\Backend\Media::class,
                        'required' => false,
                        'sort_order' => 4,
                        'group' => 'Images',
                    ],
                    ...
                    'tier_price' => [
                        ...
                        'label' => 'Tier Price',
                        'input' => 'text',
                        'backend' => \Magento\Catalog\Model\Product\Attribute\Backend\Tierprice::class,
                        'required' => false,
                        'sort_order' => 7,
                        'global' => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_WEBSITE,
                        'apply_to' => 'simple,virtual',
                    ...
                    'visibility' => [
                        ...
                        'label' => 'Visibility',
                        'input' => 'select',
                        'source' => \Magento\Catalog\Model\Product\Visibility::class,
                        'default' => '4',
                        'sort_order' => 12,
                        'global' => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_STORE,
                    ],
                    ...
                    'category_ids' => [
                        ...
                        'backend' => \Magento\Catalog\Model\Product\Attribute\Backend\Category::class,
                        'input_renderer' => \Magento\Catalog\Block\Adminhtml\Product\Helper\Form\Category::class,
                        'required' => false,
                        'sort_order' => 9,
                        'visible' => true,
                        'group' => 'General',
                    ...
                    'options_container' => [
                        ...
                        'input' => 'select',
                        'source' => \Magento\Catalog\Model\Entity\Product\Attribute\Design\Options\Container::class,
                        'required' => false,
                        'default' => 'container2',
                        'sort_order' => 6,
                        'global' => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_STORE,
                    ...
                    'quantity_and_stock_status' => [
                        'group' => 'General',
                        'type' => 'int',
                        'backend' => \Magento\Catalog\Model\Product\Attribute\Backend\Stock::class,
                        'label' => 'Quantity',
                        'input' => 'select',
                        'input_renderer' => \Magento\CatalogInventory\Block\Adminhtml\Form\Field\Stock::class,
                        'source' => \Magento\CatalogInventory\Model\Source\Stock::class,
                        'global' => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_GLOBAL,
