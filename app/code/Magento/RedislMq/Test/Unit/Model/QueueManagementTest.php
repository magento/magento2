...
{
    /**
     * @var \Magento\RedisMq\Model\ResourceModel\Queue|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    /**
     * @var \Magento\RedisMq\Model\ResourceModel\MessageStatusCollectionFactory
     *      |\PHPUnit_Framework_MockObject_MockObject
     */
    private $messageStatusCollectionFactory;

    /**
     * @var \Magento\RedisMq\Model\QueueManagement
     */
    ...
    {
        $this->messageResource = $this->getMockBuilder(\Magento\RedisMq\Model\ResourceModel\Queue::class)
        ...
        $this->messageStatusCollectionFactory = $this
            ->getMockBuilder(\Magento\RedisMq\Model\ResourceModel\MessageStatusCollectionFactory::class)
            ->setMethods(['create'])
        ...
        $this->queueManagement = $objectManager->getObject(
            \Magento\RedisMq\Model\QueueManagement::class,
            [
    ...
    {
        $messageId = 99;
        $collection = $this->getMockBuilder(\Magento\RedisMq\Model\ResourceModel\MessageStatusCollection::class)
            ->disableOriginalConstructor()->getMock();
        ...
        $this->scopeConfig->expects($this->exactly(8))->method('getValue')
            ->withConsecutive(
                [
                    \Magento\RedisMq\Model\QueueManagement::XML_PATH_SUCCESSFUL_MESSAGES_LIFETIME,
                    \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
                ],
                [
                    \Magento\RedisMq\Model\QueueManagement::XML_PATH_FAILED_MESSAGES_LIFETIME,
                    \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
                ],
                [
                    \Magento\RedisMq\Model\QueueManagement::XML_PATH_NEW_MESSAGES_LIFETIME,
                    \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
                ],
                [
                    \Magento\RedisMq\Model\QueueManagement::XML_PATH_RETRY_IN_PROGRESS_AFTER,
                    \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
                ],
                [
                    \Magento\RedisMq\Model\QueueManagement::XML_PATH_SUCCESSFUL_MESSAGES_LIFETIME,
        ...
        $collection->expects($this->once())->method('addFieldToFilter')
            ->with(
                ...
                [
                    'in' => [
                        \Magento\RedisMq\Model\QueueManagement::MESSAGE_STATUS_COMPLETE,
                        \Magento\RedisMq\Model\QueueManagement::MESSAGE_STATUS_ERROR,
                        \Magento\RedisMq\Model\QueueManagement::MESSAGE_STATUS_NEW,
                        \Magento\RedisMq\Model\QueueManagement::MESSAGE_STATUS_IN_PROGRESS,
                    ]
                ]
            )->willReturnSelf();
        $messageStatuses =
        ...
        $messageStatuses[0]->expects($this->once())->method('setStatus')
            ->with(\Magento\RedisMq\Model\QueueManagement::MESSAGE_STATUS_TO_BE_DELETED)->willReturnSelf();
    ...
    {
        $messageStatus = $this->getMockBuilder(\Magento\RedisMq\Model\MessageStatus::class)
    ...
    {
        $messageIds = [1, 2];
        $status = \Magento\RedisMq\Model\QueueManagement::MESSAGE_STATUS_TO_BE_DELETED;
