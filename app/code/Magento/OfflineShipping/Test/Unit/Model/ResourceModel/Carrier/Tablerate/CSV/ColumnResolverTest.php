...
class ColumnResolverTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->setExpectedException(\Magento\OfflineShipping\Model\ResourceModel\Carrier\Tablerate\CSV\ColumnNotFoundException::class, 'Requested column "custom_field" cannot be resolved');
    ...
    {
        $this->setExpectedException(\Magento\OfflineShipping\Model\ResourceModel\Carrier\Tablerate\CSV\ColumnNotFoundException::class, 'Column "new_custom_column" not found');
