...
{
    /**
     * @var \Magento\Sales\Model\Observer\Backend\SubtractQtyFromQuotesObserver
     */
    protected $_model;
    ...
    protected function setUp()
    {
        ...
        $this->_model = new \Magento\Sales\Model\Observer\Backend\SubtractQtyFromQuotesObserver($this->_quoteMock);
    }
