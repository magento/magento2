...
/**
 * Test StockRegistryInterface::getProductStockStatus() for configurable product type.
...
class GetProductStockStatusTest extends TestCase
{
    ...
    public function testGetStatusOnDefaultSource()
    {
        ...
        foreach ($products as $product) {
            $this->assertEquals(1, $this->stockRegistry->getProductStockStatus($product['product_id']));
        }
        ...
        foreach ($products as $product) {
            $this->assertEquals(0, $this->stockRegistry->getProductStockStatus($product['product_id']));
        }
    }
