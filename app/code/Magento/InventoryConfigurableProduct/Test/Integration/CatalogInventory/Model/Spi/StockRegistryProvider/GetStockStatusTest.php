...
/**
 * Test StockRegistryProviderInterface::getStockStatus() for configurable product type.
...
class GetStockStatusTest extends TestCase
{
    ...
    public function testGetStatusOnDefaultSource()
    {
        ...
        foreach ($products as $product) {
            $stockStatus = $this->stockRegistryProvider->getStockStatus($product['product_id'], 1);
