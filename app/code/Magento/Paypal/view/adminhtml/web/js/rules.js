 ...
 */
define(['uiClass', 'Magento_Ui/js/modal/alert'], function(Class, alert) {
  'use strict';
  ...
  var isSolutionEnabled = function(solution, enabler) {
    ...
    setSolutionSelectEnabled = function(solution, enabler, enabled) {
      ...
      solution
        .find(enabler + ' option[value=' + enabled + ']')
        .prop('selected', true);
    },
    /**
    ...
    setSolutionMarkEnabled = function(solution, enabler, enabled) {
      var solutionEnabler = solution.find(
        'label[for="' + solution.find(enabler).attr('id') + '"]',
      );
    ...
    setSolutionUsedefaultEnabled = function(solution, enabler, checked) {
      ...
      solution
        .find('input[id="' + solution.find(enabler).attr('id') + '_inherit"]')
     ...
     */
    setSolutionConfigurationUnlock = function(
      solution,
      buttonConfiguration,
      unlock,
    ) {
