...
define([
  ...
  return Class.extend({
    ...
    initEvents: function() {
      _.each(
        this.config.events,
        function(elementEvents, selector) {
          var solution = this,
    ...
    addListeners: function() {
      _.each(
        ...
        function(rules, targetName) {
          var $target = this.createElement(targetName);

          _.each(
            rules,
            function(instances, instanceName) {
              _.each(
                instances,
                function(instance) {
    ...
    createElement: function(identifier) {
      ...
      return $(
        utils.template(this.templates.elementSelector, {
