...
define(['prototype'], function() {
  ...
  Packaging.prototype = {
    ...
    initialize: function(params) {
      ...
      this.packages = [];
      this.itemsAll = [];
      this.createLabelUrl = params.createLabelUrl
        ? params.createLabelUrl
        : null;
      ...
      this.defaultItemsQty = params.shipmentItemsQty
        ? params.shipmentItemsQty
        : null;
      this.defaultItemsPrice = params.shipmentItemsPrice
        ? params.shipmentItemsPrice
        : null;
      this.defaultItemsName = params.shipmentItemsName
        ? params.shipmentItemsName
        : null;
      this.defaultItemsWeight = params.shipmentItemsWeight
        ? params.shipmentItemsWeight
        : null;
      this.defaultItemsProductId = params.shipmentItemsProductId
        ? params.shipmentItemsProductId
        : null;
      this.defaultItemsOrderItemId = params.shipmentItemsOrderItemId
        ? params.shipmentItemsOrderItemId
        : null;

      this.shippingInformation = params.shippingInformation
        ? params.shippingInformation
        : null;
      this.thisPage = params.thisPage ? params.thisPage : null;
      this.customizableContainers = params.customizable
        ? params.customizable
        : [];
    ...
    checkAllItems: function(headCheckbox) {
      $(headCheckbox)
        .up('table')
        .select('tbody input[type="checkbox"]')
        .each(
          function(checkbox) {
    ...
    sendCreateLabelRequest: function() {
      ...
      if (this.createLabelUrl) {
        ...
        this.packagesContent.childElements().each(
          function(pack) {
            var packageId = this.getPackageId(pack);

            weight = parseFloat(
              pack.select('input[name="container_weight"]')[0].value,
            );
            length = parseFloat(
              pack.select('input[name="container_length"]')[0].value,
            );
            width = parseFloat(
              pack.select('input[name="container_width"]')[0].value,
            );
            height = parseFloat(
              pack.select('input[name="container_height"]')[0].value,
            );
            packagesParams[packageId] = {
              container: pack.select('select[name="package_container"]')[0]
                .value,
              customs_value: parseFloat(
                pack.select('input[name="package_customs_value"]')[0].value,
                10,
              ),
              ...
              weight_units: pack.select(
                'select[name="container_weight_units"]',
              )[0].value,
              dimension_units: pack.select(
            ...
            if (
              'undefined' !=
              typeof pack.select('select[name="package_size"]')[0]
            ) {
              if ('' != pack.select('select[name="package_size"]')[0].value) {
                packagesParams[packageId]['size'] = pack.select(
            ...
            if (
              'undefined' !=
              typeof pack.select('input[name="container_girth"]')[0]
            ) {
              if ('' != pack.select('input[name="container_girth"]')[0].value) {
                packagesParams[packageId]['girth'] = pack.select(
                  'input[name="container_girth"]',
                )[0].value;
                packagesParams[packageId][
                  'girth_dimension_units'
                ] = pack.select(
            ...
            if (
              'undefined' !=
                typeof pack.select('select[name="content_type"]')[0] &&
              'undefined' !=
                typeof pack.select('input[name="content_type_other"]')[0]
            ) {
              packagesParams[packageId]['content_type'] = pack.select(
                'select[name="content_type"]',
              )[0].value;
              packagesParams[packageId]['content_type_other'] = pack.select(
            ...
            var deliveryConfirmation = pack.select(
              'select[name="delivery_confirmation_types"]',
            );

            if (deliveryConfirmation.length) {
              packagesParams[packageId]['delivery_confirmation'] =
                deliveryConfirmation[0].value;
            }
          }.bind(this),
        );
        ...
        for (var packageId in this.packages) {
          if (!isNaN(packageId)) {
            this.paramsCreateLabelRequest[
              'packages[' + packageId + ']' + '[params]' + '[container]'
            ] = packagesParams[packageId]['container'];
            this.paramsCreateLabelRequest[
              'packages[' + packageId + ']' + '[params]' + '[weight]'
            ] = packagesParams[packageId]['weight'];
            this.paramsCreateLabelRequest[
              'packages[' + packageId + ']' + '[params]' + '[customs_value]'
            ] = packagesParams[packageId]['customs_value'];
            this.paramsCreateLabelRequest[
              'packages[' + packageId + ']' + '[params]' + '[length]'
            ] = packagesParams[packageId]['length'];
            this.paramsCreateLabelRequest[
              'packages[' + packageId + ']' + '[params]' + '[width]'
            ] = packagesParams[packageId]['width'];
            this.paramsCreateLabelRequest[
              'packages[' + packageId + ']' + '[params]' + '[height]'
            ] = packagesParams[packageId]['height'];
            this.paramsCreateLabelRequest[
              'packages[' + packageId + ']' + '[params]' + '[weight_units]'
            ] = packagesParams[packageId]['weight_units'];
            this.paramsCreateLabelRequest[
              'packages[' + packageId + ']' + '[params]' + '[dimension_units]'
            ] = packagesParams[packageId]['dimension_units'];
            this.paramsCreateLabelRequest[
              'packages[' + packageId + ']' + '[params]' + '[content_type]'
            ] = packagesParams[packageId]['content_type'];
            this.paramsCreateLabelRequest[
              'packages[' +
                packageId +
            ...
            if ('undefined' != typeof packagesParams[packageId]['size']) {
              this.paramsCreateLabelRequest[
                'packages[' + packageId + ']' + '[params]' + '[size]'
              ] = packagesParams[packageId]['size'];
            }

            if ('undefined' != typeof packagesParams[packageId]['girth']) {
              this.paramsCreateLabelRequest[
                'packages[' + packageId + ']' + '[params]' + '[girth]'
              ...
              this.paramsCreateLabelRequest[
                'packages[' +
                  ...
                  '[params]' +
                  '[girth_dimension_units]'
              ] = packagesParams[packageId]['girth_dimension_units'];
            }

            if (
              'undefined' !=
              typeof packagesParams[packageId]['delivery_confirmation']
            ) {
              this.paramsCreateLabelRequest[
                'packages[' +
                  packageId +
              ...
              if (!isNaN(packedItemId)) {
                this.paramsCreateLabelRequest[
                  'packages[' +
                    ...
                    packedItemId +
                    '][qty]'
                ] = this.packages[packageId]['items'][packedItemId]['qty'];
                this.paramsCreateLabelRequest[
                  'packages[' +
                    packageId +
                    ']' +
                    ...
                    packedItemId +
                    '][customs_value]'
                ] = this.packages[packageId]['items'][packedItemId][
                  'customs_value'
                ];
                this.paramsCreateLabelRequest[
                  'packages[' +
                    ...
                    packedItemId +
                    '][price]'
                ] = self.defaultItemsPrice[packedItemId];
                this.paramsCreateLabelRequest[
                  'packages[' +
                    packageId +
                    ']' +
                    ...
                    packedItemId +
                    '][name]'
                ] = self.defaultItemsName[packedItemId];
                this.paramsCreateLabelRequest[
                  'packages[' +
                    packageId +
                    ']' +
                    ...
                    packedItemId +
                    '][weight]'
                ] = self.defaultItemsWeight[packedItemId];
                this.paramsCreateLabelRequest[
                  'packages[' +
                    packageId +
                    ']' +
                    ...
                    packedItemId +
                    '][product_id]'
                ] = self.defaultItemsProductId[packedItemId];
                this.paramsCreateLabelRequest[
                  'packages[' +
                    packageId +
                    ']' +
                    ...
                    packedItemId +
                    '][order_item_id]'
                ] = self.defaultItemsOrderItemId[packedItemId];
              }
            }
          }
        }
          ...
          onSuccess: function(transport) {
            ...
            if (response.isJSON()) {
              ...
              if (response.error) {
                ...
                response.ok &&
                Object.isFunction(this.labelCreatedCallback)
              ) {
        ...
        if (
          this.paramsCreateLabelRequest['code'] &&
    ...
    validate: function() {
      ...
      if (
        dimensionElements.any(function(element) {
      ...
      return (result = $$('[id^="package_block_"] input')
    ...
    newPackage: function() {
      ...
      pack
        .select('[data-role=package-number]')[0]
        .update(this.packageIncrement);
    ...
    deleteItem: function(obj) {
      ...
      if (item.offsetParent.rows.length <= 2) {
        /* head + this last row */
        $(packItems).hide();
      }
      item.remove();
    ...
    getItemsForPack: function(obj) {
      if (this.itemsGridUrl) {
        ...
        var packagePrapare = packageBlock.select(
          '[data-role=package-items]',
        )[0];
          ...
          onSuccess: function(transport) {
            ...
            if (response) {
              ...
              if (packagePrapareGrid.select('.grid tbody tr').length) {
                packageBlock
                  .select('[data-action=package-add-items]')[0]
                  .hide();
                packageBlock
                  .select('[data-action=package-save-items]')[0]
                  .show();
                packagePrapare.show();
              } else {
          ...
          for (var packedItemId in this.packages[packageId]['items']) {
            if (!isNaN(packedItemId)) {
              if (items[packedItemId]) {
                items[packedItemId] += this.packages[packageId]['items'][
                  packedItemId
                ]['qty'];
              } else {
                items[packedItemId] = this.packages[packageId]['items'][
    ...
    _parseQty: function(obj) {
      var qty = $(obj).hasClassName('qty-decimal')
    ...
    packItems: function(obj) {
      ...
      this.messages.hide().update();
      packagePrepareGrid.select('.grid tbody tr').each(
        function(item) {
      ...
      packagePrepareGrid.select('.grid tbody tr').each(
        function(item) {
          ...
          if (checkbox.checked) {
            ...
            packagePrepareGrid
              .select('.grid th [type="checkbox"]')[0]
              .up('th label')
              .hide();
      ...
      if (anySelected) {
        ...
        if (!packItems) {
          packagePrepare.insert(
            new Element('div').addClassName('grid_prepare'),
          );
          packagePrepare.insert({
            after: packagePrepareGrid,
          });
          packItems = packagePrepareGrid
            .removeClassName('grid_prepare')
            .addClassName('package_items');
          packItems.select('.grid tbody tr').each(
            function(item) {
              var itemId = item.select('[type="checkbox"]')[0].value;
              ...
              if (
                'undefined' == typeof this.packages[packageId]['items'][itemId]
              ) {
          ...
          packagePrepareGrid.select('.grid tbody tr').each(
            function(item) {
              ...
              if (
                ...
                this.packages[packageId]['items'][itemId]['qty'] += qtyValue;
                var packItem = packItems
                  .select('[type="checkbox"][value="' + itemId + '"]')[0]
                  .up('tr')
                  .select('[name="qty"]')[0];

                packItem.value = this.packages[packageId]['items'][itemId][
                  'qty'
                ];
              }
            }.bind(this),
    ...
    validateItemQty: function(itemId, qty) {
      return this.defaultItemsQty[itemId] < qty
        ? this.defaultItemsQty[itemId]
        : qty;
    },
    ...
    checkSizeAndGirthParameter: function(obj, enabled) {
      ...
      var girthEnabled =
        packageContainer[0].value == 'NONRECTANGULAR' ||
      ...
      var sizeEnabled =
        packageContainer[0].value == 'NONRECTANGULAR' ||
        packageContainer[0].value == 'RECTANGULAR' ||
        packageContainer[0].value == 'VARIABLE';
    ...
    changeContentTypes: function(obj) {
      ...
      var contentTypeOther = packageBlock.select(
    ...
    _setAllItemsPackedState: function() {
      ...
      if (
        ...
        this._checkExceedsQtyFinal(
          this._getItemsCount(this.getPackedItemsQty()),
          this._getItemsCount(this.itemsAll),
        )
      ) {
        this.packagesContent
          .select('[data-action=package-add-items]')
    ...
    processPackagePrepare: function(packagePrepare) {
      ...
      packagePrepare.select('.grid tbody tr').each(
        function(item) {
            ...
            if (!isNaN(packedItemId)) {
              ...
              if (itemId == packedItemId) {
                if (qtyValue == packedQty || qtyValue <= packedQty) {
                  ...
                  qty.value = Number(
                    Number(
                      Math.round(qtyValue - packedQty + 'e+4') + 'e-4',
                    ).toFixed(4),
                  );
                }
              }
      ...
      packagePrepare.select('tbody input[type="checkbox"]').each(
        function(item) {
    ...
    _checkExceedsQty: function(itemId, qty) {
      var packedItemQty = this.getPackedItemsQty()[itemId]
        ? this.getPackedItemsQty()[itemId]
        : 0;
      var allItemQty = this.itemsAll[itemId];

      return (
        qty * (1 - this.eps) >
        allItemQty * (1 + this.eps) - packedItemQty * (1 - this.eps)
      );
    },
    ...
    _recalcContainerWeightAndCustomsValue: function(container) {
      ...
      var containerCustomsValue = packageBlock.select(
        '[name="package_customs_value"]',
      )[0];

      containerWeight.value = 0;
      containerCustomsValue.value = 0;
      container.select('.grid tbody tr').each(
        function(item) {
          var itemId = item.select('[type="checkbox"]')[0].value;
          var qtyValue = parseFloat(item.select('[name="qty"]')[0].value);
          ...
          var itemWeight = parseFloat(
            this._getElementText(item.select('[data-role=item-weight]')[0]),
          );

          containerWeight.value =
            parseFloat(containerWeight.value) + itemWeight * qtyValue;
          var itemCustomsValue =
            parseFloat(item.select('[name="customs_value"]')[0].value) || 0;

          containerCustomsValue.value =
            parseFloat(containerCustomsValue.value) +
            itemCustomsValue * qtyValue;
          this.packages[packageId]['items'][itemId][
            'customs_value'
          ] = itemCustomsValue;
        }.bind(this),
      );
      containerWeight.value = parseFloat(
        parseFloat(Math.round(containerWeight.value + 'e+4') + 'e-4').toFixed(
          4,
        ),
      );
      containerCustomsValue.value = parseFloat(
        Math.round(containerCustomsValue.value + 'e+2') + 'e-2',
      ).toFixed(2);
