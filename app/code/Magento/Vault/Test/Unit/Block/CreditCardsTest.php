...
use Magento\Vault\Block\CreditCards;
 ...
 */
class CreditCardsTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->block = $this->objectManager->getObject(CreditCards::class, [
    ...
    public function testGetPaymentTokens()
    {
        ...
        static::assertTrue($this->block->isExistsCustomerTokens());
        static::assertCount(1, $actual);

        /** @var PaymentTokenInterface $actualToken */
        $actualToken = array_pop($actual);
        static::assertEquals(PaymentTokenInterface::CARD_TYPE, $actualToken->getType());
    }
}
