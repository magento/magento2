 ...
 * @api
 */
class MassAssignValidatorChain implements MassAssignValidatorInterface
{
    /**
     ...
     * @param MassAssignValidatorInterface[] $validators
    ...
    public function __construct(
        ...
        foreach ($validators as $validator) {
            if (!$validator instanceof MassAssignValidatorInterface) {
