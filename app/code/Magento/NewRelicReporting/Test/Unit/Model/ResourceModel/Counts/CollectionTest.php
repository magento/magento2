...
namespace Magento\NewRelicReporting\Test\Unit\Model\ResourceModel\Counts;
...
/**
 * Unit test for Counts Collection
 *
 * @covers \Magento\NewRelicReporting\Model\ResourceModel\Counts\Collection
 */
class CollectionTest extends TestCase
{
    ...
    public function testConstructInitializesCorrectModelAndResource(): void
    {
        ...
        $collection->expects($this->once())
            ->method('_init')
            ->with(
                $this->equalTo(Counts::class),
                $this->equalTo(CountsResource::class)
            );
