...
use Magento\NewRelicReporting\Model\ResourceModel\Counts;
use PHPUnit\Framework\MockObject\Exception;
use PHPUnit\Framework\TestCase;
use ReflectionClass;

/**
 * Unit test for Counts ResourceModel
 *
 * @covers \Magento\NewRelicReporting\Model\ResourceModel\Counts
 */
class CountsTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->resourceModel = new Counts($context);
    }
    ...
    public function testInitializesMainTableAndPrimaryKey(): void
    {
        ...
        $this->assertEquals('reporting_counts', $mainTableProperty->getValue($this->resourceModel));
