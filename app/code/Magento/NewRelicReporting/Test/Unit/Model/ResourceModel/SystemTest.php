...
use Magento\NewRelicReporting\Model\ResourceModel\System;
use PHPUnit\Framework\MockObject\Exception;
use PHPUnit\Framework\TestCase;
use ReflectionClass;

/**
 * Unit test for System ResourceModel
 *
 * @covers \Magento\NewRelicReporting\Model\ResourceModel\System
 */
class SystemTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->resourceModel = new System($context);
    }
    ...
    public function testInitializesMainTableAndPrimaryKey(): void
    {
        ...
        $this->assertEquals('reporting_system_updates', $mainTableProperty->getValue($this->resourceModel));
