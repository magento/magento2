...
use Magento\NewRelicReporting\Model\ResourceModel\Orders;
use PHPUnit\Framework\MockObject\Exception;
use PHPUnit\Framework\TestCase;
use ReflectionClass;

/**
 * Unit test for Orders ResourceModel
 *
 * @covers \Magento\NewRelicReporting\Model\ResourceModel\Orders
 */
class OrdersTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->resourceModel = new Orders($context);
    }
