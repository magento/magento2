...
/**
 * Executes consumer processes configured for the cron runner.
 */
class ConsumersRunnerExecutor
{
    /**
     ...
     *
     * @param array $multipleProcesses
     * @param int $maxMessages
     * @param array $allowedConsumers
     * @param array $consumerNames
     * @return void
     *
     * @SuppressWarnings(PHPMD.CyclomaticComplexity)
     */
    public function run(
        array $multipleProcesses,
        int $maxMessages,
        ...
        foreach ($this->consumerConfig->getConsumers() as $consumer) {
            if (!$this->canBeRun($consumer, $allowedConsumers, $consumerNames)) {
                continue;
            }
     ...
     * @param array $consumerNames The list of explicitly requested consumers
     *        If $consumerNames is empty it means that all consumers are allowed
     * @return bool Returns true if the consumer can be run
     * @throws \Magento\Framework\Exception\FileSystemException
     */
    private function canBeRun(
        ConsumerConfigItemInterface $consumerConfig,
        array $allowedConsumers = [],
        array $consumerNames = []
    ): bool {
        ...
        if (!empty($consumerNames) && !in_array($consumerName, $consumerNames)) {
            return false;
        }
