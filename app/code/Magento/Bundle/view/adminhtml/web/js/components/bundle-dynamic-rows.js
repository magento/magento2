  ...
  return dynamicRows.extend({
    ...
    _updateData: function(data) {
      ...
      data.concat(dataArr).forEach(function(rec, idx) {
        ...
        _.each(
          rec['bundle_selections'],
          function(obj, index) {
            this.source.set(
              path + '.bundle_button_proxy' + '.' + index,
              rec['bundle_button_proxy'][index],
            );
    ...
    removeBundleItemsFromOption: function(index) {
      var bundleSelections = registry.get(
          this.name + '.' + index + '.' + this.bundleSelectionsName,
        ),
