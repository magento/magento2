...
$table = $installer->getConnection()
    ...
    ->addColumn('required', \Magento\DB\Ddl\Table::TYPE_SMALLINT, null, array(
        'unsigned'  => true,
        'nullable'  => false,
        'default'   => '0',
        ), 'Required')
    ...
    ->addColumn('type', \Magento\DB\Ddl\Table::TYPE_TEXT, 255, array(
        ), 'Type')
...
$table = $installer->getConnection()
    ...
    ->addIndex($installer->getIdxName('catalog_product_bundle_option_value', array('option_id', 'store_id'), \Magento\DB\Adapter\AdapterInterface::INDEX_TYPE_UNIQUE),
...
$table = $installer->getConnection()
    ...
    ->addColumn('selection_qty', \Magento\DB\Ddl\Table::TYPE_DECIMAL, '12,4', array(
        ), 'Selection Qty')
    ->addColumn('selection_can_change_qty', \Magento\DB\Ddl\Table::TYPE_SMALLINT, null, array(
        'nullable'  => false,
        'default'   => '0',
...
$table = $installer->getConnection()
    ...
    ->addColumn('price_type', \Magento\DB\Ddl\Table::TYPE_SMALLINT, null, array(
        'unsigned'  => true,
        'nullable'  => false,
        ), 'Price Type')
    ->addColumn('special_price', \Magento\DB\Ddl\Table::TYPE_DECIMAL, '12,4', array(
        ), 'Special Price')
    ->addColumn('tier_percent', \Magento\DB\Ddl\Table::TYPE_DECIMAL, '12,4', array(
        ), 'Tier Percent')
...
$table = $installer->getConnection()
    ...
    ->addColumn('group_type', \Magento\DB\Ddl\Table::TYPE_SMALLINT, null, array(
        'unsigned'  => true,
        'default'   => '0',
        ), 'Group Type')
...
$table = $installer->getConnection()
    ...
    ->addColumn('alt_price', \Magento\DB\Ddl\Table::TYPE_DECIMAL, '12,4', array(
        ), 'Alt Price')
    ->addColumn('max_price', \Magento\DB\Ddl\Table::TYPE_DECIMAL, '12,4', array(
        ), 'Max Price')
    ->addColumn('tier_price', \Magento\DB\Ddl\Table::TYPE_DECIMAL, '12,4', array(
        ), 'Tier Price')
    ->addColumn('alt_tier_price', \Magento\DB\Ddl\Table::TYPE_DECIMAL, '12,4', array(
        ), 'Alt Tier Price')
