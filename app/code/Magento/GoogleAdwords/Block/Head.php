...
class Head extends \Magento\Framework\View\Element\Template
{
    ...
    {
        return $this->_googleAdwordsData->isGoogleAdwordsActive();
    }
    /**
    ...
    // public function getGoogleAdwordsConfig()
    // {
    //     return [
    //         'conversionId' => $this->_googleAdwordsData->getConversionId(),
    //         'developerId' => $this->_googleAdwordsData->getDeveloperId(),
    //         'globalSiteTagSrc' => $this->_googleAdwordsData->getConversionGtagGlobalSiteTagSrc()
    //     ];
    // }
