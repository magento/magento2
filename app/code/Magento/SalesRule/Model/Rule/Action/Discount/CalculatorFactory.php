...
class CalculatorFactory
{
    ...
    protected $classByType = [
        Rule::TO_PERCENT_ACTION => ToPercent::class,
        Rule::BY_PERCENT_ACTION => ByPercent::class,
        Rule::TO_FIXED_ACTION => ToFixed::class,
        Rule::BY_FIXED_ACTION => ByFixed::class,
        Rule::CART_FIXED_ACTION => CartFixed::class,
        Rule::BUY_X_GET_Y_ACTION => BuyXGetY::class,
    ];
