...
class CarrierTest extends TestCase
{
    ...
    /**
     * Test successful shipping label generation
     *
     * Tests that shipping label content is correctly extracted from DHL API response,
     * decoded from base64, and properly set in the result data object.
     *
     * @return void
     */
    ...
    /**
     * Test label generation exception handling
     *
     * Tests that an exception is properly thrown when shipping label content
     * is missing from the DHL API response, simulating error conditions.
     *
     * @return void
     */
