...
class Carrier extends \Magento\Dhl\Model\AbstractDhl implements \Magento\Shipping\Model\Carrier\CarrierInterface
{
    ...
    /**
     * DHL service Quote prefix used for message reference.
     *
     * @var string
     */
    private $servicePrefixQuote = 'QUOT';

    /**
     * DHL service Shipping prefix used for message reference.
     *
     * @var string
     */
    private $servicePrefixShipval = 'SHIP';

    /**
     * DHL service Tracking prefix used for message reference.
     *
     * @var string
     */
    private $servicePrefixTracking = 'TRCK';
     ...
     * @param array $data
     * @param \Magento\Dhl\Model\Validator\XmlValidatorFactory|null $xmlValidatorFactory
    ...
    protected function _buildQuotesRequestXml()
    {
        ...
        $nodeServiceHeader->addChild(
            'MessageReference',
            $this->buildMessageReference($this->servicePrefixQuote)
        );
    ...
    protected function _doRequest()
    {
        ...
        $nodeServiceHeader->addChild(
            'MessageReference',
            $this->buildMessageReference($this->servicePrefixShipval)
        );
        $nodeServiceHeader->addChild('SiteID', (string)$this->getConfigData('id'));
        $nodeServiceHeader->addChild('Password', (string)$this->getConfigData('password'));
    ...
    protected function _getXMLTracking($trackings)
    {
        ...
        $serviceHeaderNode->addChild('MessageReference', $this->buildMessageReference($this->servicePrefixTracking));
    ...
    {
        $validPrefixes = [
            $this->servicePrefixQuote,
            $this->servicePrefixShipval,
            $this->servicePrefixTracking,
        ];
