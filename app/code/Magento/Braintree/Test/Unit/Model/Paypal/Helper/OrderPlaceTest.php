...
class OrderPlaceTest extends \PHPUnit\Framework\TestCase
{
     ...
     */
    private function disabledQuoteAddressValidationStep($quoteMock)
    {
     ...
     * @param MockObject $quoteMock
     */
    private function getCheckoutMethodStep($quoteMock)
    {
     ...
     * @param MockObject $quoteMock
     */
    private function prepareGuestQuoteStep($quoteMock)
    {
        $billingAddressMock = $this->getBillingAddressMock($quoteMock);
     ...
     */
    private function getBillingAddressMock($quoteMock)
    {
