...
define([
  ...
  return Class.extend({
    ...
    initObservable: function() {
      ...
      this._super().observe(['active', 'scriptLoaded', 'selectedCardType']);

      // re-init payment method events
      self.$selector
        .off('changePaymentMethod.' + this.code)
        .on(
          'changePaymentMethod.' + this.code,
    ...
    fieldEventHandler: function(event) {
      ...
      if (event.card) {
        ...
        self.selectedCardType(
          validator.getMageCardType(
            event.card.type,
            self.getCcAvailableTypes(),
          ),
        );
      }
    },
