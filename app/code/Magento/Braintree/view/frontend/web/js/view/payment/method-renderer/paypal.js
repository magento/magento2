...
define([
  ...
  return Component.extend({
    ...
    beforePlaceOrder: function(data) {
      ...
      if (
        (this.isRequiredBillingAddress() || quote.billingAddress() === null) &&
    ...
    isActiveVault: function() {
      return (
        this.vaultEnabler.isVaultEnabled() &&
        this.vaultEnabler.isActivePaymentTokenEnabler()
      );
    },
    ...
    getButtonId: function() {
      return (
        this.getCode() +
        (this.isSkipOrderReview() ? '_pay_with' : '_continue_to')
      );
    },
  });
});
