        ...
        validate: function (context) {
            var self = this,
                ...
                options = {
                    ...
                    billingAddress: {
                        givenName: (billingAddress.firstname.isASCII() ? billingAddress.firstname : billingAddress.firstname.toASCII()),
                        surname: (billingAddress.lastname.isASCII() ? billingAddress.lastname : billingAddress.lastname.toASCII() ),
