...
class CookieTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testIsUserNotAllowSaveCookie()
    {
        ...
        $request = $this->getMock(\Magento\Framework\App\Request\Http::class, ['getCookie'], [], '', false, false);
    ...
    {
        $this->_request =
            $this->getMock(\Magento\Framework\App\Request\Http::class, ['getCookie'], [], '', false, false);
