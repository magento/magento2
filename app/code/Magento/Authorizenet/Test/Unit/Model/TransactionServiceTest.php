...
class TransactionServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testLoadVoidedTransactionDetails($transactionId, $resultStatus, $responseStatus, $responseCode)
    {
        ...
        static::assertSame($responseCode, (string)$result->transaction->responseCode);
        static::assertSame($responseCode, (string)$result->transaction->responseReasonCode);
        static::assertSame($responseStatus, (string)$result->transaction->transactionStatus);
    }
