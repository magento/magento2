...
define([
  ...
  return Collection.extend({
    ...
    initDefaultView: function() {
      ...
      if (!_.size(data)) {
        this.setViewData(this.defaultIndex, this.current).saveView(
          this.defaultIndex,
        );
      }
    ...
    applyView: function(index) {
      this.applyStateOf(index).set('activeIndex', index);
    ...
    applyStateOf: function(state, property) {
      ...
      dataPath = dataPath ? 'current.' + dataPath : 'current';
