...
define([
  ...
  Wizard = function(steps, modalClass) {
    ...
    this.element = modalClass
      ? $('.' + modalClass + this.elementSelector)
    ...
    this.updateLabels = function(step) {
      this.element
        .find(this.nextLabel)
        .find('button')
        .text(step.nextLabelText || this.nextLabelText);
      this.element
        .find(this.prevLabel)
        .find('button')
        .text(step.prevLabelText || this.prevLabelText);
    };
  ...
  return Component.extend({
    ...
    initObservable: function() {
      this._super().observe(['selectedStep', 'disabled']);
