  ...
  return Class.extend({
    ...
    _cloneTable: function(elem) {
      ...
      bodyRows.forEach(function(row, rowIndex) {
        ...
        cell.style.height =
          origTrs[rowIndex].cells[columnIndex].offsetHeight + 'px';
    ...
    dragstart: function(elem) {
      ...
      this._cacheCoords()._cloneTable(elem);
    },
    ...
    dragenter: function(dropArea) {
      var direction = this.dragArea.index < dropArea.index ? 'left' : 'right';
