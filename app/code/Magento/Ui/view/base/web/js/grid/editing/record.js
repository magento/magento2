 ...
 * @api
 */
define(['underscore', 'mageUtils', 'uiLayout', 'uiCollection'], function(
  _,
  utils,
  layout,
  Collection,
  ...
  return Collection.extend({
      ...
      templates: {
        fields: {
          base: {
            ...
            imports: {
              disabled:
                '${ $.$data.record.parentName }:fields.${ $.$data.column.index }.disabled',
            },
            isEditor: true,
          },
          text: {
    ...
    setData: function(data, partial) {
      ...
      this.set('data', data).updateState();
    ...
    onColumnsUpdate: function(columns) {
      this.createFields(columns).updateFields();
    },
  });
});
