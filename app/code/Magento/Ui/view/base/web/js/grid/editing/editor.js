...
define([
  ...
  return Collection.extend({
    ...
    edit: function(id, isIndex) {
      ...
      record ? record.active(true) : this.initRecord(recordId);
    ...
    save: function() {
      ...
      this.clearMessages().columns('showLoader');
    ...
    countErrorsMessage: function() {
      return $t(
        'There are {placeholder} messages requires your attention.',
    ...
    onDataSaved: function() {
      ...
      this.addMessage(msg).source('reload', {
        refresh: true,
      });
    },
    ...
    onSaveError: function(errors) {
      this.addMessage(errors).columns('hideLoader');
    },
  });
});
