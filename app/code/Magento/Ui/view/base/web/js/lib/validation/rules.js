  ...
  return _.mapObject(
    {
      ...
      'max-words': [
        function(value, params) {
          return (
            utils.isEmpty(value) ||
            utils.stripHtml(value).match(/\b\w+\b/g).length < params
          );
        },
      ...
      'range-words': [
        function(value, params) {
          ...
          return (
            utils.isEmpty(value) ||
            (match.length >= params[0] && match.length <= params[1])
          );
        },
      ...
      'letters-with-basic-punc': [
        function(value) {
          return (
            utils.isEmpty(value) || /^[a-z\-.,()\u0027\u0022\s]+$/i.test(value)
          );
        },
      ...
      vinUS: [
        function(value) {
          ...
          var i,
            ...
            f,
            cd,
            cdv, //eslint-disable-line vars-on-top
            LL = [
              'A',
              'B',
              'C',
      ...
      mobileUK: [
        function(value) {
          return (
            utils.isEmpty(value) ||
            (value.length > 9 && value.match(/^((0|\+44)7\d{3}\s?\d{6})$/))
          );
        },
      ...
      'stripped-min-length': [
        function(value, param) {
          return (
            _.isUndefined(value) ||
            value.length === 0 ||
            utils.stripHtml(value).length >= param
          );
        },
      ...
      email2: [
        function(value) {
          return (
            utils.isEmpty(value) ||
            /^((([a-z]|\d|[!#\$%&\u0027\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&\u0027\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\u0022)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\u0022)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)*(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i.test(
              value,
            )
          ); //eslint-disable-line max-len
        },
      ...
      'validate-data': [
        function(value) {
          return (
            utils.isEmptyNoTrim(value) || /^[A-Za-z]+[A-Za-z0-9_]+$/.test(value)
          );
        },
        $.mage.__(
      ...
      'validate-xml-identifier': [
        function(value) {
          return (
            utils.isEmptyNoTrim(value) || /^[A-Z][A-Z0-9_\/-]*$/i.test(value)
          );
        },
        $.mage.__(
      ...
      'validate-ssn': [
        function(value) {
          return (
            utils.isEmptyNoTrim(value) || /^\d{3}-?\d{2}-?\d{4}$/.test(value)
          );
        },
        $.mage.__(
      ...
      'validate-range': [
        function(value) {
          ...
          if (utils.isEmptyNoTrim(value)) {
            ...
            $.validator.methods['validate-digits'](value)
          ) {
      ...
      'validate-not-number-first': [
        function(value) {
          return (
            utils.isEmptyNoTrim(value) || /^[^0-9-\.].*$/.test(value.trim())
          );
        },
      ...
      'validate-identifier': [
        function(value) {
          return (
            utils.isEmptyNoTrim(value) ||
            /^[a-z0-9][a-z0-9_\/-]+(\.[a-z0-9_-]+)?$/.test(value)
          );
        },
        $.mage.__(
      ...
      'validate-if-tag-script-exist': [
        function(value) {
          return !value || /<script\b[^>]*>([\s\S]*?)<\/script>$/gi.test(value);
        },
        $.mage.__(
      ...
      'validate-color': [
        ...
        $.mage.__(
          'Wrong color format. Please specify color in HEX, RGBa, HSVa, HSLa or use color name.',
        ),
      ],
      'blacklist-url': [
        function(value, param) {
