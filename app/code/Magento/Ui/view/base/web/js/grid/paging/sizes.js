 ...
 * @api
 */
define(['ko', 'underscore', 'mageUtils', 'uiElement'], function(
  ko,
  _,
  utils,
  Element,
  ...
  return Element.extend({
    ...
    initObservable: function() {
      this._super()
        .track(['value', 'editing', 'customVisible', 'customValue'])
        .track({
          optionsArray: [],
        });
     ...
     */
    discardAll: function() {
      this.discardEditing().discardCustom();
    ...
    updateSize: function(value, newValue) {
      ...
      this.remove('options.' + value).addSize(newValue);
