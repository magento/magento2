...
define([
  ...
  return Collection.extend({
    ...
    clear: function(filter) {
      filter ? filter.clear() : _.invoke(this.active, 'clear');
    ...
    onBackendError: function(isError) {
      var defaultMessage =
          'Something went wrong with processing the default view and we have restored the ' +
          'filter to its original state.',
        customMessage =
          'Something went wrong with processing current custom view and filters have been ' +
      ...
      if (isError) {
        ...
        $('body')
          ...
          .notification('add', {
            error: true,
            message: $.mage.__(
              this.bookmarksActiveIndex !== 'default'
                ? customMessage
                : defaultMessage,
            ),
