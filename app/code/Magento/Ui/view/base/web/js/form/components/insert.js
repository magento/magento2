...
define([
  ...
  return Element.extend({
    ...
    initObservable: function() {
      return this._super().observe(['visible', 'content', 'value', 'loading']);
    },
    ...
    render: function(params) {
      ...
      $.async(
        ...
        function(el) {
          ...
          request.done(self.onRender).fail(self.onError);
        },
      );
    ...
    initExternalLinks: function() {
      ...
      this.setLinks(links, 'imports').setLinks(links, 'exports');
    ...
    updateData: function(params) {
      ...
      request.done(this.onUpdate).fail(this.onError);
