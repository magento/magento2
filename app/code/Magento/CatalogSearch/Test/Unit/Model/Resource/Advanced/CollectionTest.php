...
namespace Magento\CatalogSearch\Test\Unit\Model\Resource\Advanced;

use \Magento\Framework\TestFramework\Unit\Helper\ObjectManager;

/**
 * Test for \Magento\CatalogSearch\Model\Resource\Advanced\Collection
 */
class CollectionTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $requestBuilder = $this->getMockBuilder('\Magento\CatalogSearch\Model\Advanced\Request\Builder')
            ->setMethods(['bind', 'setRequestName'])
            ->disableOriginalConstructor()
            ->getMock();
        $requestBuilder->expects($this->any())
            ->method('bind')
