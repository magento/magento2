...
class SaveTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->fileSystem = $this->getMockBuilder(\Magento\Framework\Filesystem::class)
            ->disableOriginalConstructor()
            ->getMock();
        $this->siteMapFactory = $this->getMockBuilder(\Magento\Sitemap\Model\SitemapFactory::class)
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->saveController = $this->objectManagerHelper->getObject(
            ...
            [
                ...
                'stringValidator' => $this->lengthValidator,
                'pathValidator' => $this->pathValidator,
                'sitemapHelper' => $this->helper,
                'filesystem' => $this->fileSystem,
                'sitemapFactory' => $this->siteMapFactory,
            ]
        );
    }
    ...
    {
        $this->requestMock->expects($this->any())
            ->method('isPost')->willReturn(false);
