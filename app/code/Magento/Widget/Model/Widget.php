...
class Widget
{
     ...
     * @deprecated 100.1.0
     */
    private function getMathRandom(): Random
    {
     ...
     * @deprecated 100.2.0
     */
    public function getConfigAsXml(string $type): ?Element
    {
    ...
    {
        return (int)$firstElement->getData('sort_order') <=> (int)$secondElement->getData('sort_order');
    }
}
