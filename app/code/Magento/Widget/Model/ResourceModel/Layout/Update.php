...
class Update extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
     ...
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    protected function _getFetchUpdatesByHandleSelect(bool $loadAllUpdates = false): \Magento\Framework\DB\Select
    {
     ...
     * @return $this
     */
    protected function _afterSave(\Magento\Framework\Model\AbstractModel $object): Update
    {
        $data = $object->getData();
