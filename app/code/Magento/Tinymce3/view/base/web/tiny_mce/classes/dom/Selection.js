  ...
  tinymce.create('tinymce.dom.Selection', {
    ...
    getEnd: function() {
      ...
      if (r.duplicate || r.item) {
        ...
        if (e && e.nodeName == 'BODY') return e.lastChild || e;
        ...
        if (e && e.nodeType == 3) return e.parentNode;
        ...
        function getLocation() {
          ...
          function getPoint(rng, start) {
            ...
            if (container.nodeType == 3) {
              ...
              point.push(
                t.dom.nodeIndex(childNodes[offset], normalized) + after,
              );
            }
    ...
    moveToBookmark: function(bookmark) {
      ...
      if (bookmark) {
        if (bookmark.start) {
          ...
          function setEndPoint(start) {
            ...
            if (point) {
              ...
              if (start) rng.setStart(node, offset);
        ...
        } else if (bookmark.rng) t.setRng(bookmark.rng);
      }
    },
          ...
          function setPoint(node, start) {
            ...
            do {
              ...
              if (
                ...
                if (start) rng.setStart(node, 0);
                else rng.setEnd(node, node.nodeValue.length);
              ...
              // BR element
              if (node.nodeName == 'BR') {
                if (start) rng.setStartBefore(node);
                else rng.setEndBefore(node);
    ...
    isCollapsed: function() {
      ...
      if (r.compareEndPoints) return r.compareEndPoints('StartToEnd', r) === 0;
    ...
    getRng: function(w3c) {
      ...
      if (w3c && t.tridentSel) return t.tridentSel.getRangeAt(0);
      ...
      if (t.selectedRange && t.explicitRange) {
        if (
          r.compareBoundaryPoints(r.START_TO_START, t.selectedRange) === 0 &&
    ...
    normalize: function() {
          ...
          if (container.hasChildNodes()) {
            container =
              container.childNodes[
                Math.min(
                  !start && offset > 0 ? offset - 1 : offset,
      ...
      if (rng.collapsed) normalizeEndPoint();
      ...
      function selectionChange(e) {
        ...
        if (e.button) {
          ...
          if (pointRng) {
            ...
            else pointRng.setEndPoint('EndToEnd', startRng);
