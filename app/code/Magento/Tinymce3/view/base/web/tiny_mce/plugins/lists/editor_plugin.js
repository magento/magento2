(function() {
    ...
    if (!u || !t) {
      ...
      if (u.tagName === 'LI' && t.tagName === 'LI') {
        ...
        if (n(u)) {
          return (
            (u.tagName === t.tagName &&
              (s || u.style.listStyleType === t.style.listStyleType)) ||
            q(t)
          );
        } else {
  ...
  function q(t) {
    ...
    return (
      ...
      n(t) &&
      s === u &&
      (n(s) || s.style.listStyleType === 'none' || j(s))
    );
  }
  function j(u) {
  ...
  tinymce.create('tinymce.plugins.Lists', {
    init: function(y) {
      ...
      function E(T) {
        return (
          T.keyCode === tinymce.VK.TAB &&
          !(T.altKey || T.ctrlKey) &&
          (y.queryCommandState('InsertUnorderedList') ||
            y.queryCommandState('InsertOrderedList'))
        );
      }
      function D() {
      ...
      function N() {
        ...
        var T =
          U.tagName === 'P' &&
          U.parentNode.tagName === 'LI' &&
          U.parentNode.lastChild === U;
      ...
      function B() {
        ...
        return (T.tagName == 'BR' || T.tagName == '') &&
          T.parentNode.tagName == 'LI'
          ? T.parentNode
          : T;
      }
      function O(T) {
      ...
      function H(T) {
        ...
        return (
          tinymce.isIE9 &&
          V &&
          (W.nodeValue == String.fromCharCode(160) ||
            W.nodeValue == String.fromCharCode(32))
        );
      }
      function S(T) {
      ...
      function u(W, Y) {
        ...
        if (ab.tagName === 'UL' || ab.tagName === 'OL') {
          ...
          if (
            ab.previousSibling &&
            (ab.previousSibling.tagName === 'UL' ||
              ab.previousSibling.tagName === 'OL')
          ) {
        ...
        y.editorCommands.addCommands(
          {
            outdent: function() {
              ...
              function T(W) {
                ...
                return (
                  W &&
                  parseInt(y.dom.getStyle(W, 'margin-left') || 0, 10) +
                    parseInt(y.dom.getStyle(W, 'padding-left') || 0, 10) >
                    0
                );
              }
              return (
    ...
    applyList: function(y, v) {
      ...
      function K(Q, T) {
        ...
        function P(X, U) {
          ...
          V.setEndAfter(U);
          return !(
            V.compareBoundaryPoints(O, W) > 0 ||
            V.compareBoundaryPoints(L, W) <= 0
          );
        }
        function S(U) {
          if (U.nextSibling) {
      ...
      e(G, function(t) {
        ...
        if (
          t.tagName === v ||
          (t.tagName === 'LI' && t.parentNode.tagName === v)
        ) {
          u = true;
        } else {
          if (
            t.tagName === y ||
            (t.tagName === 'LI' && t.parentNode.tagName === y)
          ) {
            H = true;
          } else {
            w = true;
    ...
    outdent: function(y, x) {
      ...
      function A(t) {
        ...
        if (!d(u, t, s)) {
          if (
            z.getStyle(t, 'margin-left') !== '' ||
            z.getStyle(t, 'padding-left') !== ''
          ) {
      ...
      function B(t) {
        var s = tinymce.grep(t.childNodes, function(H) {
          return !(
            H.nodeName === 'BR' ||
            (H.nodeName === 'SPAN' &&
              z.getAttrib(H, 'data-mce-type') == 'bookmark') ||
            (H.nodeType == 3 &&
              (H.nodeValue == String.fromCharCode(160) || H.nodeValue == ''))
          );
        });
        return s.length === 0;
      }
    ...
    adjustPaddingFunction: function(u) {
      ...
      return function(w) {
        var y, x;
        y =
          parseInt(t.dom.getStyle(w, 'margin-left') || 0, 10) +
          parseInt(t.dom.getStyle(w, 'padding-left') || 0, 10);
        if (u) {
          x = y + s;
        } else {
          x = y - s;
