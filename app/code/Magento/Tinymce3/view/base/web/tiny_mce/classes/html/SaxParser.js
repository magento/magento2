...
(function(tinymce) {
  ...
  tinymce.html.SaxParser = function(settings, schema) {
    ...
    if (settings.fix_self_closing !== false) settings.fix_self_closing = true;

    // Add handler functions from settings and setup default handlers
    tinymce.each('comment cdata text start end pi doctype'.split(' '), function(
      name,
    ) {
        ...
        if ((value = matches[6])) {
          ...
          if (!validate || (elementRule = schema.getElementRule(value))) {
            ...
            if ((attribsValue = matches[8])) {
              ...
              attribsValue.replace(attrRegExp, function(
                match,
                name,
                value,
                val2,
                ...
                value =
                  name in fillAttrsMap
                    ? name
                    : decode(value || val2 || val3 || ''); // Handle boolean attribute than value attribute
            ...
            if (validate && !isInternalElement) {
              ...
              if (attributesForced) {
                ...
                while (i--) {
                  ...
                  if (attrValue === '{$uid}') attrValue = 'mce_' + idCount++;
              ...
              if (attributesRequired) {
                ...
                while (i--) {
                  if (attributesRequired[i] in attrList.map) break;
                }
