  ...
  var b = {
    ...
    _init: function() {
      ...
      function h(i) {
        if (
          i.src &&
          /tiny_mce(|_gzip|_jquery|_prototype|_full)(_dev|_src)?.js/.test(i.src)
        ) {
...
(function() {
  ...
  tinymce.extend(tinymce, {
    ...
    inArray: function(b, c) {
      return b && b.indexOf ? b.indexOf(c) : -1;
    },
  });
  var a = { 'tinymce.util.JSON': {} };
  tinymce.onCreate = function(b, e, d) {
    tinymce.extend(d, a[e]);
  };
})();
  ...
  tinymce.create('tinymce.util.URI', {
    URI: function(e, g) {
      ...
      if (e.indexOf('/') === 0 && e.indexOf('//') !== 0) {
        e =
          (g.base_uri ? g.base_uri.protocol || 'http' : 'http') +
          '://mce_host' +
          e;
      }
      if (!/^[\w-]*:?\/\//.test(e)) {
        ...
        e =
          ((g.base_uri && g.base_uri.protocol) || 'http') +
          '://mce_host' +
          f.toAbsPath(h, e);
      }
    ...
    toRelative: function(b) {
      ...
      if (
        (b.host != 'mce_host' && c.host != b.host && b.host) ||
        c.port != b.port ||
    ...
    toAbsolute: function(b, c) {
      ...
      return b.getURI(
        this.host == b.host && this.protocol == b.protocol ? c : 0,
      );
    },
...
tinymce.create('static tinymce.util.XHR', {
  send: function(g) {
    ...
    a = b.XMLHttpRequest
      ? new XMLHttpRequest()
      : d('Microsoft.XMLHTTP') || d('Msxml2.XMLHTTP');
    if (a) {
...
(function(k) {
  ...
  function c(m) {
    var o = m.dom,
      n = m.selection;
    m.onKeyDown.add(function(q, u) {
      var p, v, s, t, r;
      r = u.keyCode == h;
      if (r || u.keyCode == j) {
        u.preventDefault();
        p = n.getRng();
        v = o.getParent(p.startContainer, o.isBlock);
        if (r) {
          v = o.getNext(v, o.isBlock);
        }
        if (v) {
          s = v.firstChild;
          while (s && s.nodeType == 3 && s.nodeValue.length == 0) {
            s = s.nextSibling;
          }
        ...
        q.getDoc().execCommand(r ? 'ForwardDelete' : 'Delete', false, null);
        v = o.getParent(p.startContainer, o.isBlock);
        k.each(
          o.select('span.Apple-style-span,font.Apple-style-span', v),
          function(x) {
            var y = n.getBookmark();
            if (t) {
              o.replace(t.cloneNode(false), x, true);
            } else {
              o.remove(x, true);
            }
            n.moveToBookmark(y);
  ...
  function d(m) {
    m.onKeyUp.add(function(n, p) {
      var o = p.keyCode;
      if (o == h || o == j) {
        if (n.dom.isEmpty(n.getBody())) {
          n.setContent('', { format: 'raw' });
          n.nodeChanged();
          return;
        }
      }
  ...
  function b(m) {
    m.dom.bind(m.getDoc(), 'focusin', function() {
      m.selection.setRng(m.selection.getRng());
    });
  }
  function e(m) {
    m.onKeyDown.add(function(n, q) {
      if (q.keyCode === j) {
        if (
          n.selection.isCollapsed() &&
          n.selection.getRng(true).startOffset === 0
        ) {
          var p = n.selection.getNode();
          var o = p.previousSibling;
          if (o && o.nodeName && o.nodeName.toLowerCase() === 'hr') {
            n.dom.remove(o);
            k.dom.Event.cancel(q);
          }
        }
      }
    });
  ...
  function g(m) {
    if (!Range.prototype.getClientRects) {
      m.onMouseDown.add(function(o, p) {
  ...
  function f(m) {
    m.onClick.add(function(n, o) {
      o = o.target;
      if (/^(IMG|HR)$/.test(o.nodeName)) {
        n.selection.select(o);
      }
      if (o.nodeName == 'A' && n.dom.hasClass(o, 'mceItemAnchor')) {
        n.selection.select(o);
      }
      n.nodeChanged();
    });
  ...
  function l(m) {
    var o, n;
    m.dom.bind(m.getDoc(), 'selectionchange', function() {
      if (n) {
        clearTimeout(n);
        n = 0;
      }
      n = window.setTimeout(function() {
        var p = m.selection.getRng();
        if (!o || !k.dom.RangeUtils.compareRanges(p, o)) {
          m.nodeChanged();
          o = p;
        }
      }, 50);
...
(function(m) {
  ...
  function a(r, q) {
    ...
    n(q)
      .replace(/#/g, '#text')
      .replace(/(\w+)\[([^\]]+)\]\[([^\]]*)\]/g, function(v, t, s, u) {
        s = i(s, '|');
        p[t] = {
          attributes: d(s),
          attributesOrder: s,
          children: d(u, '|', { '#comment': {} }),
        };
      });
    return p;
  }
  l =
    'h1,h2,h3,h4,h5,h6,hr,p,div,address,pre,form,table,tbody,thead,tfoot,th,tr,td,li,ol,ul,caption,blockquote,center,dl,dt,dd,dir,fieldset,noscript,menu,isindex,samp,header,footer,article,section,hgroup';
  ...
  b.html.DomParser = function(g, h) {
    ...
    function j(m) {
      ...
      for (o = 0; o < m.length; o++) {
        ...
        for (
          x = p.parent;
          x && !h.isValidChild(x.name, p.name) && !s[x.name];
          x = x.parent
        ) {
          v.push(x);
        }
        if (x && v.length > 1) {
          ...
          if (
            x.isEmpty(k) ||
            (x.firstChild === x.lastChild && x.firstChild.name === 'br')
          ) {
            x.empty().remove();
          }
        } else {
          if (p.parent) {
            ...
            if (
              h.isValidChild(p.parent.name, 'div') &&
    ...
    f.parse = function(v, m) {
      ...
      c = {};
      o = b.extend(
        b.makeMap('script,style,head,html,body,title,meta,param'),
        h.getBlockElements(),
      );
...
tinymce.html.Writer = function(e) {
  ...
  f = tinymce.html.Entities.getEncodeFunc(
    e.entity_encoding || 'raw',
    e.entities,
  );
...
(function(h) {
  ...
  h.create('tinymce.dom.DOMUtils', {
    ...
    select: function(l, k) {
      ...
      return h.dom.Sizzle(
        l,
        j.get(k) || j.get(j.settings.root_element) || j.doc,
        [],
      );
    },
    is: function(l, j) {
    ...
    setStyle: function(m, j, k) {
      ...
      return l.run(m, function(p) {
        ...
        if (
          l.pixelStyles.test(j) &&
          (h.is(k, 'number') || /^[\-0-9\.]+$/.test(k))
        ) {
          k += 'px';
        }
        switch (j) {
    ...
    getAttrib: function(o, p, l) {
      ...
      if (
        /^(checked|compact|declare|defer|disabled|ismap|multiple|nohref|noshade|nowrap|readonly|selected)$/.test(
          p,
        )
      ) {
    ...
    isHidden: function(j) {
      j = this.get(j);
      return (
        !j || j.style.display == 'none' || this.getStyle(j, 'display') == 'none'
      );
    },
    uniqueId: function(j) {
    ...
    toHex: function(j) {
      var l = /^\s*rgb\s*?\(\s*?([0-9]+)\s*?,\s*?([0-9]+)\s*?,\s*?([0-9]+)\s*?\)\s*$/i.exec(
        j,
      );
      function k(m) {
    ...
    nodeIndex: function(n, o) {
      ...
      if (n) {
        for (
          l = n.nodeType, n = n.previousSibling, m = n;
          n;
          n = n.previousSibling
        ) {
          k = n.nodeType;
          ...
          if (u == 3 && v.nodeValue.length > 0) {
            ...
            if (u == 1) {
              ...
              if (
                ...
                r[0] &&
                r[0].nodeType == 1 &&
                r[0].getAttribute('data-mce-type') == 'bookmark'
              ) {
    ...
    _isRes: function(j) {
      return (
        /^(top|left|bottom|right|width|height)/i.test(j) ||
        /;\s*(top|left|bottom|right|width|height)/i.test(j)
      );
    },
  });
...
(function(a) {
  function b(c) {
    ...
    function m(ab) {
      ...
      for (
        t = W.parentNode, ac = Y.parentNode;
        t != ac;
        t = t.parentNode, ac = ac.parentNode
      ) {
        W = t;
        Y = ac;
      }
    ...
    if (x.length > 1 && k.exec(v)) {
      ...
      if (e) {
        D = A
          ...
          : b.find(
              x.pop(),
              x.length === 1 && (x[0] === '~' || x[0] === '+') && e.parentNode
                ? e.parentNode
                : e,
              t,
            );
      ...
      if (!u) {
        ...
        if (e && e.nodeType === 1) {
          for (y = 0; H[y] != null; y++) {
            if (
              H[y] &&
              (H[y] === true || (H[y].nodeType === 1 && b.contains(e, H[y])))
            ) {
              z.push(E[y]);
            }
          }
      ...
      '+': function(x, r) {
        ...
        for (var s = 0, e = x.length, u; s < e; s++) {
          if ((u = x[s])) {
            ...
            x[s] =
              y || (u && u.nodeName.toLowerCase() === r) ? u || false : u === r;
          }
        }
        if (y) {
          b.filter(r, x, true);
    ...
    filter: {
      PSEUDO: function(s, y, x, z) {
        ...
        if (r) {
          ...
          if (e === 'contains') {
            return (
              (s.textContent || s.innerText || b.getText([s]) || '').indexOf(
                y[3],
              ) >= 0
            );
          } else {
      ...
      TAG: function(r, e) {
        return (
          (e === '*' && r.nodeType === 1) || r.nodeName.toLowerCase() === e
        );
      },
      CLASS: function(r, e) {
        return (
      ...
      ATTR: function(v, t) {
        ...
        return e == null
          ...
          ? x.indexOf(r) === 0
          : u === '$='
          ? x.substr(x.length - r.length) === r
          : u === '|='
          ? x === r || x.substr(0, r.length + 1) === r + '-'
          : false;
      },
...
(function(a) {
  a.dom.Element = function(f, d) {
    ...
    a.each(
      'getPos,getRect,getParent,add,setStyle,getStyle,setStyles,setAttrib,setAttribs,getAttrib,addClass,removeClass,hasClass,getOuterHTML,setOuterHTML,remove,show,hide,isHidden,setHTML,get'.split(
        /,/,
      ),
      function(g) {
        b[g] = function() {
  ...
  c.create('tinymce.dom.Selection', {
      ...
      if (g.duplicate || g.item) {
        ...
        if (!n) {
          ...
          j.insertNode(
            m.create(
              'span',
              { 'data-mce-type': 'bookmark', id: i + '_end', style: u },
              l,
            ),
          );
        }
        ...
        g.insertNode(
          m.create(
            'span',
            { 'data-mce-type': 'bookmark', id: i + '_start', style: u },
            l,
          ),
        );
      }
    ...
    getRng: function(l) {
      ...
      if (g.selectedRange && g.explicitRange) {
        if (
          i.compareBoundaryPoints(i.START_TO_START, g.selectedRange) === 0 &&
      ...
      function h(p) {
        ...
        if (k === j) {
          if (k.hasChildNodes()) {
            k =
              k.childNodes[
                Math.min(!p && o > 0 ? o - 1 : o, k.childNodes.length - 1)
              ];
            o = 0;
            if (k.hasChildNodes()) {
              l = k;
...
(function(a) {
  a.dom.Serializer = function(e, i, f) {
    ...
    c.addNodeFilter('script,style', function(k, l) {
      ...
      while (m--) {
        ...
        if (l === 'script') {
          n.attr(
            'type',
            (n.attr('type') || 'text/javascript').replace(/^mce\-/, ''),
          );
          if (o.length > 0) {
    ...
    c.addAttributeFilter('data-mce-src,data-mce-href,data-mce-style', function(
      j,
      k,
    ) {
      var l = j.length;
    ...
    return {
      ...
      serialize: function(o, m) {
        ...
        m.content = j.serialize(
          c.parse(m.getInner ? o.innerHTML : a.trim(i.getOuterHTML(o), m), m),
        );
        if (!m.cleanup) {
  ...
  a.dom.RangeUtils.compareRanges = function(c, b) {
    if (c && b) {
      if (c.item || c.duplicate) {
        ...
        return (
          c.startContainer == b.startContainer && c.startOffset == b.startOffset
        );
      }
    }
    return false;
...
(function(e) {
  ...
  e.create('tinymce.ui.DropMenu:tinymce.ui.Menu', {
    ...
    update: function() {
      ...
      k = j.max_height
        ? Math.min(g.clientHeight, j.max_height)
        : g.clientHeight;
      if (!c.boxModel) {
    ...
    hideMenu: function(g) {
      ...
      if (f.menu && f.menu.isMenuVisible) {
        ...
        if (
          g &&
          g.type == 'mousedown' &&
          (g.target.id == f.id + '_text' || g.target.id == f.id + '_open')
        ) {
          return;
        }
...
(function(d) {
  ...
  d.create('tinymce.ui.NativeListBox:tinymce.ui.ListBox', {
    ...
    renderHTML: function() {
      ...
      g += c.createHTML(
        'span',
        { id: f.id + '_aria', style: 'display: none' },
        f.settings.title,
      );
      return g;
    },
      ...
      if (g.onclick) {
        ...
        a.add(e.id, ['click', 'keydown'], function(h) {
          var k = 32,
            ...
            l = 40;
          if (
            (h.keyCode === 32 || h.keyCode === 13 || h.keyCode === 14) &&
            !h.altKey &&
            !h.ctrlKey &&
            !h.metaKey
          ) {
  ...
  d.create('tinymce.ui.ColorSplitButton:tinymce.ui.SplitButton', {
    ...
    renderMenu: function() {
      ...
      a.add(p.id + '_menu', 'click', function(i) {
        ...
        if (
          i &&
          i.nodeName.toLowerCase() == 'a' &&
          (m = i.getAttribute('data-mce-color'))
        ) {
          p.setColor(m);
        }
        return a.cancel(i);
...
(function(j) {
  var g = j.each,
    ...
    a,
    c = 0;
  j.documentBaseURL = window.location.href
    .replace(/[\?#].*$/, '')
    .replace(/[\/\\][^\/]+$/, '');
...
(function(m) {
  ...
  m.create('tinymce.Editor', {
      ...
      p.settings = q = f(
        {
          ...
          indent: 'simple',
          indent_before:
            'p,h1,h2,h3,h4,h5,h6,blockquote,div,title,style,pre,script,td,ul,li,area,table,thead,tfoot,tbody,tr',
          indent_after:
            'p,h1,h2,h3,h4,h5,h6,blockquote,div,title,style,pre,script,td,ul,li,area,table,thead,tfoot,tbody,tr',
          validate: true,
    ...
    render: function(r) {
      ...
      if (
        !/TEXTAREA|INPUT/i.test(u.getElement().nodeName) &&
        v.hidden_input &&
        n.getParent(x, 'form')
      ) {
      ...
      function q() {
        ...
        if (v.theme && v.theme.charAt(0) != '-' && !h.urls[v.theme]) {
          h.load(
            v.theme,
            'themes/' + v.theme + '/editor_template' + m.suffix + '.js',
          );
        }
    ...
    init: function() {
      ...
      I.aria_label =
        I.aria_label ||
        n.getAttrib(D, 'aria-label', H.getLang('aria.rich_text_area'));
      if (I.theme) {
        ...
        if (H.theme.init && I.init_theme) {
          H.theme.init(
            H,
            h.urls[I.theme] || m.documentBaseURL.replace(/\/$/, ''),
          );
        }
      }
      function B(J) {
        var K = c.get(J),
          t = c.urls[J] || m.documentBaseURL.replace(/\/$/, ''),
          s;
      ...
      if (I.popup_css !== false) {
        if (I.popup_css) {
          ...
          I.popup_css = H.baseURI.toAbsolute(
            'themes/' + I.theme + '/skins/' + I.skin + '/dialog.css',
          );
        }
      }
      if (I.popup_css_add) {
      ...
      A =
        (q.iframeHeight || A) +
        (typeof A == 'number' ? q.deltaHeight || 0 : '');
      if (A < 100) {
        A = 100;
      }
      H.iframeHTML =
        I.doctype + '<html><head xmlns="http://www.w3.org/1999/xhtml">';
      ...
      if (
        m.relaxedDomain &&
        (b || (m.isOpera && parseFloat(opera.version()) < 11))
      ) {
        F =
      ...
      r = n.add(q.iframeContainer, 'iframe', {
        ...
        title: I.aria_label,
        style: { width: '100%', height: A, display: 'block' },
      });
    ...
    setupIframe: function() {
      ...
      q.parser.addNodeFilter('script', function(s, t) {
        ...
        while (z--) {
          A = s[z];
          A.attr('type', 'mce-' + (A.attr('type') || 'text/javascript'));
        }
      });
      ...
      q.parser.addNodeFilter('p,h1,h2,h3,h4,h5,h6,div', function(t, z) {
        var A = t.length,
          B,
          s = q.schema.getNonEmptyElements();
        while (A--) {
          B = t[A];
          if (B.isEmpty(s)) {
      ...
      i(
        'p h1 h2 h3 h4 h5 h6 div address pre div code dt dd samp'.split(/\s/),
        function(s) {
      ...
      if (v.verify_css_classes) {
        q.serializer.attribValueFilter = function(B, z) {
          ...
          if (B == 'class') {
            ...
            return !q.classesRE ||
              /(\bmceItem\w+\b|\bmceTemp\w+\b)/g.test(z) ||
              q.classesRE.test(z)
              ? z
              : '';
          }
    ...
    getLang: function(q, p) {
      return (
        m.i18n[(this.settings.language || 'en') + '.' + q] ||
        (d(p) ? p : '{#' + q + '}')
      );
    },
    ...
    nodeChanged: function(r) {
      ...
      if (p.initialized) {
        ...
        p.onNodeChange.dispatch(
          p,
          r ? r.controlManager || p.controlManager : p.controlManager,
          u,
          q.isCollapsed(),
          r,
        );
    ...
    isDirty: function() {
      var p = this;
      return (
        m.trim(p.startContent) !=
          m.trim(p.getContent({ format: 'raw', no_events: 1 })) && !p.isNotDirty
      );
    },
    ...
    _addEvents: function() {
      ...
      q.bind(
        C.content_editable ? B.getBody() : a ? B.getDoc() : B.getWin(),
        'focus',
        function(s) {
          B.focus(true);
        },
      ...
      B.onKeyDown.add(function(t, D) {
        ...
        if (
          F &&
          F.parentNode &&
          F.parentNode.tagName === 'BLOCKQUOTE' &&
          F.parentNode.firstChild == F &&
          E == 0
        ) {
      ...
      if (C.custom_shortcuts) {
        ...
        function v(t) {
          ...
          i(B.shortcuts, function(D) {
            ...
            if (
              t.keyCode == D.keyCode ||
              (t.charCode && t.charCode == D.charCode)
            ) {
              s = D;
              return false;
            }
  ...
  c.EditorCommands = function(n) {
    ...
    u({
      ...
      mceInsertRawHTML: function(y, x, v) {
        ...
        n.setContent(
          n.getContent().replace(/tiny_mce_marker/g, function() {
            return v;
          }),
        );
      },
          ...
          d(p.getSelectedBlocks(), function(A) {
            if (z == 'outdent') {
              ...
              m.setStyle(
                A,
                'paddingLeft',
                parseInt(A.style.paddingLeft || 0) + x + v,
              );
            }
          });
        } else {
      ...
      mceReplaceContent: function(y, x, v) {
        n.execCommand(
          'mceInsertContent',
          false,
          v.replace(/\{\$selection\}/g, p.getContent({ format: 'text' })),
        );
      },
    ...
    u(
      {
        ...
        Outdent: function() {
          ...
          if (k.inline_styles) {
            if (
              (v = m.getParent(p.getStart(), m.isBlock)) &&
              parseInt(v.style.paddingLeft) > 0
            ) {
              return a;
            }
            if (
              (v = m.getParent(p.getEnd(), m.isBlock)) &&
              parseInt(v.style.paddingLeft) > 0
            ) {
              return a;
            }
          ...
          return (
            ...
            l('InsertOrderedList') ||
            (!k.inline_styles && !!m.getParent(p.getNode(), 'BLOCKQUOTE'))
          );
        },
  ...
  l.create('tinymce.ForceBlocks', {
      ...
      if (l.isWebKit) {
        ...
        m.onKeyPress.add(function(s, t) {
          if (
            ...
            (t.shiftKey ||
              (p.force_br_newlines &&
                !u.getParent(o.getNode(), 'h1,h2,h3,h4,h5,h6,ol,ul')))
          ) {
            r(s);
            j.cancel(t);
          }
    ...
    insertPara: function(Q) {
      ...
      if (
        u &&
        (u.nodeName == 'CAPTION' ||
          /absolute|relative|fixed/gi.test(M.getStyle(u, 'position', 1)))
      ) {
        m = V.element;
        u = null;
      }
      ...
      if (
        /(TD|TABLE|TH|CAPTION)/.test(m) ||
        (u && m == 'DIV' && /left|right/gi.test(M.getStyle(u, 'float', 1)))
      ) {
        m = V.element;
        u = z = null;
      }
      ...
      do {
        if (
          ...
          I.nodeType == 9 ||
          E.dom.isBlock(I) ||
          /(TD|TABLE|TH|CAPTION)/.test(I.nodeName)
        ) {
          break;
        }
        p = I;
...
(function(a) {
  a.Formatter = function(U) {
    var M = {},
      ...
      d = U.schema.isValidChild,
      F = c.isBlock,
      l = U.settings.forced_root_block,
      s = c.nodeIndex,
      E = '\uFEFF',
      e = /^(src|href|style)$/,
      R = false,
    ...
    function b(V) {
      return (
        V.nodeType === 1 &&
        (V.face === 'mceinline' || V.style.fontFamily === 'mceinline')
      );
    }
    function Q(V) {
      return V ? M[V] : M;
    ...
    var i = function(W) {
      var V;
      U.dom.getParent(W, function(X) {
        V = U.dom.getStyle(X, 'text-decoration');
        return V && V !== 'none';
      });
      return V;
    };
    var I = function(V) {
      var W;
      if (V.nodeType === 1 && V.parentNode && V.parentNode.nodeType === 1) {
        W = i(V.parentNode);
        if (U.dom.getStyle(V, 'color') && W) {
          U.dom.setStyle(V, 'text-decoration', W);
        } else {
          if (U.dom.getStyle(V, 'textdecoration') === W) {
            U.dom.setStyle(V, 'text-decoration', null);
          }
        }
      }
    };
    function S(Y, ag, ab) {
      var ac = Q(Y),
        ...
        ad = q.isCollapsed();
      function Z(al) {
        var ak = al.startContainer,
          ao = al.startOffset,
          an,
          am;
        if (ak.nodeType == 1 || ak.nodeValue === '') {
          ak = ak.nodeType == 1 ? ak.childNodes[ao] : ak;
          if (ak) {
            an = new t(ak, ak.parentNode);
      ...
      function V(al, ak) {
        ...
        if (al) {
          ...
          O(ak.styles, function(an, am) {
            c.setStyle(al, am, r(an, ag));
          });
          O(ak.attributes, function(an, am) {
            c.setAttrib(al, am, r(an, ag));
          });
          O(ak.classes, function(am) {
            am = r(am, ag);
            if (!c.hasClass(al, am)) {
              c.addClass(al, am);
            }
      ...
      function X(an, at, aq, ap, al) {
        var ak = [],
          ...
          ao = -1,
          au;
        O(an.childNodes, function(ax, aw) {
        ...
        if (am <= 0 || (av < am && ao > am)) {
          O(a.grep(an.childNodes), al);
          return 0;
        } else {
          au = aq.cloneNode(R);
          O(a.grep(an.childNodes), function(ax, aw) {
      ...
      function ai(al, an, ap) {
        ...
        K.walk(al, function(aq) {
          var ar;
          function at(au) {
            var ax = au.nodeName.toLowerCase(),
              aw = au.parentNode.nodeName.toLowerCase(),
              av;
            if (g(ax, 'br')) {
              ar = 0;
              if (ah.block) {
            ...
            if (
              ...
              !(
                !ap &&
                au.nodeType === 3 &&
                au.nodeValue.length === 1 &&
                au.nodeValue.charCodeAt(0) === 65279
              ) &&
              au.id !== '_mce_caret'
            ) {
              if (!ar) {
          ...
          if (ah.inline || ah.wrapper) {
            ...
            O(ac, function(av) {
              O(c.select(av.inline, at), function(ax) {
                ...
                T(av, ag, ax, av.exact ? ax : null);
              });
            });
            if (x(at.parentNode, Y, ag)) {
              c.remove(at, 1);
              at = 0;
              return B;
            }
      ...
      if (ah) {
        if (ab) {
          ...
          if (
            ...
            var aj = U.selection.getNode();
            U.selection.setRng(aa());
            af = q.getBookmark();
    ...
    function A(X, ag, aa) {
      ...
      function ac(ak) {
        var al;
        O(m(ak.parentNode).reverse(), function(am) {
          var an;
      ...
      function ad(am) {
        var al = c.get(am ? '_start' : '_end'),
          ak = al[am ? 'firstChild' : 'lastChild'];
        if (H(ak)) {
      ...
      function aj(ak) {
        ...
        if (ai.split) {
          ...
          am = J(ak);
          if (al != am) {
            al = N(al, 'span', { id: '_start', 'data-mce-type': 'bookmark' });
            am = N(am, 'span', { id: '_end', 'data-mce-type': 'bookmark' });
            ah(al);
            ah(am);
            al = ad(B);
            am = ad();
        ...
        K.walk(ak, function(an) {
          O(an, function(ao) {
            ...
            if (
              ao.nodeType === 1 &&
              U.dom.getStyle(ao, 'text-decoration') === 'underline' &&
              ao.parentNode &&
      ...
      if (
        ...
        aj(q.getRng(B));
        q.moveToBookmark(af);
        if (ai.inline && j(X, ag, q.getStart())) {
          Z(q.getRng(true));
        }
        U.nodeChanged();
      } else {
      ...
      if (a.isWebKit) {
        U.execCommand('mceCleanup');
      }
    }
    function D(W, Y, X) {
      var V = Q(W);
      if (j(W, Y, X) && (!('toggle' in V[0]) || V[0]['toggle'])) {
        A(W, Y, X);
      } else {
        S(W, Y, X);
      }
        ...
        if (ae) {
          if (ae.length === p) {
            ...
            for (af = 0; af < ae.length; af++) {
              if (
                ak === 'attributes' ? c.getAttrib(ah, ae[af]) : L(ah, ae[af])
              ) {
                return aj;
              }
            }
    ...
    function o(V, ah, Y) {
      ...
      function ai(aq) {
        var al, ao, ap, an, am;
        al = ao = aq ? X : ak;
        am = aq ? 'previousSibling' : 'nextSibling';
        root = c.getRoot();
        if (al.nodeType == 3 && !f(al)) {
          if (aq ? ac > 0 : ae < al.nodeValue.length) {
            return al;
          }
        }
        for (;;) {
          if (ao == root || (!ah[0].block_expand && F(ao))) {
            return ao;
          }
          for (an = ao[am]; an; an = an[am]) {
            if (!H(an) && !f(an)) {
              return ao;
            }
          }
      ...
      function aa(al, am) {
        if (am === p) {
          am = al.nodeType === 3 ? al.length : al.childNodes.length;
        }
        while (al && al.hasChildNodes()) {
          al = al.childNodes[am];
          if (al) {
            am = al.nodeType === 3 ? al.length : al.childNodes.length;
          }
        }
        return { node: al, offset: am };
      }
      if (X.nodeType == 1 && X.hasChildNodes()) {
        ag = X.childNodes.length - 1;
        X = X.childNodes[ac > ag ? ag : ac];
        if (X.nodeType == 3) {
          ac = 0;
        }
      }
      if (ak.nodeType == 1 && ak.hasChildNodes()) {
        ag = ak.childNodes.length - 1;
        ak = ak.childNodes[ae > ag ? ag : ae - 1];
        if (ak.nodeType == 3) {
          ae = ak.nodeValue.length;
        }
      }
      if (H(X.parentNode) || H(X)) {
        X = H(X) ? X : X.parentNode;
        X = X.nextSibling || X;
        if (X.nodeType == 3) {
          ac = 0;
        }
      }
      if (H(ak.parentNode) || H(ak)) {
        ak = H(ak) ? ak : ak.parentNode;
        ak = ak.previousSibling || ak;
        if (ak.nodeType == 3) {
          ae = ak.length;
        }
      }
      if (ah[0].inline) {
        if (V.collapsed) {
          function ad(am, aq, at) {
            ...
            function ao(av, ax) {
              ...
              if (at) {
                ay = aw.lastIndexOf(' ', ax);
                au = aw.lastIndexOf('\u00a0', ax);
                ay = ay > au ? ay : au;
                if (ay !== -1 && !Y) {
                  ay++;
                }
            ...
            ap = new t(am, c.getParent(am, F) || U.getBody());
            while ((an = ap[at ? 'prev' : 'next']())) {
              if (an.nodeType === 3) {
                al = an;
                ar = ao(an);
                if (ar !== -1) {
                  return { container: an, offset: ar };
                }
              } else {
                if (F(an)) {
                  break;
        ...
        ab = aa(ak, ae);
        if (ab.node) {
          while (ab.node && ab.offset === 0 && ab.node.previousSibling) {
            ab = aa(ab.node.previousSibling);
          }
          if (
            ab.node &&
            ab.offset > 0 &&
            ab.node.nodeType === 3 &&
            ab.node.nodeValue.charAt(ab.offset - 1) === ' '
          ) {
            if (ab.offset > 1) {
              ak = ab.node;
              ak.splitText(ab.offset - 1);
            } else {
              if (ab.node.previousSibling) {
              }
            }
          }
        }
      }
      if (ah[0].inline || ah[0].block_expand) {
        if (!ah[0].inline || (X.nodeType != 3 || ac === 0)) {
          X = ai(true);
        }
        if (!ah[0].inline || (ak.nodeType != 3 || ae === ak.nodeValue.length)) {
          ak = ai();
        }
      }
      if (ah[0].selector && ah[0].expand !== R && !ah[0].inline) {
        function Z(am, al) {
          var an, ao, aq, ap;
          if (am.nodeType == 3 && am.nodeValue.length == 0 && am[al]) {
            am = am[al];
          }
          an = m(am);
          for (ao = 0; ao < an.length; ao++) {
            for (aq = 0; aq < ah.length; aq++) {
              ap = ah[aq];
              if ('collapsed' in ap && ap.collapsed !== V.collapsed) {
                continue;
              }
              if (c.is(an[ao], ap.selector)) {
                return an[ao];
              }
            }
          }
      ...
      if (ah[0].block || ah[0].selector) {
        function W(am, al, ao) {
          var an;
          if (!ah[0].wrapper) {
            an = c.getParent(am, ah[0].block);
          }
          if (!an) {
            an = c.getParent(am.nodeType == 3 ? am.parentNode : am, F);
          }
          if (an && ah[0].wrapper) {
            an = m(an, 'ul,ol').reverse()[0] || an;
          }
          if (!an) {
            an = am;
            while (an[al] && !F(an[al])) {
    ...
    function T(ab, aa, Y, V) {
      ...
      if (ab.remove != 'all') {
        ...
        O(ab.attributes, function(ae, ac) {
          var ad;
          ae = r(ae, aa);
          if (typeof ac === 'number') {
            ac = ae;
        ...
        if (!l) {
          ...
          if (V == c.getRoot()) {
            if (!Y.list_block || !g(X, Y.list_block)) {
              O(a.grep(X.childNodes), function(aa) {
    ...
    function H(V) {
      return (
        V && V.nodeType == 1 && V.getAttribute('data-mce-type') == 'bookmark'
      );
    }
    function u(Z, Y) {
      var V, X, W;
      function ab(ae, ad) {
        ...
        if (
          !af(
            c.parseStyle(c.getAttrib(ae, 'style')),
            c.parseStyle(c.getAttrib(ad, 'style')),
          )
        ) {
          return R;
        }
      ...
      if (Z && Y) {
        function aa(ad, ac) {
          for (X = ad; X; X = X[ac]) {
            if (X.nodeType == 3 && X.nodeValue.length !== 0) {
              return ad;
            }
            if (X.nodeType == 1 && !H(X)) {
              return X;
        ...
        if (ab(Z, Y)) {
          ...
          c.remove(Y);
          O(a.grep(Y.childNodes), function(ac) {
            Z.appendChild(ac);
          });
          return Z;
        }
    ...
    function J(W, aa) {
      var V, Z, X, Y;
      V = W[aa ? 'startContainer' : 'endContainer'];
      Z = W[aa ? 'startOffset' : 'endOffset'];
      if (V.nodeType == 1) {
        X = V.childNodes.length - 1;
        if (!aa && Z) {
          Z--;
        }
        V = V.childNodes[Z > X ? X : Z];
      }
      if (V.nodeType === 3 && aa && Z >= V.nodeValue.length) {
        V = new t(V, U.getBody()).next() || V;
      }
      if (V.nodeType === 3 && !aa && Z == 0) {
        V = new t(V, U.getBody()).prev() || V;
      }
      return V;
    }
    function P(ae, V, ac) {
      var ah,
        af = '_mce_caret',
        W = U.settings.caret_debug;
      ah = a.isGecko ? '\u200B' : E;
      function X(aj) {
        var ai = c.create('span', {
          id: af,
          'data-mce-bogus': true,
          style: W ? 'color:red' : '',
        });
        if (aj) {
          ai.appendChild(U.getDoc().createTextNode(ah));
        }
        return ai;
      }
      function ad(aj, ai) {
        while (aj) {
          if (
            (aj.nodeType === 3 && aj.nodeValue !== ah) ||
            aj.childNodes.length > 1
          ) {
            return false;
          }
          if (ai && aj.nodeType === 1) {
      ...
      function Y(ak, aj) {
        ...
        if (!ak) {
          ...
          if (ad(ak)) {
            if (aj !== false) {
              ai.setStartBefore(ak);
              ai.setEndBefore(ak);
            }
            c.remove(ak);
          } else {
            al = Z(ak);
            al = al.deleteData(0, 1);
            c.remove(ak, 1);
          }
          q.setRng(ai);
        }
      ...
      function ab() {
        var ak, ai, ao, an, al, aj, am;
        ak = q.getRng(true);
        an = ak.startOffset;
        aj = ak.startContainer;
        am = aj.nodeValue;
        ai = aa(q.getStart());
        if (ai) {
          ao = Z(ai);
        ...
        if (
          ...
          q.setCursorLocation(ao, an);
        }
      }
      function ag() {
        var ai = q.getRng(true),
          aj,
          al,
          ao,
          an,
          ...
          am,
          ap;
        aj = ai.startContainer;
        al = ai.startOffset;
        ak = aj;
        if (aj.nodeType == 3) {
          if (al != aj.nodeValue.length || aj.nodeValue === ah) {
            an = true;
          }
          ak = ak.parentNode;
        }
        ...
        if (an) {
          ...
          ap = X();
          ak = ap;
          for (am = aq.length - 1; am >= 0; am--) {
            ak.appendChild(aq[am].cloneNode(false));
            ak = ak.firstChild;
          }
          ak.appendChild(c.doc.createTextNode(ah));
          ak = ak.firstChild;
          c.insertAfter(ap, ar);
          q.setCursorLocation(ak, 1);
        }
      }
      U.onBeforeGetContent.addToTop(function() {
        var ai = [],
          aj;
        if (ad(aa(q.getStart()), ai)) {
          aj = ai.length;
          while (aj--) {
            c.setAttrib(ai[aj], 'data-mce-bogus', '1');
          }
        }
      });
      a.each('onMouseUp onKeyUp'.split(' '), function(ai) {
        U[ai].addToTop(function() {
          Y();
        });
      });
      U.onKeyDown.addToTop(function(ai, ak) {
        var aj = ak.keyCode;
        if (aj == 8 || aj == 37 || aj == 39) {
          Y(aa(q.getStart()));
        }
