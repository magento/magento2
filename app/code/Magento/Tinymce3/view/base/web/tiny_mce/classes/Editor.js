...
(function(tinymce) {
  ...
  tinymce.create('tinymce.Editor', {
      ...
      t.settings = s = extend(
        {
          ...
          font_size_legacy_values:
            'xx-small,small,medium,large,x-large,xx-large,300%', // See: http://www.w3.org/TR/CSS2/fonts.html#propdef-font-size
      ...
      t.parser.addNodeFilter('p,h1,h2,h3,h4,h5,h6,div', function(nodes, name) {
        ...
        while (i--) {
          ...
          if (node.isEmpty(nonEmptyElements))
            node
              .empty()
              .append(new tinymce.html.Node('br', 1)).shortEnded = true;
        }
      });
    ...
    setupContentEditable: function() {
      ...
      if (!s.gecko_spellcheck) t.getDoc().body.spellcheck = 0;
      ...
      if (isIE) {
        ...
        t.onBeforeExecCommand.add(function(ed, cmd, ui, val, o) {
          if (
            !DOM.getParent(ed.selection.getStart(), function(n) {
              return n == ed.getBody();
            })
          )
            o.terminate = 1;
          ...
          if (
            !DOM.getParent(ed.selection.getEnd(), function(n) {
              return n == ed.getBody();
            })
          )
            o.terminate = 1;
    ...
    focus: function(sf) {
      ...
      if (!sf) {
        ...
        // Content editable mode ends here
        if (ce) {
          if (tinymce.isWebKit) t.getWin().focus();
          else {
            if (tinymce.isIE) t.getElement().setActive();
            else t.getElement().focus();
          }
        }
