...
(function() {
  if (!window.Prototype) return alert('Load prototype first!');
              ...
              if (parent.isEmpty(nonEmptyElements)) {
                ...
                if (elementRule) {
                  if (elementRule.removeEmpty) parent.remove();
                    ...
                    parent
                      .empty()
                      .append(new tinymce.html.Node('#text', 3)).value =
                      '\u00a0';
                }
              }
            }
  ...
  tinymce.Formatter = function(ed) {
    ...
    function performCaretAction(type, name, vars) {
      ...
      function isCaretContainerEmpty(node, nodes) {
        while (node) {
          if (
            (node.nodeType === 3 && node.nodeValue !== invisibleChar) ||
      ...
      function removeCaretFormat() {
        ...
        if (container.nodeType == 3) {
          if (
            offset != container.nodeValue.length ||
            container.nodeValue === invisibleChar
          ) {
