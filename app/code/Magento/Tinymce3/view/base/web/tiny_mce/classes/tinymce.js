...
(function(win) {
  var whiteSpaceRe = /^\s*|\s*$/g,
    undefined,
    isRegExpBroken = 'B'.replace(/A(.)|B/, '$1') === '$1';
  ...
  var tinymce = {
    ...
    makeMap: function(items, delim, map) {
      ...
      if (typeof items == 'string') items = items.split(delim);
        ...
        function unload() {
          ...
          if (li) {
            ...
            for (n in li) {
              ...
              if (o && o.func) o.func.call(o.scope, 1); // Send in one arg to distinct unload and user destroy
            }
