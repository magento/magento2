...
(function() {
  ...
  window.FullPageDialog = {
    ...
    changedStyleProp: function() {
      ...
      if ((val = getVal('rightmargin'))) styles['margin-right'] = val + 'px';
      else styles['margin-right'] = '';

      if ((val = getVal('bottommargin'))) styles['margin-bottom'] = val + 'px';
      else styles['margin-bottom'] = '';

      if ((val = getVal('leftmargin'))) styles['margin-left'] = val + 'px';
    ...
    update: function() {
      ...
      tinymce.each(tinyMCEPopup.dom.select('select,input,textarea'), function(
        node,
      ) {
  ...
  function init() {
    ...
    document.getElementById('bgimage_pickcontainer').innerHTML = getBrowserHTML(
      'bgimage_browser',
      'bgimage',
      'image',
      'fullpage',
