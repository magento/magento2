  ...
  tinymce.create('tinymce.InlineWindowManager:tinymce.WindowManager', {
    ...
    open: function(s, j) {
      ...
      if (s.type) {
        ...
        if (s.type) {
          k +=
            ' mce' + s.type.substring(0, 1).toUpperCase() + s.type.substring(1);
        }
        s.resizable = false;
      }
      if (s.statusbar) {
      ...
      z._addAll(d.doc.body, [
        'div',
        {
          ...
          class:
            (r.settings.inlinepopups_skin || 'clearlooks2') +
        ...
        [
          ...
          [
            ...
            ['div', { class: 'mceCenter' }],
            ['div', { class: 'mceRight' }],
            ['span', { id: i + '_title' }, s.title || ''],
          ],
          [
            'div',
            { id: i + '_middle', class: 'mceMiddle' },
            ['div', { id: i + '_left', class: 'mceLeft', tabindex: '0' }],
            ['span', { id: i + '_content' }],
            ['div', { id: i + '_right', class: 'mceRight', tabindex: '0' }],
          ],
          [
            'div',
      ...
      if (
        z.count == 0 &&
        z.editor.getParam('dialog_type', 'modal') == 'modal'
      ) {
        d.add(d.doc.body, 'div', {
          id: 'mceModalBlocker',
          class:
            (z.editor.settings.inlinepopups_skin || 'clearlooks2') +
            '_modalBlocker',
