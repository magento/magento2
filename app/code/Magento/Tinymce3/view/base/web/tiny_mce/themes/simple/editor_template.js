(function() {
  ...
  tinymce.create('tinymce.themes.SimpleTheme', {
    init: function(c, d) {
      ...
      a.loadCSS(
        (f.editor_css ? c.documentBaseURI.toAbsolute(f.editor_css) : '') ||
    ...
    renderUI: function(h) {
      ...
      i = a.add(a.add(c, 'tr', { class: 'last' }), 'td', {
      ...
      c.add(
        f.createButton('italic', {
          title: 'simple.italic_desc',
          cmd: 'Italic',
        }),
      );
      c.add(
        f.createButton('underline', {
          title: 'simple.underline_desc',
          cmd: 'Underline',
        }),
      );
      c.add(
        f.createButton('strikethrough', {
      ...
      c.add(f.createSeparator());
      c.add(
        f.createButton('insertunorderedlist', {
          title: 'simple.bullist_desc',
          cmd: 'InsertUnorderedList',
        }),
      );
      c.add(
        f.createButton('insertorderedlist', {
