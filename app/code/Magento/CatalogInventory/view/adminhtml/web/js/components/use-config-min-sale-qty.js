...
define([
  ...
  return checkbox.extend({
    ...
    initObservable: function() {
      return this._super().observe(['valueFromConfig']);
    },
    ...
    onCheckedChanged: function(newChecked) {
      ...
      if (
        newChecked &&
        ((_.isArray(valueFromConfig) && valueFromConfig.length === 0) ||
          valueFromConfig === 1)
      ) {
     ...
     */
    changeVisibleDisabled: function(
      filter,
      visible,
      disabled,
      valueFromConfig,
    ) {
      registry.async(filter)(function(currentComponent) {
