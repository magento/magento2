 ...
 */
namespace Magento\SearchStorefrontAdvancedSearch\Model\Recommendations;
...
class DataProvider implements SuggestedQueriesInterface
{
    ...
    /**
     * @var \Magento\SearchStorefrontAdvancedSearch\Model\ResourceModel\RecommendationsFactory
     */
     ...
     * @param \Magento\SearchStorefrontAdvancedSearch\Model\ResourceModel\RecommendationsFactory $recommendationsFactory
     * @param \Magento\Search\Model\QueryResultFactory $queryResultFactory
     */
    public function __construct(
        ScopeConfigInterface $scopeConfig,
        \Magento\Catalog\Model\Layer\Resolver $layerResolver,
        \Magento\SearchStorefrontAdvancedSearch\Model\ResourceModel\RecommendationsFactory $recommendationsFactory,
    ...
    private function getSearchRecommendations(\Magento\Search\Model\QueryInterface $query)
    {
        ...
        if ($this->isSearchRecommendationsEnabled()) {
            ...
            /** @var \Magento\SearchStorefrontAdvancedSearch\Model\ResourceModel\Recommendations $recommendationsResource */
