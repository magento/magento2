 ...
 */
namespace Magento\SearchStorefrontAdvancedSearch\Model;
        ...
        if (empty($this->dataProvider)) {
            ...
            if (!$this->dataProvider instanceof SuggestedQueriesInterface) {
                throw new \InvalidArgumentException(
                    'Data provider must implement \Magento\SearchStorefrontAdvancedSearch\Model\SuggestedQueriesInterface'
                );
            }
        }
