    ...
    public function create($engine = '', array $data = [])
    {
        ...
        if (!($factory instanceof ClientFactoryInterface)) {
            throw new \InvalidArgumentException(
                'Client factory must implement \Magento\SearchStorefrontAdvancedSearch\Model\Client\ClientFactoryInterface'
            );
        }
        ...
        if (!($clientOptions instanceof ClientOptionsInterface)) {
            throw new \InvalidArgumentException(
                'Client options must implement \Magento\SearchStorefrontAdvancedSearch\Model\Client\ClientInterface'
            );
        }
