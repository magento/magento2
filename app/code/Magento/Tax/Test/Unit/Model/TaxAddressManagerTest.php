...
class TaxAddressManagerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->customerSessionMock = $this->createPartialMockWithReflection(
            Session::class,
            ['setDefaultTaxBillingAddress', 'setDefaultTaxShippingAddress']
        );
    ...
    public function testSetDefaultAddressAfterSave(
        ...
        $customer = $this->createPartialMockWithReflection(
            Customer::class,
            ['getDefaultBilling', 'getDefaultShipping']
        );
    ...
    public function testSetDefaultAddressAfterLogIn(
        bool $isAddressDefaultBilling,
        bool $isAddressDefaultShipping
    ): void {
