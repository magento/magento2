...
class DataTest extends \PHPUnit\Framework\TestCase
{
     ...
     */
    public function testSetAddressCustomerSessionAddressSave(
        $addressId,
        $billingInfo,
        $shippingInfo,
        $needSetShipping,
        ...
        $this->helper->setAddressCustomerSessionAddressSave($address);
    }
     ...
     */
    public function testSetAddressCustomerSessionLogIn(
        ...
        $this->helper->setAddressCustomerSessionLogIn([$address]);
    }
