...
class MassUnassignTest extends TestCase
{
    /**
     * @var MassUnassignInterface
     */
    private $massUnassign;
    ...
    {
        parent::setUp();
        $this->massUnassign = Bootstrap::getObjectManager()->get(MassUnassignInterface::class);
    ...
    public function testMassSourceAssignment()
    {
        ...
        $count = $this->massUnassign->execute($skus, $sources);
