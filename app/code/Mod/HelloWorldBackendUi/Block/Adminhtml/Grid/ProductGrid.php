...
use Mod\HelloWorldBackendUi\Model\ResourceModel\Grid\Grid\Collection;

/**
 * Product edit form extra comments grid block.
 */
class ProductGrid extends Extended
{
    ...
    protected function _prepareCollection()
    {
        ...
        /**
         * @var Collection $extraCommentCollection
         */
        $extraCommentCollection = $this->extraCommentCollectionFactory->create()->addFieldToSelect('*');
        $extraCommentCollection->addFieldToFilter('product_sku', $productSku);
