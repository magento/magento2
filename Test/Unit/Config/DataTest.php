...
class DataTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->readerMock = $this->getMockBuilder('Magento\Framework\Amqp\Config\Reader')
    ...
    public function testGet()
    {
        ...
        $configData = new \Magento\Framework\Amqp\Config\Data($this->readerMock, $this->cacheMock);
