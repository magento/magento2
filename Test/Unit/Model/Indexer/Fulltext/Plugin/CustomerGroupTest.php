 ...
 */
namespace Magento\Elasticsearch\Test\Unit\Model\Indexer\Fulltext\Plugin;

use Magento\Elasticsearch\Model\Indexer\Fulltext\Plugin\CustomerGroup;
...
class CustomerGroupTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \PHPUnit_Framework_MockObject_MockObject|\Magento\Elasticsearch\Model\Config
     */
    ...
    protected function setUp()
    {
        ...
        $this->configMock = $this->getMock('Magento\Elasticsearch\Model\Config', [], [], '', false);
        ...
        $this->model = new \Magento\Elasticsearch\Model\Indexer\Fulltext\Plugin\CustomerGroup(
