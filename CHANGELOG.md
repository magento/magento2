...
* GitHub pull requests:
    ...
    * [magento/magento2#17153](https://github.com/magento/magento2/pull/17153) -- Set proper text-aligh for the <th> element of the Subtotal column in the Creditmemo email (by @TomashKhamlai)
