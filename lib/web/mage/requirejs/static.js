...
/**
 * Module responsible for collecting statistics data regarding modules that have
 * been loader via bundle.
 */
define('buildStats', [], function () {
    'use strict';
    ...
    function uniq(arr) {
        return arr.filter(function (entry, i) {
            return entry.indexOf(arr) <= i;
        });
    };

    /**
     * Takes first array passed, removes all entries which further arrays contain.
