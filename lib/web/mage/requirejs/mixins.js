define('mixins', [
     ...
     *
     * @param {String} name - Name, name or alias of a module.
    ...
    return {
         ...
         *
         * @param {Array} names - An array names, paths or aliases.
...
require([
     ...
     *
     * @param {Object} obj - Object whose should be retrieved.
    ...
    window.define = function (name, deps, callback) {
        ...
        require._globalDefQueue.push([name, deps, callback]);
    };
