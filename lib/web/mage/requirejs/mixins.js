...
require([
    ...
    var originalRequire  = window.require,
        ...
        contexts         = ('s' in originalRequire) ? originalRequire.s.contexts :  originalRequire.contexts,
        defContextName   = '_',
    ...
    window.require = function (deps, callback, errback, optional) {
        ...
        if (!context) {
            context = contexts[contextName] = ('s' in require) ? require.s.newContext(contextName) : require.newContext(contextName);
        }
    ...
    window.define = function (name, deps, callback) { // eslint-disable-line no-unused-vars
        var context     = getOwn(contexts, defContextName),
            ...
            queueItem   = ('s' in require) ? require.exec(getLastInQueue) : originalRequire.queue[originalRequire.queue.length - 1],
