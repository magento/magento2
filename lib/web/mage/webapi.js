  ...
  $.mage.Webapi = function(baseUrl, ajaxArgs) {
    ...
    this.call = function(resourceUri, method, data, version) {
      ...
      function getUrl(resUri, m, payload, v) {
        ...
        if (
          payload &&
          [that.method.get, that.method['delete']].indexOf(m) !== -1
        ) {
        ...
        return (
          that.resource.uri.base +
          that.resource.uri.api +
          ensureForwardSlash(resUri)
        );
      }
