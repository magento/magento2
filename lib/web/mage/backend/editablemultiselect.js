...
define([
     ...
     *  {String} settings[add_button_caption] caption of the 'Add New Value' button
     *  {String} settings[new_url] URL to which new request has to be submitted
     *  {String} settings[save_url] URL to which save request has to be submitted
     *  {String} settings[delete_url] URL to which delete request has to be submitted
     *  {String} settings[delete_confirm_message] confirmation message that is shown to user during delete operation
     *  {String} settings[target_select_id] HTML ID of target select element
     *  {Hash} settings[submit_data] extra parameters to send with new/edit/delete requests
     *  {String} settings[entity_value_name] name of the request parameter that represents select option text
     *  {String} settings[entity_id_name] name of the request parameter that represents select option value
     *  {Boolean} settings[is_entry_editable] flag that shows if user can add/edit/remove data
     *
     * @constructor
     */
