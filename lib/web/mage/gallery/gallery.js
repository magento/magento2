    ...
    return Class.extend({
        ...
        initialize: function (config, element) {
            ...
            this.settings.$element.on('mouseup', '.fotorama__stage__frame', function () {
                if (
                    !$(this).parents('.fotorama__shadows--left').length &&
                    !$(this).parents('.fotorama__shadows--right').length
                ) {
                    self.openFullScreen();
                }
            });
            ...
            if (this.isTouchEnabled) {
                this.settings.$element.on('tap', '.fotorama__stage__frame', function () {
                    var translate = self.getTranslate($(this).parents('.fotorama__stage__shaft'));
