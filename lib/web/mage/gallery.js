...
(function (root, factory) {
    ...
    $.widget('mage.gallery', {
        ...
        _renderWrapper: function () {
            return $(mageTemplate(this.options.wrapperTemplate, {}));
        },
        ...
        _renderControl: function (control) {
            ...
            switch (control) {
                case 'baseImage':
                    templateData = $.extend({
                            ...
                            fullSizeMode: this.options.fullSizeMode,
                            medium: '',
                            large: '',
                            title: ''
                        },
                ...
                case 'notice':
                    templateData = {
                        text: this.options.controls.notice.text || ''
                    };
                    break;
            }
            ...
            this[control] = $(mageTemplate(options.controls[control].template, templateData));
