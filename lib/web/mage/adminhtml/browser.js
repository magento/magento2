...
define([
  ...
  $.widget('mage.mediabrowser', {
    ...
    _selectNode: function(event, data) {
      ...
      this.element
        .find('#delete_files, #insert_files')
        .toggleClass(this.options.hidden, true);
    ...
    insertAtCursor: function(element, value) {
      ...
      if ('selection' in document) {
        ...
        element.selectionEnd =
          startPos +
          value.length +
          element.value.substring(startPos, endPos).length;
    ...
    selectFolder: function(event) {
      this.element
        .find('[data-id="' + $(event.currentTarget).data('node').id + '"]>a')
        .click();
    },
    ...
    getTargetElement: function() {
      ...
      if (
        typeof wysiwyg != 'undefined' &&
        wysiwyg.get(this.options.targetElementId)
      ) {
        opener = this.getMediaBrowserOpener() || window;
        targetElementId = tinyMceEditors
          .get(this.options.targetElementId)
    ...
    getMediaBrowserOpener: function() {
      if (
        ...
        !tinyMceEditors
          .get(this.options.targetElementId)
          .getMediaBrowserOpener().closed
      ) {
        return tinyMceEditors
          .get(this.options.targetElementId)
          ...
          confirm: function() {
            ...
            return $.ajax({
              ...
              $.proxy(function() {
                ...
                self.element
                  .find('#delete_files, #insert_files')
                  .toggleClass(self.options.hidden, true);
