...
define([
  ...
  AdminBackup.prototype = {
    ...
    toggleFtpCredentialsForm: function() {
      $('use_ftp').checked
        ? $('ftp-credentials-container').show()
    ...
    displayError: function(parentContainer, message) {
      ...
      $$('#' + parentContainer + ' .backup-messages .messages').invoke(
        'update',
        messageHtml,
      );
    ...
    backupConfig: {
      ...
      'rollback-warning': {
         ...
         */
        content: function() {
          return document.getElementById('rollback-warning-template')
            .textContent;
        },
      ...
      'rollback-request-password': {
         ...
         */
        content: function() {
          return document.getElementById('rollback-request-password-template')
            .textContent;
        },
