...
function toggleSeveralValueElements(
  checkbox,
  containers,
  excludedElements,
  checked,
...
function toggleValueElements(checkbox, container, excludedElements, checked) {
  if (container && checkbox) {
    ...
    if (typeof excludedElements != 'undefined') {
      if (
        Object.prototype.toString.call(excludedElements) != '[object Array]'
      ) {
    ...
    var elems = Element.select(container, [
      'select',
      'input',
      'textarea',
      'button',
