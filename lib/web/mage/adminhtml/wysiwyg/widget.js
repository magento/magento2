...
define([
    ...
    var widgetTools = {
            ...
            openDialog: function (widgetUrl) {
                ...
                if(this.activeSelectedNode !== undefined) {
                    title = jQuery.mage.__('Edit Widget');
                    mode = 'edit';
                }
                ...
                this.dialogWindow = jQuery('<div/>').modal({
                    ...
                    opened: function () {
                        ...
                        new Ajax.Updater($(this), widgetUrl, {
                             ...
                             */
                            onComplete: function () {
                                var msg = jQuery.mage.__('Inserting a widget does not create a widget instance.');
    ...
    WysiwygWidget.Widget.prototype = {
        ...
        closeDialog: function () {
            widgetTools.dialogWindow.modal('closeModal').remove();
        }
    };
