...
define(['underscore'], function(_) {
  ...
  schema.flowContent = schema.blockContent.concat(schema.phrasingContent, [
    'style',
  ]);
  schema.nonEmpty = [
    'td',
  ...
  _.extend(
    ...
    (function(phrasingContent, flowContent) {
      ...
      rawData = [
        ...
        [
          'a',
          'href target rel media hreflang type charset name rev shape coords download',
          phrasingContent,
        ],
        ...
        [
          'img',
          'src sizes srcset alt usemap ismap width height name longdesc align border hspace vspace',
        ],
        [
          'iframe',
        ...
        [
          ...
          'caption colgroup thead tfoot tbody tr col',
        ],
        ...
        [
          'td',
          'colspan rowspan headers abbr axis scope align char charoff valign nowrap bgcolor width height',
          flowContent,
        ],
        [
          'th',
          'colspan rowspan headers scope abbr axis align char charoff valign nowrap bgcolor width height accept',
          flowContent,
        ],
        [
          'form',
          'accept-charset action autocomplete enctype method name novalidate target onsubmit onreset',
          flowContent,
        ],
        ...
        [
          'select',
          'disabled form multiple name required size onfocus onblur onchange',
          'option optgroup',
        ],
