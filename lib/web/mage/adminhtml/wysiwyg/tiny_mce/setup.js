...
define([
    ...
    tinyMceWysiwygSetup.prototype = {
        ...
        /**
         * Set content to textarea from o.content
         *
         * @param {Object} o
         */
        setContentToTextarea: function(o) {
            if (tinyMCE.get(this.id)) {
                jQuery(o.element).val(o.content);
                jQuery(o.element).trigger('change');
            }
        }
    };
