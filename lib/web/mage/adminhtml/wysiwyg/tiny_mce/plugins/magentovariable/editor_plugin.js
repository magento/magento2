    ...
    return function (config) {
        tinymce.create('tinymce.plugins.magentovariable', {
            ...
            init: function (editor, url) {
                 ...
                 */
                const svgPath = url  + '/img/icon.svg'
                jQuery.get(svgPath).then(svg => {
                    editor.ui.registry.addIcon('magentovariable', svg.documentElement.outerHTML);
                    editor.ui.registry.addToggleButton('magentovariable', {
                        icon: 'magentovariable',
                        tooltip: jQuery.mage.__('Insert Variable'),
                        onAction: () => editor.execCommand('openVariablesSlideout'),
                        /**
