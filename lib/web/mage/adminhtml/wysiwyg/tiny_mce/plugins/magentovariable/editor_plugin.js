...
(function () {
        ...
        tinymce.PluginManager.add('magentovariable', function (ed, url) {
            ...
            ed.addCommand('openVariablesSlideout', function (commandConfig) {
                ...
                var pluginSettings = ed.settings.magentoPluginsOptions.magentovariable;MagentovariablePlugin.setEditor(ed);
                MagentovariablePlugin.loadChooser(
                    pluginSettings.url,
                    this.settings.adapter.id,
                   variableCode, selectedElement);
        ...
        var $el = jQuery(evt.target),
            ...
            variableType;
                ...
                if (isVariable) {
                    ...
                    var node = editor.dom.select('#' + $el.attr('id'));
