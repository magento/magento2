        ...
        getSettings: function () {
            ...
            settings = {
                ...
                setup: function (editor) {
                    ...
                    // Keep empty icon tags like <i class="icon-x">; must run on PreInit, before init loads content.
                    editor.on('PreInit', function () {
                        _.each(['i', 'em', 'span'], function (tagName) {
                            var rule = editor.schema.getElementRule(tagName);
