...
define([
    ...
    'jquery/ui',
    'mage/translate',
    'mage/adminhtml/wysiwyg/tiny_mce/plugins/magentowidget/editor_plugin'
    ...
    tinyMce4Wysiwyg.prototype = {
        ...
        decodeWidgets: function (content) {
            return content.gsub(/(<span class="magento-placeholder magento-widget mceNonEditable">)?<img([^>]+id="[^>]+)>(([^>]*)<\/span>)?/i, function (match) {
