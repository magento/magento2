...
], function (jQuery, _, tinyMCE4, configDirectiveGenerator, customDirectiveGenerator, variables) {
    'use strict';
        ...
        encodeVariables: function (content) {
            ...
            content = content.gsub(/\{\{customVar code=([^\"]+)\}\}/i, function (match) {
                ...
                if (this.magentoVariables[match[1]]) {
                    ...
                    imageHtml = '<span id="%id" class="magento-variable magento-custom-var magento-variable-lost mceNonEditable">Not found</span>';
                }
