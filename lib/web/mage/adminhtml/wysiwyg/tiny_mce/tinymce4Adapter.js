            ...
            settings = {
                ...
                setup: function (editor) {
                    ...
                    editor.on('BeforeSetContent', function (evt) {
                        ...
                        eventBus.fireEvent('tinymceBeforeSetContent');
                    });

                    editor.on('SaveContent', function (evt) {
                        varienGlobalEvents.fireEvent('tinymceSaveContent', evt);
                        eventBus.fireEvent('tinymceSaveContent');
                    });

                    editor.on('paste', function (evt) {
                        varienGlobalEvents.fireEvent('tinymcePaste', evt);
                        eventBus.fireEvent('tinymcePaste');
                    });
                    ...
                    editor.on('undo', function (evt) {
                        ...
                        eventBus.fireEvent('tinymceUndo');
                    });

                    editor.on('focus', function () {
                        eventBus.fireEvent('tinymceFocus');
                    });

                    editor.on('blur', function () {
                        eventBus.fireEvent('tinymceBlur');
                    });
                    ...
                    onChange = function (evt) {
                        ...
                        eventBus.fireEvent('tinymceChange');
                    };
                    ...
                    editor.on('init', function (args) {
                        ...
                        eventBus.fireEvent('wysiwygEditorInitialized');
                    });
                }
            };
