...
define([
    ...
    return {
        ...
        */
        forEachRecursive: function fEachRec(data, action) {
            var prop;
        ...
        * @returns {*}
        */
        mapRecursive: function mapRec(data, action) {
            var newData;
