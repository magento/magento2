...
(function (factory) {
    ...
    var creditCartTypes = {
        ...
        'JCB': [new RegExp('^((2|21|213|2131\\d*)|(1|18|180|1800\\d*)|(3|35\\d*))$'), new RegExp('^[0-9]{3}$'), true],
        'OT': [new RegExp('^([0-9]+)$'), new RegExp('^([0-9]{3}|[0-9]{4})?$'), false],
        'DN': [new RegExp('^(3(0[0-5]|095|6|[8-9]))\\d*$'), new RegExp('^[0-9]{3}$'), true],
        'UN': [new RegExp('^(622(1(2[6-9]|[3-9])|[2-8]|9([[0-1]*|2[0-5]))|62[4-6]|628([2-8]))\\d*?$'), new RegExp('^[0-9]{3}$'), true],
