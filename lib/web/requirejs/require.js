 ...
 // eslint-disable-line no-shadow
        ...
        handlers = {
            'require': function (mod) {
                ...
                return (mod.require = context.makeRequire(mod.map)); // eslint-disable-line no-extra-parens
            },
 ...
 return value; }, null, {
        ...
        context = {
            ...
            onScriptError: function (evt) {
                var data = getScriptData(evt); // eslint-disable-line one-var

                if (!hasPathFallback(data.id)) {
                    var parents = [];         // eslint-disable-line one-var
