  ...
  function Magnify(element, options) {
    ...
    (curThumb = null),
      (magnifierOptions = {
        ...
        zoomAttached: false,
        zoomable:
          customUserOptions.zoomable !== undefined
        ...
        onthumbleave:
          customUserOptions.onthumbleave !== undefined
            ...
            : null,
        onzoom:
          customUserOptions.onzoom !== undefined
      ...
      (curLarge = null),
      (lensbg =
        customUserOptions.bg !== undefined ? customUserOptions.lensbg : true),
      (gZoom =
    ...
    function updateLensOnLoad(
      idSelectorMainImg,
      thumb,
      largeImgInMagnifyLens,
      largeWrapper,
    ) {
    ...
    function getMousePos() {
      ...
      inBounds =
        xPos < 0 ||
        yPos < 0 ||
        xPos > magnifierOptions.w ||
        yPos > magnifierOptions.h
          ? false
          : true;
      ...
      if (
        xPos - magnifierOptions.w + Math.ceil(magnifierOptions.lensW / 2) >
        0
      ) {
      ...
      if (
        yPos - magnifierOptions.h + Math.ceil(magnifierOptions.lensH / 2) >
        0
      ) {
      ...
      if (magnifierOptions.mode === 'inside') {
        magnifierOptions.largeL = Math.round(
          xPos *
            (magnifierOptions.zoom -
              magnifierOptions.lensW / magnifierOptions.w),
        );
        magnifierOptions.largeT = Math.round(
          yPos *
            (magnifierOptions.zoom -
              magnifierOptions.lensH / magnifierOptions.h),
        );
      } else {
        magnifierOptions.largeL = Math.round(
    ...
    function move() {
      if (_toBoolean(enabled)) {
        ...
        if (magnifierOptions.status > 0) {
          curThumb.className =
            magnifierOptions.thumbCssClass + ' magnify-opaque';
    ...
    function setThumbData(mainImage, mainImageData) {
      ...
      mainImageData.largeImgInMagnifyLensWidth = Math.round(
        mainImageData.zoom * w,
      );
      mainImageData.largeImgInMagnifyLensHeight = Math.round(
        mainImageData.zoom * h,
      );
    ...
    function set(options) {
      ...
      var thumbObj = new Image(),
        ...
        eventType =
          options.eventType ||
          thumb.getAttribute('data-eventType') ||
          gEventType,
        onthumbenter =
      ...
      largeUrl =
        $thumb.data('original') || customUserOptions.full || $thumb.attr('src');
