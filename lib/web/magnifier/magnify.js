        ...
        function magnifierFullscreen() {
            ...
            function setImageFullSize (e) {
                ...
                if ($image.width() >= $image.height() && $image.width() !== imgOriginalSize.rw) {
                    ...
                    checkFullscreenImagePosition($image, dimentions, -zoomWidthStepTemp, -zoomHeightStepTemp);
            ...
            $image.unbind('touchstart mousedown pointerdown MSPointerDown');
            ...
            $image.unbind('touchmove mousemove pointermove MSPointerMove');
