        ...
        function magnifierFullscreen() {
            ...
            function shiftImage(dx, dy, e) {
                ...
                if (($image.offset().left === $imageContainer.offset().left + $imageContainer.width() - $image.width() && e.keyCode === 39) ||
                    (endX === $imageContainer.offset().left + $imageContainer.width() - $image.width() && dx < 0 && e.type === 'mousemove')) {
                    endX = null;
                    swipeSlide('>');
                    return;
                }
                ...
                if (($image.offset().left === $imageContainer.offset().left && dx !== 0 && e.keyCode === 37) ||
                    (endX === $imageContainer.offset().left && dx > 0 && e.type === 'mousemove')) {
                    endX = null;
                    swipeSlide('<');
                    return;
                }
                ...
                } else if (Math.abs(dy) === 0 && e.type !== 'mousemove') {
                    dx < 0 ? $(gallerySelector).data('fotorama').show('>') : $(gallerySelector).data('fotorama').show('<');
                }

                if ($image.width() <= $imageContainer.width() && e.type === 'mousemove' && Math.abs(dx) > Math.abs(dy)) {
