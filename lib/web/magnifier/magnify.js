    ...
    return function (config, element) {
        ...
        function zoomIn(e) {
            ...
            if (zoomShown && allowZoomIn) {
                ...
                $(gallerySelector).data('fotorama').setOptions({
                    swipe: false
                });
            }
        ...
        function magnifierFullscreen() {
            ...
            function shiftImage(dx, dy, e) {
                ...
                if (($image.offset().left === $imageContainer.offset().left + $imageContainer.width() - $image.width() && e.type !== 'mousemove') ||
                ...
                if (($image.offset().left === $imageContainer.offset().left && dx !== 0 && e.type !== 'mousemove') ||
