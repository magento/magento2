...
(function() {
  ...
  var _7 = document.compatMode == 'CSS1Compat',
    _8 = ua.indexOf('opera') > -1,
    _9 = /webkit|khtml/.test(ua),
    _a = ua.indexOf('msie') > -1,
    _b = ua.indexOf('msie 7') > -1,
    _c = !_9 && ua.indexOf('gecko') > -1,
    _d = _a && !_7,
    _e = ua.indexOf('windows') != -1 || ua.indexOf('win32') != -1,
    _f = ua.indexOf('macintosh') != -1 || ua.indexOf('mac os x') != -1,
    _10 = window.location.href.toLowerCase().indexOf('https') === 0;
  if (_a && !_b) {
    try {
...
(function() {
  ...
  Ext.lib.Dom = {
    ...
    getXY: function(el) {
      ...
      if (el.getBoundingClientRect) {
        ...
        if (p != el) {
          while (p) {
            ...
            if (
              Ext.isSafari &&
              !_18 &&
              fly(p).getStyle('position') == 'absolute'
            ) {
              _18 = true;
            }
            if (Ext.isGecko) {
        ...
        if (
          Ext.isSafari &&
          (_18 || fly(el).getStyle('position') == 'absolute')
        ) {
          x -= bd.offsetLeft;
          y -= bd.offsetTop;
        }
  ...
  Ext.lib.Ajax = (function() {
    ...
    return {
      request: function(_41, uri, cb, _44) {
      ...
      formRequest: function(_45, uri, cb, _48, _49, _4a) {
        new Ajax.Request(uri, {
          method: Ext.getDom(_45).method || 'POST',
          parameters: Form.serialize(_45) + (_48 ? '&' + _48 : ''),
          timeout: cb.timeout,
          onSuccess: _3b(cb),
          onFailure: _3e(cb),
        });
  ...
  Ext.lib.Anim = (function() {
    ...
    return {
      scroll: function(el, _56, _57, _58, cb, _5a) {
        var _5b = _51(cb, _5a);
        el = Ext.getDom(el);
        el.scrollLeft = _56.scroll.to[0];
        el.scrollTop = _56.scroll.to[1];
        _5b.proxyCallback();
        return _5b;
      },
      ...
      run: function(el, _69, _6a, _6b, cb, _6d, _6e) {
        ...
        var _75 = _51(cb, _6d);
        _75.effect = new Effect.Morph(Ext.id(el), {
          duration: _6a,
          afterFinish: _75.proxyCallback,
          transition: _4e[_6b] || Effect.Transitions.linear,
          style: o,
        });
        return _75;
      },
  ...
  Ext.lib.Region.prototype = {
    contains: function(_7b) {
      return (
        _7b.left >= this.left &&
        _7b.right <= this.right &&
        _7b.top >= this.top &&
        _7b.bottom <= this.bottom
      );
    },
    getArea: function() {
    ...
    var _f = function(_10) {
      return function() {
        return this.fireEvent.apply(
          this,
          Ext.combine(_10, Array.prototype.slice.call(arguments, 0)),
        );
      };
    };
...
(function() {
  ...
  El.prototype = {
    ...
    anim: function(_24, opt, _26, _27, _28, cb) {
      _26 = _26 || 'run';
      opt = opt || {};
      var _2a = Ext.lib.Anim[_26](
        this.dom,
        _24,
        opt.duration || _27 || 0.35,
        opt.easing || _28 || 'easeOut',
        function() {
    ...
    hasClass: function(_79) {
      return (
        _79 && (' ' + this.dom.className + ' ').indexOf(' ' + _79 + ' ') != -1
      );
    },
        ...
        : function(_85) {
            ...
            if (_85 == 'opacity') {
              if (typeof el.filter == 'string') {
                var fv = parseFloat(
                  el.filter.match(/alpha\(opacity=(.*)\)/i)[1],
                );
                if (!isNaN(fv)) {
                  return fv ? fv / 100 : 0;
                }
    ...
    setBounds: function(x, y, _b7, _b8, _b9) {
      if (!_b9 || !A) {
        ...
        this.anim(
          { points: { to: [x, y] }, width: { to: _b7 }, height: { to: _b8 } },
    ...
    mask: function(msg, _15f) {
      ...
      if (!this._mask) {
        this._mask = Ext.DomHelper.append(
          this.dom,
          { tag: 'div', cls: 'ext-el-mask' },
          true,
        );
      }
      ...
      if (typeof msg == 'string') {
        if (!this._maskMsg) {
          this._maskMsg = Ext.DomHelper.append(
            this.dom,
            { tag: 'div', cls: 'ext-el-mask-msg', cn: { tag: 'div' } },
            true,
          );
        }
    ...
    fitToParent: function(_173, _174) {
      ...
      this.setSize(
        p.getComputedWidth() - p.getFrameWidth('lr'),
        p.getComputedHeight() - p.getFrameWidth('tb'),
      );
      if (_173 === true) {
        Ext.EventManager.onWindowResize(
          this.fitToParent.createDelegate(this, []),
        );
      }
      return this;
    },
    ...
    insertSibling: function(el, _182, _183) {
      ...
      el = el || {};
      var rt,
        _185 = _182 == 'before' ? this.dom : this.dom.nextSibling;
      if (typeof el == 'object' && !el.nodeType) {
        if (_182 == 'after' && !this.dom.nextSibling) {
          rt = Ext.DomHelper.append(this.dom.parentNode, el, !_183);
        } else {
          rt = Ext.DomHelper[_182 == 'after' ? 'insertAfter' : 'insertBefore'](
            this.dom,
            el,
            !_183,
          );
        ...
        rt = this.dom.parentNode.insertBefore(
          Ext.getDom(el),
          _182 == 'before' ? this.dom : this.dom.nextSibling,
        );
        if (!_183) {
          rt = Ext.get(rt);
        }
    ...
    set: function(o, _18d) {
      var el = this.dom;
      _18d =
        typeof _18d == 'undefined' ? (el.setAttribute ? true : false) : _18d;
      for (var attr in o) {
    ...
    scrollTo: function(side, _197, _198) {
      ...
      if (!_198 || !A) {
        ...
        var to =
          prop == 'scrollLeft'
            ? [_197, this.dom.scrollTop]
            : [this.dom.scrollLeft, _197];
...
Ext.Fx = {
  ...
  puff: function(o) {
    ...
    el.queueFx(o, function() {
      ...
      arguments.callee.anim = this.fxanim(
        {
          width: { to: this.adjustWidth(_1c * 2) },
          height: { to: this.adjustHeight(_1d * 2) },
          points: { by: [-(_1c * 0.5), -(_1d * 0.5)] },
          opacity: { to: 0 },
  ...
  switchOff: function(o) {
    ...
    el.queueFx(o, function() {
      ...
      this.fxanim({ opacity: { to: 0.3 } }, null, null, 0.1, null, function() {
        ...
        (function() {
          this.fxanim(
            { height: { to: 1 }, points: { by: [0, this.getHeight() * 0.5] } },
            o,
            'motion',
            0.3,
            'easeIn',
        ...
        _30.animate(
          {
            ...
            opacity: { from: 1, to: 0 },
            height: { from: b.height, to: b.height + 20 * _31 },
            width: { from: b.width, to: b.width + 20 * _31 },
          },
          duration,
          function() {
            _30.remove();
  ...
  fxanim: function(_61, opt, _63, _64, _65, cb) {
    _63 = _63 || 'run';
    opt = opt || {};
    var _67 = Ext.lib.Anim[_63](
      this.dom,
      _61,
      opt.duration || _64 || 0.35,
      opt.easing || _65 || 'easeOut',
      function() {
        Ext.callback(cb, this);
      },
      this,
    ...
    if (this.fireEvent('beforeupdate', this.el, _4, _5) !== false) {
      ...
      if (typeof _4 == 'object') {
        ...
        if (typeof _9.text != 'undefined') {
          this.indicatorText =
            '<div class="loading-indicator">' + _9.text + '</div>';
        }
      ...
      var cb = {
        ...
        argument: { url: _4, form: null, callback: _6, params: _5 },
      };
      _8 = _8 || (_5 ? 'POST' : 'GET');
      if (_8 == 'GET') {
  ...
  formUpdate: function(_d, _e, _f, _10) {
    if (this.fireEvent('beforeupdate', this.el, _d, _e) !== false) {
      ...
      var cb = {
        ...
        failure: this.failureDelegate,
        timeout: this.timeout * 1000,
        argument: { url: _e, form: formEl, callback: _10, reset: _f },
      };
      var _12 = false;
      ...
      this.transaction = Ext.lib.Ajax.formRequest(
        formEl,
        _e,
        cb,
        null,
  ...
  processSuccess: function(_1c) {
    ...
    if (this.loadScripts) {
      this.renderer.render(
        ...
        _1c,
        this,
        this.updateComplete.createDelegate(this, [_1c]),
      );
    } else {
...
Ext.extend(Ext.util.MixedCollection, Ext.util.Observable, {
  ...
  getRange: function(_45, end) {
    ...
    _45 = _45 || 0;
      ...
      typeof end == 'undefined' ? this.length - 1 : end,
      this.length - 1,
    );
    var r = [];
    if (_45 <= end) {
...
(function() {
  ...
  Ext.dd.DragDrop.prototype = {
    ...
    constrainTo: function(_1d, pad, _1f) {
      ...
      this.setXConstraint(
        _26 - (pad.left || 0),
        c.width - _26 - b.width - (pad.right || 0),
      );
      this.setYConstraint(
        _25 - (pad.top || 0),
        c.height - _25 - b.height - (pad.bottom || 0),
      );
    },
    getEl: function() {
      if (!this._domRef) {
    ...
    clickValidator: function(e) {
      ...
      return (
        this.isValidHandleChild(_42) &&
        (this.id == this.handleElId || this.DDM.handleWasClicked(_42, this.id))
      );
    },
    ...
    return {
      ...
      isOverTarget: function(pt, _bd, _be) {
        ...
        if (
          !dc ||
          !dc.getTargetCoord ||
          (!_be && !dc.constrainX && !dc.constrainY)
        ) {
...
Ext.extend(Ext.dd.DropZone, Ext.dd.DropTarget, {
  ...
  notifyDrop: function(dd, e, _26) {
    ...
    var n = this.getTargetFromEvent(e);
    return n
      ? this.onNodeDrop(n, dd, e, _26)
      : this.onContainerDrop(dd, e, _26);
  },
  triggerCacheRefresh: function() {
    Ext.dd.DDM.refreshCache(this.groups);
  },
      ...
      case 'int':
        cv = function(v) {
          return v !== undefined && v !== null && v !== ''
            ? parseInt(String(v).replace(_3, ''), 10)
            : '';
        };
        break;
      case 'float':
        cv = function(v) {
          return v !== undefined && v !== null && v !== ''
            ? parseFloat(String(v).replace(_3, ''), 10)
            : '';
        };
        break;
      case 'bool':
...
Ext.extend(Ext.data.HttpProxy, Ext.data.DataProxy, {
  ...
  load: function(_2, _3, _4, _5, _6) {
    if (this.fireEvent('beforeload', this, _2) !== false) {
      this.conn.request({
        params: _2 || {},
        request: { callback: _4, scope: _5, arg: _6 },
        reader: _3,
...
Ext.extend(Ext.data.JsonReader, Ext.data.DataReader, {
  ...
  getJsonAccessor: (function() {
    ...
    return function(_9) {
      try {
        return re.test(_9)
          ? new Function('obj', 'return obj.' + _9)
          : function(_a) {
              return _a[_9];
            };
      } catch (e) {}
...
Ext.extend(Ext.data.ArrayReader, Ext.data.JsonReader, {
  readRecords: function(o) {
    ...
    for (var i = 0; i < _8.length; i++) {
      ...
      var _b = {};
      var id =
        (_4 || _4 === 0) && n[_4] !== undefined && n[_4] !== '' ? n[_4] : null;
...
Ext.extend(Ext.data.Node, Ext.util.Observable, {
  ...
  appendChild: function(_e) {
    ...
    if (_f) {
      ...
      if (_13) {
        if (
          _e.fireEvent('beforemove', _e.getOwnerTree(), _e, _13, this, _12) ===
          false
        ) {
          return false;
        }
  ...
  insertBefore: function(_17, _18) {
    ...
    if (
      this.fireEvent('beforeinsert', this.ownerTree, this, _17, _18) === false
    ) {
      return false;
    }
...
Ext.Shadow.prototype = {
  ...
  show: function(_4) {
    ...
    this.el.setStyle(
      'z-index',
      this.zIndex || parseInt(_4.getStyle('z-index'), 10) - 1,
    );
    if (Ext.isIE) {
...
Ext.extend(Ext.tree.TreePanel, Ext.data.Tree, {
  ...
  render: function() {
    this.container = this.el.createChild({
      tag: 'ul',
      cls:
        'x-tree-root-ct ' + (this.lines ? 'x-tree-lines' : 'x-tree-no-lines'),
    });
    if (this.containerScroll) {
      Ext.dd.ScrollManager.register(this.el);
    }
...
Ext.extend(Ext.tree.TreeNode, Ext.data.Node, {
  ...
  expand: function(_e, _f, _10) {
    if (!this.expanded) {
      ...
      if (
        (!this.isHiddenRoot() &&
          (this.getOwnerTree().animate && _f !== false)) ||
        _f
      ) {
        this.ui.animExpand(
          function() {
    ...
    if (!this.childIndent) {
      ...
      while (p) {
        if (!p.isRoot || (p.isRoot && p.ownerTree.rootVisible)) {
          if (!p.isLast()) {
            buf.unshift(
              '<img src="' + this.emptyIcon + '" class="x-tree-elbow-line">',
            );
          } else {
            buf.unshift(
              '<img src="' + this.emptyIcon + '" class="x-tree-icon">',
            );
          }
        }
        p = p.parentNode;
...
if (Ext.dd.DropZone) {
  ...
  Ext.extend(Ext.tree.TreeDropZone, Ext.dd.DropZone, {
    ...
    onNodeDrop: function(n, dd, e, _2d) {
      ...
      var _30 =
        _2d.node || (dd.getTreeNode ? dd.getTreeNode(_2d, _2f, _2e, e) : null);
      var _31 = {
        tree: this.tree,
        target: _2f,
        data: _2d,
