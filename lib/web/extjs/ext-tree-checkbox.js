...
Ext.extend(Ext.tree.CheckboxNodeUI, Ext.tree.TreeNodeUI, {
  ...
  render: function(bulkRender) {
    ...
    var targetNode = n.parentNode
      ...
      : n.ownerTree.container
          .dom; /* in later svn builds this changes to n.ownerTree.innerCt.dom */
    if (!this.rendered) {
      this.rendered = true;
      var a = n.attributes;
...
Ext.extend(
  Ext.tree.CheckNodeMultiSelectionModel,
  Ext.tree.MultiSelectionModel,
  {
    ...
    extendSelection: function(node) {
      ...
      if (node.parentNode == last.parentNode) {
        ...
        for (i = 0; i < cs.length; i++) {
          ...
          if (
            cs[i].attributes[attr] == last.attributes[attr] ||
     ...
     */
    onKeyDown: Ext.tree.DefaultSelectionModel.prototype.onKeyDown.createInterceptor(
      function(e) {
