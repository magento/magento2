  ...
  })(
    {
            ...
            function k(a, b, d, e, i) {
              function j(c) {
                ...
                if (
                  ...
                  i && ((i.remaining = e), !k.modifyVars))
                ) {
                  var l = t.getCSS(h, i);
                  if (!d && l)
                    return (i.local = !0), void b(null, l, f, a, i, h);
                }
                s.remove(h),
                  (k.rootFileInfo = j),
                  o.render(f, k, function(c, d) {
                    c
                      ? ((c.href = h), b(c))
                      : ((d.css = g(d.css)),
                        k.modifyVars || t.setCSS(a.href, i.lastModified, d.css),
                        b(null, d.css, f, a, i, h));
                  });
              }
              var k = h(f);
              c(k, a),
                (k.mime = a.type),
                i && (k.modifyVars = i),
                r.loadFile(a.href, null, k, p, function(a, c) {
                  ...
                  new Promise(function(c, f) {
                    ...
                    (g = h = new Date()),
                      l(
                        function(a, b, j, k, l) {
                          return a
                            ? (s.add(a, a.href || k.href), void f(a))
                            : (o.logger.info(
                                l.local
                                  ? 'loading ' + k.href + ' from cache.'
                                  : 'rendered ' + k.href + ' successfully.',
                              ),
                              d.createCSS(e.document, b, k),
                              o.logger.info(
                                'css for ' +
                                  k.href +
                                  ' generated in ' +
          ...
          b.exports = function() {
            ...
            g.add('svg-gradient', function(a) {
              ...
              return (
                ...
                new f(
                  new e("'" + i + "'", i, !1, this.index, this.currentFileInfo),
                  this.index,
                  this.currentFileInfo,
                )
              );
          ...
          (e.prototype = new c()),
            ...
            (e.prototype.markReferenced = function() {
              ...
              if (((this.isReferenced = !0), this.rules))
                for (b = this.rules.rules, a = 0; b.length > a; a++)
      ...
      73: [
        function(a, b) {
          ...
          (k.prototype = new c()),
            (k.prototype.type = 'Ruleset'),
            (k.prototype.isRuleset = !0),
            ...
            (k.prototype.eval = function(a) {
              ...
              for (f = 0; q.length > f; f++)
                (j = q[f]), j.evalFirst || (q[f] = j = j.eval ? j.eval(a) : j);
              for (f = 0; q.length > f; f++)
                if (
                  ((j = q[f]),
                  j instanceof k &&
            ...
            (k.prototype.makeImportant = function() {
              return (
                (this.rules = this.rules.map(function(a) {
        ...
        function(a, b) {
          ...
          (g.prototype = {
            ...
            visitMediaOut: function() {
              ...
              this.checkExtendsForNonMatched(this.allExtendsStack[a]),
          ...
          (e.prototype = {
            ...
            visitDirective: function(a, b) {
              ...
              if (a.rules && a.rules.rules) {
                if (
                  (this._mergeRules(a.rules.rules),
                  a.accept(this._visitor),
                  (b.visitDeeper = !1),
                  a.getIsReferenced())
                )
                ...
                for (var e = 0; a.rules.rules.length > e; e++) {
                  ...
                  if (f.getIsReferenced && f.getIsReferenced())
