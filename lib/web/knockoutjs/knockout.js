    ...
    (function(factory) {
      ...
      ko.utils = (function() {
        ...
        function toggleObjectClassPropertyString(
          ...
          ko.utils.arrayForEach(classNames.match(cssClassNameRegex), function(
            className,
          ) {
        ...
        return {
          ...
          setOptionNodeSelectionState: function(optionNode, isSelected) {
            ...
            if (ieVersion < 7) optionNode.setAttribute('selected', isSelected);
      ...
      ko.utils.domData = new function() {
        ...
        function getAll(node, createIfNotFound) {
          ...
          var hasExistingDataStore =
            dataStoreKey && dataStoreKey !== 'null' && dataStore[dataStoreKey];
        ...
        function jQueryHtmlParse(html, documentContext) {
          ...
          if (jQueryInstance['parseHTML']) {
            ...
            if (elems && elems[0]) {
              ...
              while (
                elem.parentNode &&
                elem.parentNode.nodeType !== 11 /* i.e., DocumentFragment */
              )
      ...
      var ko_subscribable_fn = {
        ...
        limit: function(limitFunction) {
          ...
          var finish = limitFunction(function() {
            ...
            var shouldNotify =
              notifyNextChange || self.isDifferent(previousValue, pendingValue);
          ...
          self._limitChange = function(value) {
            self._changeSubscriptions = self._subscriptions[defaultEvent].slice(
              0,
            );
        ...
        getSubscriptionsCount: function(event) {
          if (event) {
            ...
            var total = 0;
            ko.utils.objectForEach(this._subscriptions, function(
              eventName,
              subscriptions,
            ) {
          ...
          switch (operationName) {
            ...
            case 'splice':
              ...
              var startIndex = Math.min(
                  Math.max(0, args[0] < 0 ? arrayLength + args[0] : args[0]),
                  arrayLength,
                ),
                endDeleteIndex =
                  argsLength === 1
      ...
      ko.computed = ko.dependentObservable = function(
        ...
        function computedObservable() {
          if (arguments.length > 0) {
            ...
            if (
              state.isDirty ||
              (state.isSleeping && computedObservable.haveDependenciesChanged())
            ) {
      ...
      var computedFn = {
        ...
        evaluateImmediate: function(notifyChange) {
          ...
          try {
            changed = this.evaluateImmediate_CallReadWithDependencyDetection(
              notifyChange,
            );
          } finally {
        ...
        evaluateImmediate_CallReadWithDependencyDetection: function(
          ...
          var newValue = this.evaluateImmediate_CallReadThenEndDependencyDetection(
            state,
            dependencyDetectionContext,
          );
        ...
        dispose: function() {
          ...
          if (!state.isSleeping && state.dependencyTracking) {
            ko.utils.objectForEach(state.dependencyTracking, function(
              id,
              dependency,
            ) {
            ...
            if (state.isStale || computedObservable.haveDependenciesChanged()) {
              ...
              ko.utils.arrayForEach(dependeciesOrder, function(id, order) {
                var dependency = state.dependencyTracking[id],
                  subscription = computedObservable.subscribeToDependency(
                    dependency._target,
                  );
      ...
      (function() {
        ...
        var commentNodesHaveTextProperty =
          document && document.createComment('test').text === '<!--test-->';
        ...
        ko.virtualElements = {
          ...
          virtualNodeBindingValue: function(node) {
            var regexMatch = (commentNodesHaveTextProperty
              ? node.text
              : node.nodeValue
      ...
      (function() {
        ...
        ko.utils.extend(ko.bindingProvider.prototype, {
          nodeHasBindings: function(node) {
            switch (node.nodeType) {
              case 1: // Element
                return (
                  node.getAttribute(defaultBindingAttributeName) != null ||
        ...
        function createBindingsStringEvaluatorViaCache(
          ...
          var cacheKey =
            bindingsString + ((options && options['valueAccessors']) || '');
          return (
            cache[cacheKey] ||
        ...
        function createBindingsStringEvaluator(bindingsString, options) {
          ...
          var rewrittenBindings = ko.expressionRewriting.preProcessBindings(
              bindingsString,
              options,
            ),
            functionBody =
        ...
        function applyBindingsToNodeInternal(
          ...
          if (sourceBindings && typeof sourceBindings !== 'function') {
            ...
            var provider = ko.bindingProvider['instance'],
              getBindings =
                provider['getBindingAccessors'] || getBindingsAndMakeAccessors;
          ...
          if (bindings) {
            ...
            allBindings['get'] = function(key) {
              return (
                bindings[key] && evaluateValueAccessor(getValueAccessor(key))
              );
            };
            ...
            ko.utils.arrayForEach(orderedBindings, function(
      ...
      (function(undefined) {
        ...
        function loadComponentAndNotify(componentName, callback) {
          ...
          if (!subscribable) {
            ...
            subscribable = loadingSubscribablesCache[
              componentName
            ] = new ko.subscribable();
        ...
        function beginLoadingComponent(componentName, callback) {
          getFirstResultFromLoaders('getConfig', [componentName], function(
            config,
          ) {
            if (config) {
      ...
      (function(undefined) {
        ...
        ko.components.defaultLoader = {
          ...
          loadComponent: function(componentName, config, callback) {
            ...
            possiblyGetConfigFromAmd(errorCallback, config, function(
              loadedConfig,
            ) {
              resolveConfig(
                componentName,
        ...
        function resolveConfig(componentName, errorCallback, config, callback) {
          ...
          if (templateConfig) {
            possiblyGetConfigFromAmd(errorCallback, templateConfig, function(
              loadedConfig,
            ) {
          ...
          if (viewModelConfig) {
            possiblyGetConfigFromAmd(errorCallback, viewModelConfig, function(
              loadedConfig,
            ) {
              ko.components._getFirstResultFromLoaders(
                'loadViewModel',
        ...
        function getComponentParamsFromCustomElement(elem, bindingContext) {
          ...
          if (paramsAttribute) {
            var params = nativeBindingProviderInstance['parseBindingsString'](
              ...
              rawParamComputedValues = ko.utils.objectMap(params, function(
                paramValue,
                paramName,
              ) {
              ...
              result = ko.utils.objectMap(rawParamComputedValues, function(
                paramValueComputed,
                paramName,
              ) {
      ...
      makeWithIfBinding('with', true /* isWith */, false /* isNot */, function(
        bindingContext,
        dataValue,
      ) {
      ...
      ko.bindingHandlers['options'] = {
        ...
        update: function(element, valueAccessor, allBindings) {
          ...
          var selectWasPreviouslyEmpty = element.length == 0,
            ...
            previousScrollTop =
              !selectWasPreviouslyEmpty && multiple ? element.scrollTop : null,
            unwrappedArray = ko.utils.unwrapObservable(valueAccessor()),
            valueAllowUnset =
              allBindings.get('valueAllowUnset') && allBindings['has']('value'),
          ...
          if (unwrappedArray) {
            ...
            filteredArray = ko.utils.arrayFilter(unwrappedArray, function(
              item,
            ) {
              return (
                includeDestroyed ||
      ...
      ko.bindingHandlers[
        'options'
      ].optionValueDomDataKey = ko.utils.domData.nextKey();
      ...
      (function() {
        ...
        if (ko.utils.ieVersion < 10) {
          ...
          var registerForSelectionChangeEvent = function(element, handler) {
            var ownerDoc = element.ownerDocument;
            if (
              !ko.utils.domData.get(ownerDoc, selectionChangeRegisteredName)
            ) {
              ko.utils.domData.set(
                ownerDoc,
          ...
          ko.utils.arrayForEach(eventsToCatch, function(eventName) {
            ...
            if (ko.utils.stringStartsWith(eventName, 'after')) {
              handler = function() {
                ...
                elementValueBeforeEvent = ko.selectExtensions.readValue(
                  element,
                );
      ...
      ko.templateEngine.prototype['createJavaScriptEvaluatorBlock'] = function(
        script,
      ) {
      ...
      ko.templateEngine.prototype['isTemplateRewritten'] = function(
        ...
        return this['makeTemplateSource'](template, templateDocument)['data'](
          'isRewritten',
        );
      };
      ...
      ko.templateRewriting = (function() {
        ...
        function constructMemoizedTagReplacement(
          ...
          var dataBindKeyValueArray = ko.expressionRewriting.parseObjectLiteral(
            dataBindAttributeValue,
          );
          validateDataBindValuesForRewriting(dataBindKeyValueArray);
          var rewrittenDataBindAttributeValue = ko.expressionRewriting.preProcessBindings(
        ...
        return {
          ensureTemplateIsRewritten: function(
            ...
            if (
              !templateEngine['isTemplateRewritten'](template, templateDocument)
            )
      ...
      (function() {
        ...
        ko.templateSources.domElement.prototype[
          'text'
      ...
      (function() {
        ...
        function activateBindingsOnContinuousNodeArray(
          ...
          if (continuousNodeArray.length) {
            ...
            if (preprocessNode) {
              invokeForEachNodeInContinuousRange(firstNode, lastNode, function(
                node,
                nextNodeInRange,
              ) {
                ...
                if (newNodes) {
                  ...
                  if (node === lastNode)
                    lastNode =
                      newNodes[newNodes.length - 1] || nodePreviousSibling;
                }
              });
        ...
        function executeTemplate(
          ...
          if (haveAddedNodesToParent) {
            ...
            if (options['afterRender'])
              ko.dependencyDetection.ignore(options['afterRender'], null, [
                renderedNodesArray,
                bindingContext['$data'],
              ]);
          }
        ...
        ko.renderTemplateForEach = function(
          ...
          return ko.dependentObservable(
            function() {
              ...
              // Filter out any entries marked as destroyed
              var filteredArray = ko.utils.arrayFilter(unwrappedArray, function(
                item,
              ) {
                return (
        ...
        ko.expressionRewriting.bindingRewriteValidators['template'] = function(
          bindingValue,
        ) {
          var parsedBindingValue = ko.expressionRewriting.parseObjectLiteral(
            bindingValue,
          );
      ...
      ko.utils.findMovesInArrayComparison = function(
        ...
        if (left.length && right.length) {
          ...
          for (
            failedCompares = l = 0;
            (!limitFailedCompares || failedCompares < limitFailedCompares) &&
            (leftItem = left[l]);
            ++l
          ) {
            ...
            function() {
              var newMappedNodes =
                mapping(
                  valueToMap,
                  index,
                  ko.utils.fixUpContinuousNodeArray(mappedNodes, containerNode),
                ) || [];
          ...
          for (i = 0; i < itemsForBeforeRemoveCallbacks.length; ++i) {
            if (itemsForBeforeRemoveCallbacks[i]) {
              itemsForBeforeRemoveCallbacks[
                i
              ].arrayEntry = deletedItemDummyValue;
            }
          }
