        ...
        if (isMethodCall) {
          ...
          this.each(function() {
            var instance = instances[$.data(this, 'jstree_instance_id')],
              methodValue =
                instance && $.isFunction(instance[settings])
                  ? instance[settings].apply(instance, args)
                  : instance;
            if (
              typeof methodValue !== 'undefined' &&
          ...
          this.each(function() {
            ...
            instances[instance_id] = new $.jstree._instance(
              instance_id,
              $(this).addClass('jstree jstree-' + instance_id),
              s,
            );
            // init all activated plugins for this instance
            $.each(instances[instance_id]._get_settings().plugins, function(
              i,
              val,
            ) {
            ...
            $.jstree._fn[i] = function() {
              ...
              do {
                if (
                  func &&
                  func.plugin &&
                  $.inArray(func.plugin, this._get_settings().plugins) !== -1
                ) {
                  break;
                }
                func = func.old;
      ...
      $.jstree.plugin('core', {
        ...
        _fn: {
          init: function() {
            ...
            this.data.core.li_height =
              this.get_container_ul()
                .find('li.jstree-closed, li.jstree-leaf')
                .eq(0)
                .height() || 18;
          ...
          reload_nodes: function(is_callback) {
            ...
            if (!is_callback) {
              ...
              this.data.core.to_open = $.map(
                $.makeArray(this.data.core.to_open),
                function(n) {
                  return (
                    '#' +
                    n
              ...
              this.data.core.to_load = $.map(
                $.makeArray(this.data.core.to_load),
                function(n) {
                  return (
                    '#' +
                    n
              ...
              if (this.data.core.to_open.length) {
                this.data.core.to_load = this.data.core.to_load.concat(
                  this.data.core.to_open,
                );
              }
            }
          ...
          _get_prev: function(obj, strict) {
            ...
            if (strict) {
              return obj.prevAll('li').length > 0
                ? obj.prevAll('li:eq(0)')
                : false;
            }
          ...
          delete_node: function(obj) {
            ...
            if (p !== -1 && p.find('> ul > li').length === 0) {
              p.removeClass('jstree-open jstree-closed').addClass(
                'jstree-leaf',
              );
            }
            this.clean_node(p);
      ...
      $.jstree.plugin('ui', {
            ...
            .bind(
              ...
              $.proxy(function(event, data) {
                var s = this._get_settings().ui,
                  ...
                  clk =
                    obj && obj.length
                      ? obj.children('ul').find('a.jstree-clicked')
                      : $(),
                  _this = this;
        ...
        _fn: {
          ...
          select_node: function(obj, check, e) {
            ...
            if (check) {
              if (
                s.disable_selecting_children &&
                is_multiple &&
                (obj.parentsUntil('.jstree', 'li').children('a.jstree-clicked')
                  .length ||
              ...
              switch (!0) {
                case is_range:
                  ...
                  obj = obj[
                    obj.index() < this.data.ui.last_selected.index()
                      ? 'nextUntil'
                      : 'prevUntil'
                  ]('.jstree-last-selected').addBack();
                  if (s.select_limit == -1 || obj.length < s.select_limit) {
                    this.data.ui.last_selected.removeClass(
        ...
        _fn: {
          _show_input: function(obj, callback) {
            ...
            var rtl = this._get_settings().core.rtl,
              ...
              w2 =
                obj.find('> a:visible > ins').width() *
                obj.find('> a:visible > ins').length,
              t = this.get_text(obj),
              h1 = $('<div />', {
                css: {
                  position: 'absolute',
                  ...
                  $('<input />', {
                    ...
                    keyup: function(event) {
                      ...
                      if (key == 27) {
                        ...
                        h2.width(
                          Math.min(h1.text('pW' + this.value).width(), w),
                        );
                      }
                    },
            ...
            h2.width(
              Math.min(h1.text('pW' + h2[0].value).width(), w),
            )[0].select();
          },
          rename: function(obj) {
            obj = this._get_node(obj);
          ...
          move_node: function(
            ...
            if (!is_prepared) {
              ...
              if (
                position === 'inside' &&
                !s.default_position.match(/^(before|after)$/)
              ) {
                position = s.default_position;
              }
              return this.__call_old(
          ...
          $('script').each(function() {
            if (
              ...
              $.jstree._themes =
                this.src
                  .toString()
                  .replace(/jquery\.jstree[^\/]*?\.js(\?.*)?$/, '') + 'themes/';
              return false;
            }
          });
        }
                ...
                if (
                  ...
                  (t.children('ins').get(0).className &&
                    t
                      .children('ins')
                      .get(0)
                      .className.replace(/jstree[^ ]*|$/gi, '').length)
                ) {
                  lang = false;
                  if (
                    $.inArray('languages', s.plugins) !== -1 &&
      ...
      $.jstree.plugin('languages', {
        ...
        _fn: {
          set_lang: function(i) {
            ...
            st = $.vakata.css.get_css(
              selector + '.' + this.data.languages.current_language,
              false,
      ...
      $.jstree.plugin('sort', {
        __init: function() {
          this.get_container()
            ...
            .bind(
              'rename_node.jstree create_node.jstree create.jstree',
              $.proxy(function(e, data) {
            ...
            .bind(
              ...
              $.proxy(function(e, data) {
                var m =
                  data.rslt.np == -1 ? this.get_container() : data.rslt.np;
    ...
    (function($) {
      ...
      $.vakata.dnd = {
        ...
        drag: function(e) {
          ...
          if (!$.vakata.dnd.is_drag) {
            if (
              Math.abs(e.pageX - $.vakata.dnd.init_x) > 5 ||
            ...
            if (e.pageY - t < 20) {
              ...
              if (!sti) {
                ...
                sti = setInterval(function() {
                  $(document).scrollTop(
                    $(document).scrollTop() - $.vakata.dnd.scroll_spd,
                  );
                }, 150);
              }
            } else {
            ...
            if (e.pageX - l < 20) {
              ...
              if (!sli) {
                ...
                sli = setInterval(function() {
                  $(document).scrollLeft(
                    $(document).scrollLeft() - $.vakata.dnd.scroll_spd,
                  );
                }, 150);
              }
            } else {
      ...
      $.jstree.plugin('dnd', {
        __init: function() {
              ...
              $.proxy(function(e) {
                if ($.vakata.dnd.is_drag && $.vakata.dnd.user_data.jstree) {
                  ...
                  if (
                    ...
                    $($.vakata.dnd.user_data.obj).parents(
                      '.jstree:eq(0)',
                    )[0] !== e.target
                  ) {
            ...
            .bind(
              ...
              $.proxy(function(e) {
                ...
                if (
                  ...
                  $.vakata.dnd.user_data.obj &&
                  $($.vakata.dnd.user_data.obj).length &&
                  $($.vakata.dnd.user_data.obj).parents('.jstree:eq(0)')[0] !==
                    e.target
                ) {
                  // node should not be from the same tree
                  ...
                  if (tr.data.dnd.foreign) {
                    ...
                    tr.move_node(
                      ...
                      tr.get_container(),
                      'last',
                      e[tr._get_settings().dnd.copy_modifier + 'Key'],
                    );
                  }
                }
              }, this),
            ...
            .bind(
              ...
              $.proxy(function(e) {
                if (
                  e.relatedTarget &&
                  e.relatedTarget.id &&
                  e.relatedTarget.id === 'jstree-marker-line'
                ) {
                  return false;
                }
                if ($.vakata.dnd.is_drag && $.vakata.dnd.user_data.jstree) {
              ...
              $.proxy(function(e) {
                if ($.vakata.dnd.is_drag && $.vakata.dnd.user_data.jstree) {
                  if (
                    !r ||
                    !r.length ||
                    r.children('a')[0] !== e.currentTarget
                  ) {
                    this.dnd_enter(e.currentTarget);
                  }
                  ...
                  this.data.dnd.w =
                    (e.pageY - (this.data.dnd.off.top || 0)) %
                    this.data.core.li_height;
          ...
          if (s.drag_target) {
            $(document).delegate(
              s.drag_target,
              'mousedown.jstree-' + this.get_index(),
              $.proxy(function(e) {
                o = e.target;
                $.vakata.dnd.drag_start(
                  e,
                  { jstree: true, obj: e.target },
          ...
          if (s.drop_target) {
            $(document)
              .delegate(
                ...
                $.proxy(function(e) {
                  if (
                    ...
                    this._get_settings().dnd.drop_check.call(this, {
                      o: o,
                      r: $(e.target),
                      e: e,
                    })
              ...
              .delegate(
                s.drop_target,
                'mouseleave.jstree-' + this.get_index(),
                $.proxy(function(e) {
        ...
        _fn: {
          ...
          dnd_show: function() {
            ...
            if (this.data.dnd.w < this.data.core.li_height / 3) {
              ...
              o =
                this.data.dnd.w < this.data.core.li_height / 2
                  ? ['inside', 'before', 'after']
                  : ['inside', 'after', 'before'];
            } else {
            ...
            switch (r) {
              ...
              case 'after':
                m.css({
                  left: pos + 'px',
                  top:
                    this.data.dnd.off.top + this.data.core.li_height - 6 + 'px',
                }).show();
                if (ml) {
                  ml.css({
                    left: pos + 8 + 'px',
                    top:
                      this.data.dnd.off.top +
                      this.data.core.li_height -
                      1 +
                      'px',
                  }).show();
          ...
          dnd_enter: function(obj) {
            ...
            if (s.check_timeout) {
              ...
              this.data.dnd.to1 = setTimeout(
                $.proxy(this.dnd_prepare, this),
                s.check_timeout,
              );
            } else {
              this.dnd_prepare();
            ...
            if (s.open_timeout) {
              ...
              if (r && r.length && r.hasClass('jstree-closed')) {
                ...
                this.data.dnd.to2 = setTimeout(
                  $.proxy(this.dnd_open, this),
                  s.open_timeout,
                );
              }
            } else {
          ...
          start_drag: function(obj, e) {
            ...
            var dt =
                o.length > 1
                  ? this._get_string('multiple_selection')
                  : this.get_text(o),
    ...
    (function($) {
      $.jstree.plugin('checkbox', {
        __init: function() {
          ...
          this.get_container()
            .bind(
              'open_node.jstree create_node.jstree clean_node.jstree refresh.jstree',
              $.proxy(function(e, data) {
        ...
        defaults: {
          ...
          real_checkboxes_names: function(n) {
            return [
              'check_' + (n[0].id || Math.ceil(Math.random() * 10000)),
              1,
            ];
          },
        },
        __destroy: function() {
          this.get_container()
            .find('input.jstree-real-checkbox')
            .removeClass('jstree-real-checkbox')
            .end()
            .find('ins.jstree-checkbox')
            .remove();
        },
        _fn: {
          ...
          _prepare_checkboxes: function(obj) {
            ...
            obj.each(function() {
              ...
              c =
                t.is('li') &&
                (t.hasClass('jstree-checked') ||
                  (rc && t.children(':checked').length))
                  ? 'jstree-checked'
                  : 'jstree-unchecked';
              t.find('li')
                .addBack()
                .each(function() {
                  ...
                  $t.children('a' + (_this.data.languages ? '' : ':eq(0)'))
                    ...
                    .addClass(ts ? 'jstree-unchecked' : c);
                  if (rc) {
                    if (!$t.children(':checkbox').length) {
                      nm = rcn.call(_this, $t);
                      $t.prepend(
                        "<input type='checkbox' class='jstree-real-checkbox' id='" +
                          nm[0] +
                          "' name='" +
                          nm[0] +
                          "' value='" +
          ...
          change_state: function(obj, state) {
            ...
            if (this._get_settings().checkbox.two_state) {
              ...
              if (state) {
                ...
                if (
                  !coll.filter('.jstree-checked, .jstree-undetermined').length
                ) {
                  return false;
                }
                coll
                ...
                coll = obj.find('li').addBack();
                if (
                  !coll.filter('.jstree-unchecked, .jstree-undetermined').length
                ) {
                  return false;
                }
                coll
              ...
              obj.parentsUntil('.jstree', 'li').each(function() {
                ...
                if (state) {
                  if (
                    $this
                      .children('ul')
                      .children('li.jstree-checked, li.jstree-undetermined')
                      .length
                  ) {
                    $this
                      .parentsUntil('.jstree', 'li')
                  ...
                  if (
                    $this
                      .children('ul')
                      .children('li.jstree-unchecked, li.jstree-undetermined')
                      .length
                  ) {
                    $this
                      .parentsUntil('.jstree', 'li')
          ...
          check_all: function() {
            var _this = this,
              coll = this._get_settings().checkbox.two_state
                ? this.get_container_ul().find('li')
                : this.get_container_ul().children('li');
            coll.each(function() {
          ...
          get_checked: function(obj, get_all) {
            obj =
              !obj || obj === -1 ? this.get_container() : this._get_node(obj);
            return get_all || this._get_settings().checkbox.two_state
              ? obj.find('.jstree-checked')
              : obj.find(
          ...
          save_loaded: function() {
            ...
            this.get_container_ul()
              .find('li.jstree-closed.jstree-undetermined')
              .each(function() {
                if (this.id) {
        ...
        _fn: {
          ...
          get_xml: function(tp, obj, li_attr, a_attr, is_callback) {
            ...
            if (
              !is_callback &&
              this.data.types &&
              $.inArray(s.types.type_attr, li_attr) === -1
            ) {
              li_attr.push(s.types.type_attr);
            }
          ...
          search: function(str, skip_async) {
            ...
            if (
              ...
              this.get_container_ul().find(
                'li.jstree-closed:not(:has(ul)):eq(0)',
              ).length > 0
            ) {
        ...
        $.vakata.context.cnt
          ...
          .delegate('a', 'mouseup', function(e) {
            if (
              !$(this)
                .parent()
                .hasClass('jstree-contextmenu-disabled') &&
      ...
      $.jstree.plugin('contextmenu', {
        ...
        _fn: {
          show_contextmenu: function(obj, x, y) {
            ...
            i =
              obj.data('jstree') && obj.data('jstree').contextmenu
                ? obj.data('jstree').contextmenu
                : s.items;
            if ($.isFunction(i)) {
              i = i.call(this, obj);
            }
            ...
            if (this.data.themes) {
              $.vakata.context.cnt.attr(
                'class',
                'jstree-' + this.data.themes.theme + '-context',
              );
            }
          },
        },
    ...
    (function($) {
      $.jstree.plugin('types', {
        __init: function() {
          ...
          this.get_container()
              ...
              $.proxy(function() {
                ...
                $.each(types, function(i, tp) {
                  ...
                  if (tp.icon.image || tp.icon.position) {
                    if (i == 'default') {
                      icons_css +=
                        '.jstree-' + _this.get_index() + ' a > .jstree-icon { ';
                    } else {
                      icons_css +=
                        '.jstree-' +
                        _this.get_index() +
                    ...
                    if (tp.icon.image) {
                      icons_css +=
                        ' background-image:url(' + tp.icon.image + '); ';
                    }
                    if (tp.icon.position) {
                      icons_css +=
                        ' background-position:' + tp.icon.position + '; ';
                    } else {
            ...
            .bind(
              ...
              $.proxy(function(e, data) {
                var s,
                  t,
                  o = this._get_settings().types.use_data
                ...
                if ($.inArray(data.func, this.data.types.attach_to) !== -1) {
                  if (
                    !data.args[0] ||
                    (!data.args[0].tagName && !data.args[0].jquery)
                  ) {
                    return;
                  }
                  ...
                  if (
                    ((s[t] && typeof s[t][data.func] !== 'undefined') ||
                      (s['default'] &&
                        typeof s['default'][data.func] !== 'undefined')) &&
          ...
          if (is_ie6) {
            this.get_container().bind(
              'load_node.jstree set_type.jstree',
              $.proxy(function(e, data) {
                var r =
                    data && data.rslt && data.rslt.obj && data.rslt.obj !== -1
          ...
          _check: function(rule, obj, opts) {
            ...
            if (obj === -1) {
              ...
              if (
                data &&
                data.types &&
                typeof data.types[rule] !== 'undefined'
              ) {
                v = data.types[rule];
              } else if (
                !!s.types[t] &&
                typeof s.types[t][rule] !== 'undefined'
              ) {
                v = s.types[t][rule];
              } else if (
                !!s.types['default'] &&
                typeof s.types['default'][rule] !== 'undefined'
              ) {
          ...
          create_node: function(
            ...
            if (!skip_check && (is_loaded || this._is_loaded(obj))) {
              ...
              if (s.max_children !== -2 && mc !== -1) {
                ch =
                  p === -1
                    ? this.get_container().find('> ul > li').length
                    : p.find('> ul > li').length;
                if (ch + 1 > mc) {
                  return false;
                }
          ...
          _is_loaded: function(obj) {
            ...
            return (
              ...
              (!this._get_settings().html_data.ajax &&
                !$.isFunction(this._get_settings().html_data.data)) ||
              obj.is('.jstree-open, .jstree-leaf') ||
              obj
                .children('ul')
                .children('li')
          ...
          this.get_container()
            ...
            .bind(
              ...
              $.proxy(function(e, data) {
                data.inst
                  .get_container()
                  .find('> ul > li > .jstree-loading > ins')
                  .addClass('ui-icon-refresh');
                this._themeroller(data.inst.get_container().find('> ul > li'));
              }, this),
            )
            .bind(
              'open_node.jstree create_node.jstree',
              $.proxy(function(e, data) {
                this._themeroller(data.rslt.obj);
              }, this),
            )
            .bind(
              'loaded.jstree refresh.jstree',
              $.proxy(function(e) {
                this._themeroller();
              }, this),
            )
        ...
        _fn: {
          _themeroller: function(obj) {
            ...
            obj
              ...
              .removeClass(s.item_leaf + ' ' + s.item_open)
              .addClass(s.item_clsd || 'jstree-no-icon')
              .end()
              .end()
              .end()
              .end()
              ...
              .removeClass(s.item_leaf + ' ' + s.item_clsd)
              .addClass(s.item_open || 'jstree-no-icon')
              .end()
              .end()
              .end()
              .end()
              .find('li.jstree-leaf')
              .children('ins.jstree-icon')
              .removeClass(s.closed + ' ui-icon ' + s.opened)
              .end()
              .children('a')
              .addClass(s.item)
              .children('ins.jstree-icon')
              ...
              .removeClass(s.item_clsd + ' ' + s.item_open)
              .addClass(s.item_leaf || 'jstree-no-icon');
          },
        },
        defaults: {
            ...
            $.proxy(function(e, data) {
              ...
              if (data.func == 'create_node') {
                ...
                if (data.args[4] || this._is_loaded(data.args[0])) {
                  ...
                  if (
                    data.args[1] &&
                    (data.args[1] === 'before' || data.args[1] === 'after')
                  ) {
      ...
      $.jstree.plugin('wholerow', {
        __init: function() {
          ...
          this.get_container()
            ...
            .bind(
              'open_node.jstree create_node.jstree clean_node.jstree loaded.jstree',
              $.proxy(function(e, data) {
                this._prepare_wholerow_span(
                  data && data.rslt && data.rslt.obj ? data.rslt.obj : -1,
                );
              }, this),
            )
            .bind(
              'search.jstree clear_search.jstree reopen.jstree after_open.jstree after_close.jstree create_node.jstree delete_node.jstree clean_node.jstree',
              $.proxy(function(e, data) {
                if (this.data.to) {
            ...
            .bind(
              ...
              $.proxy(function(e, data) {
                this.get_container()
                  .find(' > .jstree-wholerow .jstree-clicked')
                  .removeClass(
                    'jstree-clicked ' +
                      (this.data.themeroller
                        ? this._get_settings().themeroller.item_a
                        : ''),
                  );
              }, this),
            )
            .bind(
              ...
              $.proxy(function(e, data) {
                data.rslt.obj.each(function() {
                  ...
                  ref
                    .children('a')
                    .attr('class', data.rslt.obj.children('a').attr('class'));
                });
              }, this),
            )
            .bind(
              ...
              $.proxy(function(e, data) {
                this.get_container()
                  .find(' > .jstree-wholerow .jstree-hovered')
                  .removeClass(
                    'jstree-hovered ' +
                      (this.data.themeroller
                        ? this._get_settings().themeroller.item_h
                        : ''),
                  );
                if (e.type === 'hover_node') {
                  var ref = this.get_container().find(
                    ' > .jstree-wholerow li:visible:eq(' +
                      parseInt(
                        (data.rslt.obj.offset().top -
            ...
            .delegate(
              '.jstree-wholerow-span, ins.jstree-icon, li',
              'click.jstree',
              function(e) {
                ...
                if (
                  ...
                  (e.target.tagName === 'INS' &&
                    n.closest('li').is('.jstree-open, .jstree-closed'))
                ) {
                  return;
                }
                n.closest('li')
            ...
            .delegate(
              ...
              $.proxy(function(e) {
                if (
                  $(e.currentTarget)
                    .children('a')
                    .hasClass('jstree-hovered').length
                ) {
                  return;
                }
            ...
            obj.each(function() {
              $(this)
                ...
                .each(function() {
                  ...
                  $t.prepend(
                    "<span class='jstree-wholerow-span' style='width:" +
      ...
      $.jstree.plugin('model', {
        __init: function() {
          ...
          this._get_settings().json_data.data = function(n, b) {
            var obj =
              n == -1
                ? this._get_settings().model.object
                : n.data('jstree_model');
      ...
      $.jstree.plugin('vcheckbox', {
        __init: function() {
          ...
          this.get_container()
            ...
            .delegate(
              this.data.ui && this.data.vcheckbox.noui
                ? 'a'
                : 'ins.jstree-checkbox',
              'click.jstree',
              $.proxy(function(e) {
        ...
        _fn: {
          ...
          _prepare_checkboxes: function(obj) {
            ...
            var c,
              _this = this,
              t,
              ts = this._get_settings().vcheckbox.two_state,
          ...
          change_state: function(obj, state) {
            ...
            if (this._get_settings().vcheckbox.two_state) {
              ...
              obj.parentsUntil('.jstree', 'li').each(function() {
                ...
                if (state) {
                  if (
                    $this.children('ul').children('li.jstree-checked').length
                  ) {
                    $this
                      .parentsUntil('.jstree', 'li')
                      .addBack()
                  ...
                  if (
                    $this.children('ul').children('li.jstree-unchecked').length
                  ) {
                    $this
                      .parentsUntil('.jstree', 'li')
                      .addBack()
          ...
          check_all: function() {
            var _this = this,
              coll = this._get_settings().vcheckbox.two_state
                ? this.get_container_ul().find('li')
                : this.get_container_ul().children('li');
            coll.each(function() {
              _this.change_state(this, false);
          ...
          get_checked: function(obj, get_all) {
            obj =
              !obj || obj === -1 ? this.get_container() : this._get_node(obj);
            return get_all || this._get_settings().vcheckbox.two_state
              ? obj.find('.jstree-checked')
              : obj.find(
                  '> ul > .jstree-checked, .jstree-undetermined > ul > .jstree-checked',
                );
