(function(a) {
  ...
  var b = function(a, c, d) {
      ...
      return (
        ...
        (window.Blob && a instanceof Blob) || (window.File && a instanceof File)
          ? (f = g = b.createObjectURL(a))
          : (f = a),
        f
          ? ((e.src = f), e)
  ...
  (b.scale = function(a, b) {
    ...
    return (
      ...
      f < 1 && ((d = parseInt(d * f, 10)), (e = parseInt(e * f, 10))),
      a.getContext || (b.canvas && c.getContext)
        ? ((c.width = d),
          (c.height = e),
          c.getContext('2d').drawImage(a, 0, 0, d, e),
          c)
