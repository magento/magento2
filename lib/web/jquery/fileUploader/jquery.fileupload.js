  ...
  $.widget('blueimp.fileupload', {
    ...
    _onProgress: function(e, data) {
      if (e.lengthComputable) {
        ...
        loaded =
          parseInt((e.loaded / e.total) * (data.chunkSize || total), 10) +
    ...
    _chunkedUpload: function(options, testOnly) {
      ...
      upload = function(i) {
        ...
        return upload((i -= 1)).pipe(function() {
          ...
          jqXHR = ($.ajax(o) || that._getXHRPromise(false, o.context)).done(
            function() {
    ...
    _onSend: function(e, data) {
      ...
      if (
        ...
        if (this.options.limitConcurrentUploads > 1) {
          ...
          pipe = this._sequence = this._sequence.pipe(
            send,
            send,
          );
        }
    ...
    _onPaste: function(e) {
      ...
      if (
        that._trigger('paste', e, data) === false ||
