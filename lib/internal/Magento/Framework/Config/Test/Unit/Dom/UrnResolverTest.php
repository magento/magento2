...
class UrnResolverTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->setExpectedException(\Magento\Framework\Exception\NotFoundException::class, 'Unsupported format of schema location: \'urn:magento:test:test:etc/test_test.xsd\'');
    ...
    {
        $this->setExpectedException(\Magento\Framework\Exception\NotFoundException::class, 'Could not locate schema: \'urn:magento:module:Magento_Test:test.xsd\' at \'/test.xsd\'');
