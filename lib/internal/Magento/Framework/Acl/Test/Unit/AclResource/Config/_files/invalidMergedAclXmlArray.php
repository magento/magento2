...
return [
    'disabled_attribute_empty_value' => [
        ...
        [
            ...
            "<resource id=\"Test_Value::show_toolbar\" disabled=\"\" title=\"test\"/></resources></acl>" .
            "</config>\n2:\n"
        ],
    ],
    'disabled_attribute_wrong_type_value' => [
        ...
        [
            ...
            "'xs:boolean'.\nLine: 1\nThe xml was: \n0:<?xml version=\"1.0\"?>\n1:<config><acl><resources>" .
            "<resource id=\"Test_Value::show_toolbar\" disabled=\"notBool\" title=\"test\"/></resources>" .
            "</acl></config>\n2:\n"
        ],
    ],
    'double_acl' => [
    ...
    'notvalid_id_attribute_value_regexp1' => [
        ...
        [
            ...
            "Line: 1\nThe xml was: \n0:<?xml version=\"1.0\"?>\n1:<config><acl><resources><resource " .
            "id=\"test_Value::show_toolbar\" title=\"test\"/></resources></acl></config>\n2:\n"
        ],
    ],
    ...
    'notvalid_id_attribute_value_regexp3' => [
        ...
        [
            ...
            "accepted by the pattern '([A-Z]+[a-zA-Z0-9]{1,}){1,}_[A-Z]+[A-Z0-9a-z]{1,}::[A-Za-z_0-9]{1,}'.\n" .
            "Line: 1\nThe xml was: \n0:<?xml version=\"1.0\"?>\n1:<config><acl><resources><resource " .
            "id=\"M@#$%^*_Value::show_toolbar\" title=\"test\"/></resources></acl></config>\n2:\n"
        ],
    ],
    'notvalid_id_attribute_value_regexp4' => [
        ...
        [
            ...
            "accepted by the pattern '([A-Z]+[a-zA-Z0-9]{1,}){1,}_[A-Z]+[A-Z0-9a-z]{1,}::[A-Za-z_0-9]{1,}'.\n" .
            "Line: 1\nThe xml was: \n0:<?xml version=\"1.0\"?>\n1:<config><acl><resources><resource " .
            "id=\"_Value::show_toolbar\" title=\"test\"/></resources></acl></config>\n2:\n"
        ],
    ],
    'notvalid_id_attribute_value_regexp5' => [
        ...
        [
            ...
            "The xml was: \n0:<?xml version=\"1.0\"?>\n1:<config><acl><resources><resource " .
            "id=\"Value_::show_toolbar\" title=\"test\"/></resources></acl></config>\n2:\n"
        ],
    ],
    ...
    'notvalid_id_attribute_value_regexp7' => [
        ...
        [
            ...
            "The xml was: \n0:<?xml version=\"1.0\"?>\n1:<config><acl><resources><resource " .
            "id=\"Test_Value::\" title=\"test\"/></resources></acl></config>\n2:\n"
        ],
    ],
    ...
    'with_not_allowed_attribute' => [
        ...
        [
            ...
            "The xml was: \n0:<?xml version=\"1.0\"?>\n1:<config><acl><resources><resource " .
            "id=\"Test_Value::show_toolbar\" title=\"test\" someatrrname=\"some value\"/></resources>" .
            "</acl></config>\n2:\n"
        ],
    ],
    'with_two_same_id' => [
    ...
    'without_title' => [
        ...
        [
            ...
            "0:<?xml version=\"1.0\"?>\n1:<config><acl><resources><resource id=\"Test_Value::show_toolbar\"/>" .
            "</resources></acl></config>\n2:\n"
        ],
    ],
];
