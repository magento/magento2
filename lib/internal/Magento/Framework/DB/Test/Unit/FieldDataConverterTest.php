...
class FieldDataConverterTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->setExpectedException(\InvalidArgumentException::class, 'Invalid value for environment variable DATA_CONVERTER_BATCH_SIZE. Should be integer, >= 1 and < value of PHP_INT_MAX');
