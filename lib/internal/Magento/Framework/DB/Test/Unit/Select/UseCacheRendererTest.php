 ...
 */
class UseCacheRendererTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->model = $objectManager->getObject(\Magento\Framework\DB\Select\UseCacheRenderer::class);
    }
    ...
    {
        $sql = 'SELECT';
        $expectedResult = $sql . ' ' . Select::SQL_CACHE  . ' ';
        $this->selectMock->expects($this->once())
            ->method('getPart')
            ->with(Select::USE_CACHE)
            ->willReturn(true);
