...
class StateTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->setExpectedException(\Exception::class, 'Some error');
    ...
    {
        $this->setExpectedException(\Exception::class, 'Unknown application mode: unknown mode');
    ...
    {
        $this->setExpectedException(\Magento\Framework\Exception\LocalizedException::class, 'Area code "any code" does not exist');
