...
use \Magento\Framework\Stdlib\Test\Unit\Cookie\PhpCookieMonsterTest;
...
function setcookie($name, $value, $expiry, $path, $domain, $secure, $httpOnly)
{
    ...
    if (isset($mockTranslateSetCookie) && $mockTranslateSetCookie === true) {
        PhpCookieMonsterTest::$isSetCookieInvoked = true;
        return PhpCookieMonsterTest::assertCookie($name, $value, $expiry, $path, $domain, $secure, $httpOnly);
    } else {
