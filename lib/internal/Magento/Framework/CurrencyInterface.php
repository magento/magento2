...
interface CurrencyInterface
{
     ...
     *
     * @return Zend_Cache_Core|FrontendInterface|null The set cache
     */
     ...
     *
     * @param  Zend_Cache_Core|FrontendInterface $cache Cache to set
     * @return void
     */
    public static function setCache(Zend_Cache_Core|FrontendInterface $cache);
