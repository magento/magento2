...
class ConstructorIntegrityTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertSame(true, $this->_model->validate(\Magento\SomeModule\Model\One\Test::class));
    }

    public function testValidateIfClassHasParentConstructCall()
    {
        $this->assertSame(true, $this->_model->validate(\Magento\SomeModule\Model\Two\Test::class));
    }

    public function testValidateIfClassHasArgumentsQtyEqualToParentClass()
    {
        $this->assertSame(true, $this->_model->validate(\Magento\SomeModule\Model\Three\Test::class));
    }
