...
class ScoreBuilderTest extends \PHPUnit_Framework_TestCase
{
    public function testBuild()
    {
        ...
        $expected = '((LEAST((someCondition1), 1000000) * %1$s + (LEAST((someCondition2), 1000000) * %1$s + LEAST((someCondition3), 1000000) * %1$s + ' .
            '(LEAST((someCondition4), 1000000) * %1$s + LEAST((someCondition5), 1000000) * %1$s) * 10.1 + (LEAST((someCondition6), 1000000) * %1$s + ' .
