...
/**
 * Module data setup implementation for data manipulation during setup operations
 *
 * @api
 */
class ModuleDataSetup extends \Magento\Framework\Module\Setup implements ModuleDataSetupInterface
{
    /**
     * Tables data cache
     *
