...
class DbSchemaWriter implements DbSchemaWriterInterface
{
    ...
    private function isNeedToSplitSql() : bool
    {
        return str_contains($this->sqlVersionProvider->getSqlVersion(), SqlVersionProvider::MARIA_DB_10_4_VERSION) ||
            ...
            str_contains($this->sqlVersionProvider->getSqlVersion(), SqlVersionProvider::MARIA_DB_11_8_VERSION) ||
            str_contains($this->sqlVersionProvider->getSqlVersion(), SqlVersionProvider::MARIA_DB_12_2_VERSION) ||
            str_contains($this->sqlVersionProvider->getSqlVersion(), SqlVersionProvider::MARIA_DB_12_3_VERSION);
    }
