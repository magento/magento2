...
class ConfigTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->setExpectedException(\InvalidArgumentException::class, 'There must be at least one configuration file specified.');
    ...
    {
        $this->setExpectedException(\InvalidArgumentException::class, 'Unknown validation entity "invalid_entity"');
    ...
    {
        $this->setExpectedException(\InvalidArgumentException::class, 'Unknown validation group "invalid_group" in entity "test_entity_a"');
    ...
    {
        $this->setExpectedException(\InvalidArgumentException::class, 'Builder class "UnknownBuilderClass" was not found');
    ...
    {
        $this->setExpectedException(\InvalidArgumentException::class, 'Builder "stdClass" must extend \\Magento\\Framework\\Validator\\Builder');
