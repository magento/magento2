 ...
 */
namespace Magento\Setup\Test\Unit\Module\Di\Test\Unit\App;

use Magento\Framework\App\Console\Response;
use Magento\Setup\Module\Di\App\Compiler;
use Magento\Setup\Module\Di\App\Task;
...
class CompilerTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        $this->objectManagerMock = $this->getMockBuilder('Magento\Framework\ObjectManagerInterface')
            ->setMethods([])
            ->getMock();
        $this->taskManagerMock = $this->getMockBuilder('Magento\Setup\Module\Di\App\Task\Manager')
