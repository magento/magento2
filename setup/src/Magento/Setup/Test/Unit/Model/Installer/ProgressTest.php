...
class ProgressTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->setExpectedException(\LogicException::class, 'Total number must be more than zero.');
    ...
    {
        $this->setExpectedException(\LogicException::class, 'Current cannot exceed total number.');
