...
namespace Magento\Setup\Test\Unit\Console\Command\Info\Backups;

use Magento\Setup\Console\Command\Info\Backups\ListCommand;
...
class ListCommandTest extends \PHPUnit_Framework_TestCase
{
    public function testExecute()
    {
        ...
        $command = new ListCommand($directoryList, $file);
