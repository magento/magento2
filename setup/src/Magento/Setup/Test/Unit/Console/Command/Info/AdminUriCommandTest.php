 ...
 */
namespace Magento\Setup\Test\Unit\Console\Command\Info;

use Magento\Setup\Console\Command\Info\AdminUriCommand;
use Symfony\Component\Console\Tester\CommandTester;
use Magento\Framework\Setup\BackendFrontnameGenerator;

class AdminUriCommandTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testExecute()
    {
        ...
        $commandTester = new CommandTester(new AdminUriCommand($this->deploymentConfig));
