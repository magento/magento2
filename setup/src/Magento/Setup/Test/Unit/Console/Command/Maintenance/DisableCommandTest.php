...
use Magento\Setup\Console\Command\Maintenance\DisableCommand;
use Magento\Setup\Validator\IpValidator;
use Symfony\Component\Console\Tester\CommandTester;

class DisableCommandTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function setUp()
    {
        ...
        $this->command = new DisableCommand($this->maintenanceMode, $this->ipValidator);
    }
