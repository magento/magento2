...
namespace Magento\Setup\Test\Unit\Console\Command\Setup\Config;

use Magento\Framework\Module\ModuleList;
use Magento\Setup\Console\Command\Setup\Config\SetCommand;
...
class SetCommandTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \PHPUnit_Framework_MockObject_MockObject|\Magento\Setup\Console\Command\SetCommand
     */
    private $command;
    ...
    public function setUp()
    {
        ...
        $this->command = new SetCommand($this->configModel, $moduleList, $this->deploymentConfig);
    }
