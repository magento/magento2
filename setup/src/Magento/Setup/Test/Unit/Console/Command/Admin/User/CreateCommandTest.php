 ...
 */
namespace Magento\Setup\Test\Unit\Console\Command\Admin\User;

use Magento\Setup\Model\AdminAccount;
use Magento\Setup\Console\Command\Admin\User\CreateCommand;
...
class CreateCommandTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \PHPUnit_Framework_MockObject_MockObject|CreateCommand
     */
    private $command;
    ...
    public function setUp()
    {
        ...
        $this->command = new CreateCommand($this->installerFactoryMock, new UserValidationRules());
    }
