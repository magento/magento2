...
use Magento\Setup\Console\Command\Maintenance\AllowIpsCommand;
use Magento\Setup\Validator\IpValidator;
use Symfony\Component\Console\Tester\CommandTester;

class AllowIpsCommandTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function setUp()
    {
        ...
        $this->command = new AllowIpsCommand($this->maintenanceMode, $this->ipValidator);
    }
