 ...
 */
namespace Magento\Setup\Test\Unit\Console\Command\Setup\Db;

use Magento\Framework\Module\DbVersionInfo;
use Magento\Setup\Console\Command\Setup\Db\StatusCommand;
...
class StatusCommandTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->command = new StatusCommand($objectManagerProvider, $this->deploymentConfig);
    }
