...
namespace Magento\Setup\Test\Unit\Console\Command\Maintenance;

use Magento\Setup\Console\Command\Maintenance\EnableCommand;
use Magento\Setup\Validator\IpValidator;
use Symfony\Component\Console\Tester\CommandTester;

class EnableCommandTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function setUp()
    {
        ...
        $this->command = new EnableCommand($this->maintenanceMode, $this->ipValidator);
    }
