        ...
        (i.select = a.select = function(e, f) {
            ...
            if (!l) {
              if (
                ...
                angular.forEach(j, function(a) {
                  ...
                  angular.extend(e, { direction: f, active: !0, entering: !0 }),
          ...
          (i.addSlide = function(b, c) {
            (b.$element = c),
              j.push(b),
              1 === j.length || b.active
                ? (i.select(j[j.length - 1]), 1 == j.length && a.play())
                : (b.active = !1);
          }),
      ...
      (this.createParser = function(a) {
        ...
        (this.parse = function(b, d) {
          ...
          (d = a.DATETIME_FORMATS[d] || d),
            this.parsers[d] || (this.parsers[d] = this.createParser(d));
          ...
          if (h && h.length) {
            for (
              var i,
                j = { year: 1900, month: 0, date: 1, hours: 0 },
                k = 1,
                l = h.length;
              l > k;
              k++
            ...
            return (
              c(j.year, j.month, j.date) &&
                (i = new Date(j.year, j.month, j.date, j.hours)),
              i
            );
          }
        });
      ...
      function(a, b, c, d, e, f, g) {
        return {
          ...
          link: function(h, i, j, k) {
            ...
            j.datepickerOptions &&
              angular.forEach(h.$parent.$eval(j.datepickerOptions), function(
                a,
                b,
              ) {
                r.attr(l(b), a);
              ...
              angular.forEach(['minDate', 'maxDate'], function(a) {
                j[a] &&
                  (h.$parent.$watch(b(j[a]), function(b) {
                    h[a] = b;
                  }),
                  r.attr(l(a), a));
              }),
        ...
        $get: [
          ...
          function(b, c, d, e, f, g, h) {
            function i(a) {
              return a.template
                ? d.when(a.template)
                : e.get(a.templateUrl, { cache: f }).then(function(a) {
                    return a.data;
                  });
            }
            function j(a) {
            ...
            return function(e, l, m) {
              ...
              var o = angular.extend({}, b, d),
                ...
                s =
                  ...
                  'tt_placement' +
                  r +
                  '" animation="tt_animation" is-open="tt_isOpen"></div>';
              return {
                restrict: 'EA',
                scope: !0,
                compile: function() {
                  ...
                  return function(b, c, d) {
                    ...
                    function p() {
                      return (
                        ...
                        b.tt_content
                          ? (r(),
                            t.css({ top: 0, left: 0, display: 'block' }),
                    ...
                    var t,
                      u,
                      v,
                      w = angular.isDefined(o.appendToBody)
                        ? o.appendToBody
                        : !1,
                      x = n(void 0),
                    ...
                    d.$observe(l + 'Trigger', function(a) {
                      A(),
                        ...
                        x.show === x.hide
                          ? c.bind(x.show, f)
                          : (c.bind(x.show, k), c.bind(x.hide, m));
                    });
                    var B = b.$eval(d[l + 'Animation']);
                    (b.tt_animation = angular.isDefined(B) ? !!B : o.animation),
      ...
      function(a, b, c, d, e, f, g) {
        ...
        return {
          ...
          link: function(i, j, k, l) {
            ...
            var x =
              'typeahead-' + w.$id + '-' + Math.floor(1e4 * Math.random());
            j.attr({
            ...
            y.attr({
              ...
              angular.isDefined(k.typeaheadTemplateUrl) &&
                y.attr('template-url', k.typeaheadTemplateUrl);
            var z = function() {
                (w.matches = []),
                  (w.activeIdx = -1),
            ...
            w.$watch('activeIdx', function(a) {
              0 > a
                ...
                : j.attr('aria-activedescendant', A(a));
            });
            var B = function(a) {
              var b = { $viewValue: a };
              q(i, !0),
                c.when(v.source(i, b)).then(
                  function(c) {
                    var d = a === l.$viewValue;
                    if (d && m)
                      if (c.length > 0) {
                        ...
                        (w.query = a),
                          (w.position = t ? f.offset(j) : f.position(j)),
                          (w.position.top =
                            w.position.top + j.prop('offsetHeight')),
            ...
            l.$parsers.unshift(function(a) {
              ...
              (w.select = function(a) {
                var b,
                  c,
                  e = {};
                (e[v.itemName] = c = w.matches[a].model),
                  (b = v.modelMapper(i, e)),
                  u(i, b),
                  l.$setValidity('editable', !0),
                  r(i, { $item: c, $model: b, $label: v.viewMapper(i, e) }),
                  z(),
                  d(
                    function() {
                      j[0].focus();
              ...
              j.bind('keydown', function(a) {
                0 !== w.matches.length &&
                  ...
                  (a.preventDefault(),
                  40 === a.which
                    ? ((w.activeIdx = (w.activeIdx + 1) % w.matches.length),
                      w.$digest())
                    : 38 === a.which
                    ? ((w.activeIdx =
                        (w.activeIdx ? w.activeIdx : w.matches.length) - 1),
                      w.$digest())
