...
angular
  ...
  .controller('installController', [
    ...
    '$rootScope',
    'progress',
    function($scope, $sce, $timeout, $localStorage, $rootScope, progress) {
    ...
    function($http) {
      return {
        get: function(callback) {
          $http
            .post('index.php/install/progress')
            .then(callback, function errorCallback() {});
        },
        post: function(data, callback) {
          $http
            .post('index.php/install/start', data)
            .then(callback, function errorCallback() {});
        },
      };
    },
