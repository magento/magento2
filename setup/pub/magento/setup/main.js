...
main
  ...
  .controller('mainController', [
    ...
    function(
      ...
      $interval(function() {
        $http
          .post('index.php/session/prolong')
      ...
      return {
          ...
          return $http
            ...
            .then(function successCallback(resp) {
              ...
              self.titlesWithModuleName.forEach(function(value) {
                data.titles[value] =
                  data.titles[value] + $localStorage.moduleName;
              });
        ...
        getNextState: function() {
          ...
          this.states.forEach(function(item) {
            if (
              item.order == $state.$current.order + 1 &&
    ...
    function($localStorage, $rootScope, $state, $http, ngDialog) {
      return {
        checkMarketplaceAuthorized: function() {
          $rootScope.isMarketplaceAuthorized =
            typeof $rootScope.isMarketplaceAuthorized !== 'undefined'
              ? $rootScope.isMarketplaceAuthorized
              : false;
        ...
        reset: function(context) {
          return $http
            .post('index.php/marketplace/remove-credentials', [])
        ...
        checkAuth: function(context) {
          return $http.post('index.php/marketplace/check-auth', []).then(
        ...
        openAuthDialog: function(scope) {
          return $http
            .get('index.php/marketplace/popup-auth')
            .then(function successCallback(resp) {
              var data = resp.data;
        ...
        saveAuthJson: function(context) {
          return $http
            .post('index.php/marketplace/save-auth-json', context.user)
            .then(
              function successCallback(response) {
                var data = response.data;
      ...
      return {
        setTitle: function(type, component) {
          if (type === 'enable' || type === 'disable') {
            $localStorage.packageTitle = $localStorage.moduleName =
      ...
      return {
        ...
        updateSelectedExtensions: function($event, name, version) {
          ...
          if (checkbox.checked) {
            ...
            if (
              this._getObjectSize(this.selectedExtensions) ==
              this._getObjectSize(this.allExtensions)
            ) {
              this.someExtensionsSelected = false;
            ...
            this.allExtensionsSelected = false;
            this.someExtensionsSelected =
              this._getObjectSize(this.selectedExtensions) > 0;
          }
        },
