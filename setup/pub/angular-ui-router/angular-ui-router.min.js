...
'undefined' != typeof module &&
  ...
  (function(a, b, c) {
    ...
    function h(a, b) {
      ...
      for (
        d = d < 0 ? Math.ceil(d) : Math.floor(d), d < 0 && (d += c);
        d < c;
        d++
      )
            ...
            f.$$inheritedValues && e(u, m(f.$$inheritedValues, q)),
              ...
              f.$$values
                ? ((w = e(u, m(f.$$values, q))),
                  ...
                  h())
                : (f.$$inheritedValues &&
                    (s.$$inheritedValues = m(f.$$inheritedValues, q)),
                  f.then(h, i));
        ...
        (this.fromUrl = function(e, f) {
          return (
            ...
            null == e
              ...
              : d
              ? a
                  .get(e, { cache: b, headers: { Accept: 'text/html' } })
                  .then(function(a) {
                    return a.data;
                  })
    ...
    function v() {
      ...
      function e(a) {
        return null != a
          ? a.toString().replace(/(~~|~2F)/g, function(a) {
              return { '~~': '~', '~2F': '/' }[a];
            })
          : a;
      }
      ...
      (v.$$getDefaultValue = function(a) {
        ...
        (this.type = function(a, b, c) {
          ...
          return (
            (r[a] = new u(T({ name: a }, b))),
            c && (w.push({ name: a, def: c }), s || j()),
            this
          );
        }),
        S(x, function(a, b) {
        ...
        (this.Param = function(a, d, e, f) {
          ...
          function s(a, b, d, e) {
            ...
            return (
              (f = R(a.replace) ? a.replace : []),
              P(e) && f.push({ from: e, to: c }),
              (g = o(f, function(a) {
                return a.from;
              })),
              n(i, function(a) {
    ...
    function x(a, e) {
      ...
      function m(a, b) {
        ...
        if (f(e)) {
          ...
          b = m(b);
          for (var g = e.split('.'), h = 0, i = g.length, j = b; h < i; h++)
            if ('' !== g[h] || 0 !== h) {
              if ('^' !== g[h]) break;
              if (!j.parent)
                throw new Error(
        ...
        return (
          ...
          !b[C] &&
            ...
            a.when(b.url, [
              ...
              '$stateParams',
              function(a, c) {
                (z.$current.navigable == b && j(a, c)) ||
                  z.transitionTo(b, a, { inherit: !0, location: !1 });
              },
            ]),
          q(c),
          b
      ...
      function u(a, b) {
        return P(a) && !N(b)
          ? D[a]
          : O(b) && P(a)
          ? (D[a] && !D.$delegates[a] && (D.$delegates[a] = D[a]),
            (D[a] = b),
            this)
          : this;
      }
      ...
      function w(a, e, f, h, j, l, n, q, r) {
        function u(b, c, d, f) {
          ...
          return (
            h.then(
              function() {
                return h !== z.transition
                  ? (a.$broadcast('$stateChangeCancel', b.to, b.toParams, c, d),
                    B)
                  : ((b.options.$retry = !0),
            ...
            return (
              S(a.views, function(d, e) {
                ...
                (g.$template = [
                  ...
                  c.push(
                    j.resolve(g, i.globals, i.resolve, a).then(function(c) {
        ...
        return (
          (y.locals = { resolve: null, globals: { $stateParams: {} } }),
          (z = { params: {}, current: y.self, $current: y, transition: null }),
          (z.reload = function(a) {
          ...
          (z.go = function(a, b, c) {
            return z.transitionTo(
              a,
              b,
              T({ inherit: !0, relative: z.$current }, c),
            );
          }),
          (z.transitionTo = function(b, c, f) {
                ...
                if (f.reload && !K)
                  throw new Error(
                    "No such reload state '" +
                      (P(f.reload) ? f.reload : f.reload.name) +
                      "'",
                  );
                for (; H && H === q[G] && H !== K; )
            ...
            if (
              ...
              s && (c['#'] = s),
              f.notify &&
                a.$broadcast('$stateChangeStart', b.self, c, j.self, o, f)
                  .defaultPrevented)
            )
              return (
                a.$broadcast('$stateChangeCancel', b.self, c, j.self, o),
            ...
            var O = (z.transition = L.then(function() {
              ...
              if (z.transition !== O)
                return (
                  a.$broadcast('$stateChangeCancel', b.self, c, j.self, o), B
                );
              ...
              return z.transition !== O
                ...
                : ((z.$current = b),
                  ...
                  f.notify &&
                    a.$broadcast('$stateChangeSuccess', b.self, c, j.self, o),
                  n.update(!0),
                  z.current);
          ...
          (z.is = function(a, b, d) {
            d = T({ relative: z.$current }, d || {});
            var e = m(a, d.relative);
            return N(e)
              ? z.$current === e &&
                  (!b ||
                    g(b).reduce(function(a, c) {
                      var d = e.params[c];
          ...
          (z.href = function(a, b, d) {
            d = T(
              { lossy: !0, inherit: !0, absolute: !1, relative: z.$current },
              d || {},
            );
            var e = m(a, d.relative);
            if (!N(e)) return null;
            ...
            return f && f.url !== c && null !== f.url
              ? n.href(f.url, k(e.params.$$keys().concat('#'), b || {}), {
                  absolute: d.absolute,
                })
              : null;
          }),
      ...
      function x(a, b, c, d, e, f) {
        ...
        if (
          !f.reload &&
          a === c &&
          (e === c.locals || (!1 === a.self.reloadOnSearch && g(c, d, b)))
        )
          return !0;
      }
      var y,
        ...
        D = {
          ...
          data: function(a) {
            return (
              a.parent &&
                a.parent.data &&
                (a.data = a.self.data = d(a.parent.data, a.data)),
              a.data
            );
          },
          url: function(a) {
            ...
            if (P(b))
              return '^' == b.charAt(0)
                ...
                : (a.parent.navigable || y).url.concat(b, c);
          ...
          params: function(a) {
            ...
            return a.parent && a.parent.params
              ? T(a.parent.params.$$new(), b)
              : new W.ParamSet();
          },
          views: function(a) {
            var b = {};
            return (
              S(N(a.views) ? a.views : { '': a }, function(c, d) {
      ...
      (y = r({ name: '', url: '^', views: null, abstract: !0 })),
        (y.navigable = null),
        (this.decorator = u),
        (this.state = v),
        (this.$get = w),
    ...
    function B(a, c, d, e) {
      return {
        ...
        compile: function(f) {
          var g = f.html();
          return (
            f.empty ? f.empty() : (f[0].innerHTML = null),
            function(f, h, i) {
              var j = d.$current,
                k = C(f, i, h, e),
                l = j && j.locals[k];
              if (!l) return h.html(g), void a(h.contents())(f);
              h.data('$uiView', { name: k, state: l.$$state }),
    ...
    function F(a) {
      var b =
          ...
          Object.prototype.toString.call(a.prop('href')),
        c = 'FORM' === a[0].nodeName;
      return {
    ...
    function G(a, b, c, d, e) {
      return function(f) {
        var g = f.which || f.button,
          h = e();
        if (
          !(g > 1 || f.ctrlKey || f.metaKey || f.shiftKey || a.attr('target'))
        ) {
          var i = c(function() {
    ...
    (t.prototype.concat = function(a, b) {
      ...
      (t.prototype.exec = function(a, b) {
        ...
        for (e = 0; e < j; e++) {
          for (
            g = h[e], l = this.params[g], m = d[e + 1], f = 0;
            f < l.replace.length;
            f++
          )
      ...
      b
        ...
        .constant('$state.runtime', { autoinject: !0 })
        .provider('$state', x)
        .run([
          '$injector',
          function(a) {
