          ...
          var B = {
              ...
              activate: function(a) {
                ...
                b.trapFocus &&
                  ...
                  z.on('keydown', B.onTrapFocusKeydown));
              },
              deactivate: function(a) {
                a.off('keydown', B.onTrapFocusKeydown),
                  z.off('keydown', B.onTrapFocusKeydown);
              },
              ...
              setBodyPadding: function(a) {
                ...
                z.css('padding-right', b + a + 'px'),
                  z.data('ng-dialog-original-padding', b);
              },
              resetBodyPadding: function() {
                var a = z.data('ng-dialog-original-padding');
                a
                  ? z.css('padding-right', a + 'px')
                  : z.css('padding-right', '');
              },
              performCloseDialog: function(a, b) {
                ...
                if (h) {
                  ...
                  1 === n && z.unbind('keydown'),
                    a.hasClass('ngdialog-closing') || (n -= 1);
                  var j = a.data('$ngDialogPreviousFocus');
                  j && j.focus(),
                    u.$broadcast('ngDialog.closing', a, b),
                    (n = 0 > n ? 0 : n),
                      ...
                      ? (h.$destroy(),
                        a
                          ...
                          .bind(g, function() {
                            a.remove(),
                              0 === n &&
                                (z.removeClass('ngdialog-open'),
                                B.resetBodyPadding()),
                              u.$broadcast('ngDialog.closed', a, b);
                          })
                    ...
                    l.length ||
                      (z.unbind('keydown', B.onDocumentKeydown), (m = !1));
                }
              },
            ...
            C = {
              open: function(f) {
                function g(a, b) {
                  return (
                    u.$broadcast('ngDialog.templateLoading', a),
                    t.get(a, b || {}).then(function(b) {
                      return (
                        u.$broadcast('ngDialog.templateLoaded', a), b.data || ''
                      );
                    })
                  );
                }
                function h(b) {
                  return b
                    ? a.isString(b) && j.plain
                      ? b
                      : 'boolean' != typeof j.cache || j.cache
                      ? g(b, { cache: q })
                      : g(b, { cache: !1 })
                    : 'Empty template';
                }
                ...
                var F,
                  G,
                  H = a.extend({}, j.resolve);
                return (
                  a.forEach(H, function(b, c) {
                    H[c] = a.isString(b)
                      ? y.get(b)
                      : y.invoke(b, null, null, c);
                  }),
                  s
                    .all({
                    ...
                    .then(function(b) {
                      ...
                      if (
                        ...
                        (F = c(
                          '<div id="ngdialog' + p + '" class="ngdialog"></div>',
                        )),
                        F.html(
                          j.overlay
                        ...
                        F.data('$ngDialogOptions', j),
                        (E.ngDialogId = A),
                        j.data && a.isString(j.data))
                      ) {
                        var g = j.data.replace(/^\s*/, '')[0];
                        (E.ngDialogData =
                          '{' === g || '[' === g ? a.fromJson(j.data) : j.data),
                          (E.ngDialogData.ngDialogId = A);
                      } else j.data && a.isObject(j.data) && ((E.ngDialogData = j.data), (E.ngDialogData.ngDialogId = A));
                      if (
                        j.controller &&
                        (a.isString(j.controller) ||
                          a.isArray(j.controller) ||
                          a.isFunction(j.controller))
                      ) {
                        var h;
                        j.controllerAs &&
                          a.isString(j.controllerAs) &&
                          (h = j.controllerAs);
                        var k = x(
                          j.controller,
                          a.extend(f, { $scope: E, $element: F }),
                          null,
                          h,
                        );
                      ...
                      if (
                        (j.className && F.addClass(j.className),
                        j.disableAnimation && F.addClass(i),
                        (G =
                          j.appendTo && a.isString(j.appendTo)
                            ? a.element(document.querySelector(j.appendTo))
                            : z),
                        B.applyAriaAttributes(F, j),
                        j.preCloseCallback)
                      ) {
                        var l;
                        a.isFunction(j.preCloseCallback)
                          ? (l = j.preCloseCallback)
                          : a.isString(j.preCloseCallback) &&
                            E &&
                            (a.isFunction(E[j.preCloseCallback])
                              ? (l = E[j.preCloseCallback])
                              : E.$parent &&
                                a.isFunction(E.$parent[j.preCloseCallback])
                              ? (l = E.$parent[j.preCloseCallback])
                              : u &&
                                a.isFunction(u[j.preCloseCallback]) &&
                                (l = u[j.preCloseCallback])),
                          l && F.data('$ngDialogPreCloseCallback', l);
                      }
                      if (
                        ((E.closeThisDialog = function(a) {
                          B.closeDialog(F, a);
                        }),
                        v(function() {
                          var a = document.querySelectorAll('.ngdialog');
                          ...
                          c > 0 && B.setBodyPadding(c),
                            G.append(F),
                            B.activate(F),
                            j.trapFocus && B.autoFocus(F),
                            j.name
                              ? u.$broadcast('ngDialog.opened', {
                                  dialog: F,
                                  name: j.name,
                                })
                              : u.$broadcast('ngDialog.opened', F);
                        }),
                        m || (z.bind('keydown', B.onDocumentKeydown), (m = !0)),
                        j.closeByNavigation)
                      ) {
              ...
              openConfirm: function(b) {
                ...
                a.extend(e, b),
                  (e.scope = a.isObject(e.scope) ? e.scope.$new() : u.$new()),
