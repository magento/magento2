...
class ServiceVersionV1Test extends \Magento\Webapi\Routing\BaseService
{
    ...
    public function testCreate()
    {
        ...
        $item = $this->_webApiCall($serviceInfo, $requestData);
        $this->assertSame($createdItemName, $item['name'], 'Item creation failed');
    }
    ...
    public function testOverwritten()
    {
        ...
        $item = $this->_webApiCall($serviceInfo, []);
        $this->assertSame(['item_id' => -55, 'name' => 'testProduct1'], $item);
    }
    ...
    public function testDefaulted()
    {
        ...
        $item = $this->_webApiCall($serviceInfo, []);
        $this->assertSame(['item_id' => 3, 'name' => 'Default Name'], $item);
    }
    ...
    public function testDefaultedWithValue()
    {
        ...
        $this->assertSame(['item_id' => 3, 'name' => 'Ms. LaGrange'], $item);
    }
}
