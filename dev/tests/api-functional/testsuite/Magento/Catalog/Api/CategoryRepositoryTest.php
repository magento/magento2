...
class CategoryRepositoryTest extends WebapiAbstract
{
    ...
    public function testDelete()
    {
        ...
        $this->assertSame(1, $urlRewrite->getIsAutogenerated());
        $this->assertSame($categoryId, $urlRewrite->getEntityId());
        $this->assertSame(CategoryUrlRewriteGenerator::ENTITY_TYPE, $urlRewrite->getEntityType());
        $this->assertSame('category-1.html', $urlRewrite->getRequestPath());
    ...
    public function testUpdate()
    {
        ...
        $this->assertSame("Update Category Test", $category->getName());
        $this->assertSame("Update Category Description Test", $category->getDescription());
        // delete category to clean up auto-generated url rewrites
