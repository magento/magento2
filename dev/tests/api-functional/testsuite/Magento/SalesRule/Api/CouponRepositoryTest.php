...
class CouponRepositoryTest extends WebapiAbstract
{
    ...
    public function testCrud()
    {
        ...
        //test delete
        $this->assertSame(true, $this->deleteCoupon($couponId));
    }
    ...
    public function testGetListWithMultipleFiltersAndSorting()
    {
        ...
        $this->assertSame('autogenerated_3_2', $result['items'][0]['code']);
        $this->assertSame('autogenerated_2_1', $result['items'][1]['code']);
    ...
    public function verifyGetList($couponId)
    {
        ...
        $this->assertSame($couponId, $response['items'][0]['coupon_id']);
