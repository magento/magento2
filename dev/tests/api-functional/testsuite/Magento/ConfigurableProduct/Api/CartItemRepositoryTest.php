...
class CartItemRepositoryTest extends WebapiAbstract
{
    ...
    {
        $this->setExpectedException(\Exception::class, 'You need to choose options for your item.');
    ...
    {
        $this->setExpectedException(\Exception::class, 'The %1 Cart doesn\'t contain the %2 item.');
