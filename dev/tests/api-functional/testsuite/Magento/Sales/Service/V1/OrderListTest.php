...
class OrderListTest extends WebapiAbstract
{
    ...
    public function testOrderList()
    {
        ...
        $this->assertSame('100000002', $result['items'][0]['increment_id']);
        $this->assertSame('100000001', $result['items'][1]['increment_id']);
    }
    ...
    public function testOrderListExtensionAttributes()
    {
        ...
        $this->assertSame($expectedTax['code'], $appliedTaxes[0]['code']);
        $appliedTaxes = $result['items'][0]['extension_attributes']['item_applied_taxes'];
        $this->assertSame($expectedTax['type'], $appliedTaxes[0]['type']);
        $this->assertNotEmpty($appliedTaxes[0]['applied_taxes']);
        $this->assertSame(true, $result['items'][0]['extension_attributes']['converting_from_quote']);
