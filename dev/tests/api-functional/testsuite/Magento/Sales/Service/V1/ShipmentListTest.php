...
class ShipmentListTest extends WebapiAbstract
{
    ...
    public function testShipmentList()
    {
        ...
        $this->assertSame('100000003', $result['items'][1]['increment_id']);
        $this->assertSame(base64_encode('shipping_label_100000002'), $result['items'][0]['shipping_label']);
        $this->assertSame(base64_encode('shipping_label_100000003'), $result['items'][1]['shipping_label']);
    }
}
