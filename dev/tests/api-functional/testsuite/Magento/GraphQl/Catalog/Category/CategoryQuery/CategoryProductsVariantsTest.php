...
QUERY;
        ...
        $product = $this->productRepository->get('simple_10', false, null, true);
        self::assertArrayHasKey('variants', $response['category']['products']['items'][0]);
        self::assertCount(2, $response['category']['products']['items'][0]['variants']);
