...
QUERY;
        ...
        self::assertCount(1, $result['categoryList']);
...
QUERY;
        $result = $this->graphQlQuery($query);
        self::assertArrayNotHasKey('errors', $result);
        self::assertCount(count($expectedResult), $result['categoryList']);
...
QUERY;
        $result = $this->graphQlQuery($query);
        self::assertArrayNotHasKey('errors', $result);
        self::assertCount(3, $result['categoryList']);
...
QUERY;
        $result = $this->graphQlQuery($query);
        self::assertArrayNotHasKey('errors', $result);
        self::assertArrayHasKey('categoryList', $result);
        self::assertEquals([], $result['categoryList']);
    }
...
QUERY;
        ...
        self::assertArrayNotHasKey('errors', $result);
        self::assertArrayHasKey('categoryList', $result);
        self::assertEquals('Default Category', $result['categoryList'][0]['name']);
        self::assertEquals($storeRootCategoryId, $result['categoryList'][0]['id']);
    }
...
QUERY;
        ...
        self::assertEquals($urlPath, $categoryList[0]['url_path']);
        self::assertEquals('Category 1', $categoryList[0]['name']);
    }
...
QUERY;
        ...
        self::assertCount(1, $categoryList);
        self::assertEquals($urlPath, $categoryList[0]['url_path']);
        self::assertEquals('Category 1.1.1', $categoryList[0]['name']);
    }
...
QUERY;
        ...
        self::assertEquals($urlPaths[0], $categoryList[0]['url_path']);
        self::assertEquals('Category 1.1', $categoryList[0]['name']);
        self::assertEquals($urlPaths[2], $categoryList[1]['url_path']);
        self::assertEquals('Movable Position 2', $categoryList[1]['name']);
    }
...
QUERY;
        ...
        self::assertArrayNotHasKey('errors', $response);
        $categoryList = $response['categoryList'];
        self::assertCount(0, $categoryList);
    }
...
QUERY;
        ...
        self::assertArrayNotHasKey('errors', $result);
        self::assertCount(1, $result['categoryList']);
        self::assertEquals($result['categoryList'][0]['name'], 'Category 2');
        self::assertEquals($result['categoryList'][0]['url_path'], 'category-2');
    }
