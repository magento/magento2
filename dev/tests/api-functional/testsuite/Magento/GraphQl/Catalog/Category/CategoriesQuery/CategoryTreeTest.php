...
QUERY;
        ...
        self::assertArrayHasKey('categories', $response);
        ...
        self::assertEquals('default-category', $baseCategory['url_key']);
        self::assertEquals([], $baseCategory['children'][0]['available_sort_by']);
        self::assertEquals('name', $baseCategory['children'][0]['default_sort_by']);
        self::assertCount(7, $baseCategory['children']);
        self::assertCount(2, $baseCategory['children'][0]['children']);
        self::assertEquals(13, $baseCategory['children'][0]['children'][1]['id']);
    }
...
QUERY;
        ...
        self::assertArrayHasKey('categories', $response);
        self::assertArrayHasKey('children', $response['categories']['items'][0]);
        self::assertCount(6, $response['categories']['items'][0]['children']);
    }
...
QUERY;
        $response = $this->graphQlQuery($query);
        self::assertEquals('Category 1.2', $response['categories']['items'][0]['name']);
        self::assertEquals(13, $response['categories']['items'][0]['id']);
    }
...
QUERY;
        $response = $this->graphQlQuery($query);
        self::assertArrayHasKey('items', $response['categories']);
        self::assertEquals([], $response['categories']['items']);
    }
...
QUERY;
        ...
        self::assertArrayHasKey('items', $response['categories']);
        self::assertEquals([], $response['categories']['items']);
        self::assertEquals(0, $response['categories']['total_count']);
    }
...
QUERY;
        $response = $this->graphQlQuery($query);
        self::assertArrayHasKey('products', $response['categories']['items'][0]);
        $baseCategory = $response['categories']['items'][0];
        self::assertArrayHasKey('total_count', $baseCategory['products']);
        self::assertGreaterThanOrEqual(1, $baseCategory['products']['total_count']);
        self::assertEquals(1, $baseCategory['products']['page_info']['current_page']);
        self::assertEquals(20, $baseCategory['products']['page_info']['page_size']);
        self::assertArrayHasKey('sku', $baseCategory['products']['items'][0]);
        ...
        self::assertEquals('Category 1', $firstProduct['categories'][0]['name']);
        self::assertEquals('category-1/category-1-1', $firstProduct['categories'][1]['url_path']);
        self::assertCount(3, $firstProduct['categories']);
    }
...
QUERY;
        ...
        $response = $this->graphQlQuery($query);
        self::assertArrayNotHasKey('errors', $response);
        self::assertNotEmpty($response['categories']);
        ...
        self::assertEquals($categoryId, $categories[0]['id']);
        self::assertEquals('Parent Image Category', $categories[0]['name']);
        $categories[0]['image'] = str_replace('index.php/', '', $categories[0]['image']);
        self::assertEquals($expectedImageUrl, $categories[0]['image']);
