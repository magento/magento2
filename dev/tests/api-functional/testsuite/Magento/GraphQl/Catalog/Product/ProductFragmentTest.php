...
QUERY;
        ...
        self::assertNotEmpty($actualProductData);
        self::assertEquals($name, $actualProductData['name']);
        self::assertEquals($price, $actualProductData['price']['regularPrice']['amount']['value']);
    }
}
