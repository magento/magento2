...
class GroupedProductImageTest extends GraphQlAbstract
{
    private const PARENT_THUMBNAIL_PATH = 'Magento_Catalog/images/product/placeholder/thumbnail.jpg';
    ...
    {
        $thumbnails = [
            'product1' => self::PARENT_THUMBNAIL_PATH,
            'product2' => self::PARENT_THUMBNAIL_PATH
        ];
