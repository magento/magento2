...
/**
 * Bundle product test with multiple options, where option product have custom require options.
 */
class BundleOptionProductRequiredOptionTest extends GraphQlAbstract
{
    /**
    ...
    /**
     * @magentoApiDataFixture Magento/Bundle/_files/product_with_multiple_options_product_with_custom_options.php
