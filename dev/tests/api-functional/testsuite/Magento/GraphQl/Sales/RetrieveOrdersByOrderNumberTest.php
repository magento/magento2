...
QUERY;
    ...
    #[
        ...
        DataFixture(SetBillingAddress::class, ['cart_id' => '$o2$'], 'b2'),
        DataFixture(SetBillingAddress::class, ['cart_id' => '$o3$'], 'b3'),
        DataFixture(SetBillingAddress::class, ['cart_id' => '$o4$'], 'b4'),
        DataFixture(SetBillingAddress::class, ['cart_id' => '$o5$'], 'b5'),
        DataFixture(SetBillingAddress::class, ['cart_id' => '$o6$'], 'b6'),
        DataFixture(SetBillingAddress::class, ['cart_id' => '$o7$'], 'b7'),
        DataFixture(SetBillingAddress::class, ['cart_id' => '$o8$'], 'b8'),
