...
QUERY;
    ...
    #[
        ...
        DataFixture(SetPaymentMethod::class, ['cart_id' => '$cart2.id$', 'method'=> 'checkmo']),
        DataFixture(SetPaymentMethod::class, ['cart_id' => '$cart3.id$', 'method'=> 'checkmo']),
        DataFixture(SetPaymentMethod::class, ['cart_id' => '$cart4.id$', 'method'=> 'checkmo']),
        DataFixture(SetPaymentMethod::class, ['cart_id' => '$cart5.id$', 'method'=> 'checkmo']),
        DataFixture(SetPaymentMethod::class, ['cart_id' => '$cart6.id$', 'method'=> 'checkmo']),
        DataFixture(SetPaymentMethod::class, ['cart_id' => '$cart7.id$', 'method'=> 'checkmo']),
        DataFixture(SetPaymentMethod::class, ['cart_id' => '$cart8.id$', 'method'=> 'checkmo']),
