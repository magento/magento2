...
class CustomerPlaceOrderWithConfigurable
{
    /**
     * @var Client
     */
    ...
    /**
     * Place order for a configurable product
     *
     * @param array $customerLogin
     * @param array $productData
     * @return array
     */
    public function placeOrderWithConfigurableProduct(array $customerLogin, array $productData): array
    {
        $this->customerLogin = $customerLogin;
        $this->createCustomerCart();
        $this->addConfigurableProduct($productData);
...
QUERY;
    ...
    /**
     * Add configurable product with link to the cart
     *
     * @param array $productData
     * @return array
     * @throws \Magento\Framework\Exception\NoSuchEntityException
     */
    private function addConfigurableProduct(array $productData)
    {
        $productSku = $productData['sku'];
        $parentSku = $productData['parent_sku'];
