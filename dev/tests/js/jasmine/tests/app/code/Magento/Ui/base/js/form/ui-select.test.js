...
define(['underscore', 'uiRegistry', 'squire', 'ko'], function(
  _,
  registry,
  Squire,
  ko,
  ...
  describe('Magento_Ui/js/form/element/ui-select', function() {
    ...
    describe('"setCaption" method', function() {
      ...
      it('Check returned value if selected array length more than 1 and options exist', function() {
        ...
        expect(obj.setCaption()).toEqual(
          '2 ' + obj.selectedPlaceholders.lotPlaceholders,
        );
      });
      it('Check returned value if selected array length is 0', function() {
        ...
        expect(obj.setCaption()).toEqual(
          obj.selectedPlaceholders.defaultPlaceholder,
        );
      });
    });
    ...
    describe('"processRequest" method', function() {
      it('Should store options successfully fetched from ajax request', function() {
        ...
        expect(JSON.stringify(obj.options())).toEqual(
