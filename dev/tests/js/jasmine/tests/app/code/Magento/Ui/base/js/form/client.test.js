...
define([
  ...
  describe('Magento_Ui/js/form/client', function() {
    ...
    describe('"save" method', function() {
      ...
      it(
        'Check "beforeSave" method. ' +
          'Check calls "filterFormData", "serialize" and "ajax" inside themselves.',
        function() {
          var data = {
              key: {
                anotherKey: 'value',
      ...
      it('Check call "beforeSave" method. Check "success" ajax callback with error response.', function() {
        var request, notificationArguments;
        ...
        expect($('body').notification.calls.allArgs()).toEqual([
          ['clear'],
          ['add', notificationArguments],
        ]);
      });
