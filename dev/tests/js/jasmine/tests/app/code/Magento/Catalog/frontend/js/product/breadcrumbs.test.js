...
define(['squire', 'jquery', 'jquery/ui'], function(Squire, $) {
  'use strict';
  ...
  describe('Magento_Catalog/js/product/breadcrumbs', function() {
    it('mixin is applied to Magento_Theme/js/view/breadcrumbs', function() {
      var breadcrumbMixins =
        defaultContext.config.config.mixins[
          'Magento_Theme/js/view/breadcrumbs'
        ];

      expect(breadcrumbMixins['Magento_Catalog/js/product/breadcrumbs']).toBe(
        true,
      );
    });
    ...
    describe('Check Magento_Catalog/js/product/breadcrumbs methods', function() {
      ...
      it('Check _appendCatalogCrumbs call', function() {
        ...
        spyOn(widget.prototype, '_resolveCategoryCrumbs').and.returnValues(
          [],
          [categoryCrumb],
        );
        ...
        appendCatalogCrumbsHandler = widget.prototype._appendCatalogCrumbs.bind(
          context,
        );
        appendCatalogCrumbsHandler();
        ...
        expect(
          mocks['Magento_Theme/js/model/breadcrumb-list'].push,
        ).toHaveBeenCalled();
        expect(
          mocks['Magento_Theme/js/model/breadcrumb-list'].push.calls.count(),
        ).toBe(1);
        ...
        expect(
          mocks['Magento_Theme/js/model/breadcrumb-list'].push,
        ).toHaveBeenCalledWith(categoryCrumb);
        expect(
          mocks['Magento_Theme/js/model/breadcrumb-list'].push.calls.count(),
        ).toBe(2);
      });
      ...
      it('Check _getCategoryCrumb call', function() {
        ...
        expect(widget.prototype._getCategoryCrumb(item)).toEqual(
      ...
      it('Check _getProductCrumb call', function() {
        ...
        getProductCrumbHandler = widget.prototype._getProductCrumb.bind(
          context,
        );

        expect(getProductCrumbHandler()).toEqual(
          jasmine.objectContaining({
            name: 'product',
            label: 'simple',
          }),
      ...
      it('Check _resolveCategoryMenuItem call with empty navigation menu', function() {
        var resolveCategoryMenuHandler, context;
        ...
        resolveCategoryMenuHandler = widget.prototype._resolveCategoryMenuItem.bind(
          context,
        );
      ...
      it('Check _resolveCategoryMenuItem call with non-empty navigation menu', function() {
        var result, context, resolveCategoryMenuHandler;
      ...
      it('Check _resolveCategoryCrumbs call with empty navigation menu', function() {
        var result, context, resolveCategoryCrumbsHandler;
        ...
        context = createContext(widget.prototype);
        resolveCategoryCrumbsHandler = widget.prototype._resolveCategoryCrumbs.bind(
          context,
        );
      ...
      it('Check _getParentMenuItem call', function() {
        ...
        context = createContext(widget.prototype);
        getParentMenuHandler = widget.prototype._getParentMenuItem.bind(
          context,
        );
        result = getParentMenuHandler(
          $('[href="http://localhost.com/cat1/cat21.html"]'),
        );
        ...
        result = getParentMenuHandler(
          $('[href="http://localhost.com/cat1.html"]'),
        );
