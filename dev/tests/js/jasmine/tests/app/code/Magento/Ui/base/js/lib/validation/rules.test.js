...
define(['Magento_Ui/js/lib/validation/rules'], function(rules) {
  'use strict';
  ...
  describe('validate-color', function() {
    ...
    it('Should accept rgb(a) value', function() {
      expect(rules['validate-color'].handler('rgb(128, 128, 10)')).toEqual(
        true,
      );
      expect(rules['validate-color'].handler('rgb(255, 0, 57, 0.4)')).toEqual(
        true,
      );
    });
    ...
    it('Should accept hsl(a) value', function() {
      ...
      expect(rules['validate-color'].handler('hsl(40, 75%, 25%)')).toEqual(
        true,
      );
      expect(rules['validate-color'].handler('hsl(50, 25, 50, 50)')).toEqual(
        true,
      );
    });
    ...
    it('Should accept hsv value', function() {
      ...
      expect(rules['validate-color'].handler('hsv(25, 25%, 65%)')).toEqual(
        true,
      );
    });
  });
