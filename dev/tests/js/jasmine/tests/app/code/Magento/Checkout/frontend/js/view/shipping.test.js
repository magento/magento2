...
define(['squire', 'ko', 'jquery', 'uiRegistry', 'jquery/validate'], function(
  Squire,
  ko,
  $,
  registry,
  ...
  var injector = new Squire(),
    ...
    mocks = {
      ...
      'Magento_Checkout/js/action/create-shipping-address': jasmine
        .createSpy()
        .and.returnValue(
      ...
      'Magento_Checkout/js/model/shipping-service': jasmine.createSpyObj(
        'service',
        ['getShippingRates'],
      ),
      ...
      'Magento_Checkout/js/model/step-navigator': jasmine.createSpyObj(
        'navigator',
        ['registerStep'],
      ),
      'Magento_Ui/js/modal/modal': jasmine
        .createSpy('modal')
        .and.returnValue(modalStub),
  ...
  describe('Magento_Checkout/js/view/shipping', function() {
    ...
    describe('"selectShippingMethod" method', function() {
      it('Check method call.', function() {
        ...
        expect(
          mocks['Magento_Checkout/js/checkout-data'].setSelectedShippingRate,
    ...
    describe('"validateShippingInformation" method', function() {
      it('Check method call on negative cases.', function() {
        ...
        registry.set(
          'test.shippingAddress.shipping-address-fieldset.country_id',
          country,
        );
        ...
        spyOn(
          mocks['Magento_Checkout/js/model/quote'],
          'shippingMethod',
        ).and.returnValue(true);
        spyOn(
          mocks['Magento_Customer/js/model/customer'],
          'isLoggedIn',
        ).and.returnValue(true);
        expect(obj.validateShippingInformation()).toBeFalsy();
      });
