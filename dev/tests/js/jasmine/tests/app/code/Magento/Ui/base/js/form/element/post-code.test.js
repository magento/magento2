...
define(['squire'], function(Squire) {
  ...
  describe('Magento_Ui/js/form/element/post-code', function() {
    ...
    beforeEach(function(done) {
      injector.mock(mocks);
      injector.require(
        ['Magento_Ui/js/form/element/post-code', 'knockoutjs/knockout-es5'],
        function(Constr) {
          model = new Constr({
            provider: 'provName',
            name: '',
    ...
    describe('update method', function() {
      it('check for default', function() {
        ...
        spyOn(
          mocks['Magento_Ui/js/lib/registry/registry'],
          'get',
        ).and.returnValue(country);
        model.update(value);
        expect(
          mocks['Magento_Ui/js/lib/registry/registry'].get,
        ).toHaveBeenCalled();
