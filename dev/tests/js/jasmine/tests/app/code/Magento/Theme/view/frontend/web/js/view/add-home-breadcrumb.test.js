...
define(['squire'], function(Squire) {
  ...
  var injector = new Squire(),
    mocks = {
      ...
      'Magento_Theme/js/model/breadcrumb-list': jasmine.createSpyObj([
        'unshift',
      ]),
    };
  ...
  describe('Magento_Theme/js/view/breadcrumbs', function() {
    ...
    it('mixin is applied to Magento_Theme/js/view/breadcrumbs', function() {
      var breadcrumbsMixins =
        defaultContext.config.config.mixins[
          'Magento_Theme/js/view/breadcrumbs'
        ];

      expect(
        breadcrumbsMixins['Magento_Theme/js/view/add-home-breadcrumb'],
      ).toBe(true);
    });
    ...
    it('Magento_Theme/js/model/breadcrumb-list is populated with "Home Page" crumb', function() {
      ...
      expect(
        mocks['Magento_Theme/js/model/breadcrumb-list'].unshift,
