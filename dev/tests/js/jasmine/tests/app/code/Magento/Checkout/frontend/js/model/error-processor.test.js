...
define(['squire'], function(Squire) {
  ...
  describe('Magento_Checkout/js/model/error-processor', function() {
    ...
    beforeEach(function(done) {
      injector.mock(mocks);
      injector.require(['Magento_Checkout/js/model/error-processor'], function(
        processor,
      ) {
        model = processor;
    ...
    describe('Check process method', function() {
      it('check on success response with valid response data', function() {
        var messageObject = {
          ...
          messageContainer = jasmine.createSpyObj('globalMessageList', [
            'addErrorMessage',
          ]);
        ...
        expect(messageContainer.addErrorMessage).toHaveBeenCalledWith(
          messageObject,
        );
      });
