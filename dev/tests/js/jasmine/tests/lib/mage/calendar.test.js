...
define(['jquery', 'jquery/ui', 'mage/calendar'], function($) {
  'use strict';
  ...
  describe('mage/calendar', function() {
    describe('Check calendar', function() {
      ...
      it('With server timezone offset', function() {
        ...
        currentDate.setTime(
          (serverTimezoneSeconds + currentDate.getTimezoneOffset() * 60) * 1000,
        );

        expect($calendar.calendar('getTimezoneDate').toString()).toBe(
