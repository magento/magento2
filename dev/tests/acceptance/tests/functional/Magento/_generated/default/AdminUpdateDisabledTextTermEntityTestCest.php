...
class AdminUpdateDisabledTextTermEntityTestCest
{
	...
	public function _after(AcceptanceTester $I)
	{
		...
		$I->fillField("#agreementGrid_filter_name", "name" . msq("activeHtmlTerm")); // stepKey: fillTermNameFilterOpenTermToDelete
	 ...
	 * @throws \Exception
	 */
	public function AdminUpdateDisabledTextTermEntityTest(AcceptanceTester $I)
	{
		...
		$I->fillField("#name", "name" . msq("disabledTextTerm")); // stepKey: fillFieldConditionNameFillNewTerm
		$I->selectOption("#is_active", "Disabled"); // stepKey: selectOptionIsActiveFillNewTerm
		...
		$I->fillField("#checkbox_text", "test_checkbox" . msq("disabledTextTerm")); // stepKey: fillFieldCheckboxTextFillNewTerm
		$I->fillField("#content", "TestMessage" . msq("disabledTextTerm")); // stepKey: fillFieldContentFillNewTerm
		...
		$I->fillField("#agreementGrid_filter_name", "name" . msq("disabledTextTerm")); // stepKey: fillTermNameFilterOpenUpdateTerm
		...
		$I->fillField("#name", "name" . msq("activeHtmlTerm")); // stepKey: fillFieldConditionNameFillUpdateTerm
		...
		$I->fillField("#checkbox_text", "test_checkbox" . msq("activeHtmlTerm")); // stepKey: fillFieldCheckboxTextFillUpdateTerm
		...
		$I->fillField("#agreementGrid_filter_name", "name" . msq("activeHtmlTerm")); // stepKey: fillTermNameFilterAssertTermInGrid
		...
		$I->see("name" . msq("activeHtmlTerm"), ".data-grid>tbody>tr>td.col-name"); // stepKey: assertTermInGridAssertTermInGrid
		...
		$I->comment("Entering Action Group [assertTermInCheckout] AssertStorefrontTermInCheckoutActionGroup");
		$I->comment("Check if agreement is present on checkout and select it");
		$I->see("test_checkbox" . msq("activeHtmlTerm"), "div.checkout-agreements-block > div > div > div > label > button > span"); // stepKey: seeTermInCheckoutAssertTermInCheckout
		$I->selectOption("div.checkout-agreement.field.choice.required > input", "test_checkbox" . msq("activeHtmlTerm")); // stepKey: checkAgreementAssertTermInCheckout
		...
		$I->comment("Exiting Action Group [assertTermInCheckout] AssertStorefrontTermInCheckoutActionGroup");
