 ...
 */
class Magento_Test_Event_Transaction
{
    /**
     ...
     */
    public function __construct(Magento_Test_EventManager $eventManager)
    {
     ...
     * @return Varien_Db_Adapter_Interface|Magento_Test_Db_Adapter_TransactionInterface
