...
class Mage_Adminhtml_Block_Report_Sales_Shipping_GridTest extends Mage_Backend_Area_TestCase
{
    /**
    ...
    {
        $block = Mage::app()->getLayout()->createBlock('Mage_Adminhtml_Block_Report_Sales_Shipping_Grid');
