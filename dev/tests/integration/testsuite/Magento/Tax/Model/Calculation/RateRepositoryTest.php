...
class RateRepositoryTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->setExpectedException(\Magento\Framework\Exception\NoSuchEntityException::class, 'No such entity with taxRateId = 9999');
    ...
    {
        $this->setExpectedException(\Magento\Framework\Exception\AlreadyExistsException::class, 'Code already exists.');
    ...
    {
        $this->setExpectedException(\Magento\Framework\Exception\InputException::class, 'postcode');
