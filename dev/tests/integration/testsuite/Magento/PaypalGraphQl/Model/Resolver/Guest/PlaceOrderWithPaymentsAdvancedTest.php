 ...
 mutation {
  setPaymentMethodOnCart(input: {
      ...
      payment_method: {
          ...
          additional_data: {
              payflow_link: {
                 cancel_url:"http://mage.test/paypal/payflowadvanced/cancel"
                 return_url:"http://mage.test/paypal/payflowadvanced/return"
                 error_url:"http://mage.test/paypal/payflowadvanced/error"
              }
          }
      }
  }) {    
