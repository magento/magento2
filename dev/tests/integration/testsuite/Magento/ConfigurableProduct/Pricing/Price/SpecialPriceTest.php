...
class SpecialPriceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testPriceInfoIfChildHasSpecialPrice()
    {
        ...
        $this->assertEquals($specialPrice, $finalPrice->getMinimalPrice()->getValue());
    }
    ...
    public function testSortingOfProductsIfChildHasNotSpecialPrice()
    {
        ...
        $this->assertEquals('configurable', $items[0]->getSku());
        $this->assertEquals('simple_77', $items[1]->getSku());
    }
    ...
    public function testSortingOfProductsIfChildHasSpecialPrice()
    {
        ...
        /** @var Product[] $items */
        $items = array_values($collection->getItems());
        $this->assertEquals('simple_77', $items[0]->getSku());
        $this->assertEquals('configurable', $items[1]->getSku());
    }
}
