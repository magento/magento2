...
class CheckoutTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->setExpectedException(\Magento\Framework\Exception\LocalizedException::class, 'You can\'t use the payment type you selected to make payments to the billing country.');
