...
/**
 * Test class for \Magento\PasswordManagement\Block\Adminhtml\Crypt\Key\Form
...
class FormTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testPrepareForm()
    {
        ...
        $block = $objectManager->get('Magento\Framework\View\LayoutInterface')
            ->createBlock('Magento\PasswordManagement\Block\Adminhtml\Crypt\Key\Form');

        $prepareFormMethod = new \ReflectionMethod(
            'Magento\PasswordManagement\Block\Adminhtml\Crypt\Key\Form',
            '_prepareForm'
        );
