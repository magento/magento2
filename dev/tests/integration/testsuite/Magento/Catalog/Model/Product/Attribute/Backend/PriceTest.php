...
class PriceTest extends \PHPUnit\Framework\TestCase
{
    ...
    #[
        ...
        DataFixture(StoreFixture::class, ['store_group_id' => '$store_group2.id$'], 'store2'),
        DataFixture(StoreFixture::class, ['store_group_id' => '$store_group2.id$'], 'store3'),
        DataFixture(AttributeFixture::class, ['frontend_input' => 'price', 'backend_type' => 'decimal', 'is_filterable' => 1], 'attr1'),
        DataFixture(AttributeFixture::class, ['frontend_input' => 'price', 'backend_type' => 'decimal', 'is_filterable' => 1], 'attr2'),
        DataFixture(AttributeFixture::class, ['frontend_input' => 'price', 'backend_type' => 'decimal', 'is_filterable' => 1], 'attr3'),
