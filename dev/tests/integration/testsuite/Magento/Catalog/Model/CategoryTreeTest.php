...
class CategoryTreeTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testMovePosition()
    {
        ...
        $category = $this->loadCategory(9);
        $this->assertSame(1, $category->getPosition(), 'Position must be 1, if $afterCategoryId was null|false|0');
        $category = $this->loadCategory(10);
        $this->assertSame(5, $category->getPosition(), 'Category 10 position must decrease after Category 9 moved');
        $category = $this->loadCategory(11);
        $this->assertSame(6, $category->getPosition(), 'Category 11 position must decrease after Category 9 moved');
        $category = $this->loadCategory(6);
        $this->assertSame(2, $category->getPosition(), 'Category 6 position must be the same');

        //move category 11 to new parent 6 with afterCategoryId = 9
        $category = $this->loadCategory(11);
        $category->move(6, 9);
        $category = $this->loadCategory(11);
        $this->assertSame(2, $category->getPosition(), 'Category 11 position must be after category 9');
        $category = $this->loadCategory(10);
        $this->assertSame(5, $category->getPosition(), 'Category 10 position must be the same');
        $category = $this->loadCategory(9);
        $this->assertSame(1, $category->getPosition(), 'Category 9 position must be 1');
    }

    public function testMove()
    {
        $this->_model->load(7);
        $this->assertSame(2, $this->_model->getParentId());
        $this->_model->move(6, 0);
        /* load is not enough to reset category data */
        $this->_model->setData([]);
        $this->_model->load(7);
        $this->assertSame(6, $this->_model->getParentId());
    }
    ...
    public function testGetUrlPath()
    {
        ...
        $this->_model->load(4);
        $this->assertSame('category-1/category-1-1', $this->_model->getUrlPath());
    }

    public function testGetParentId()
    {
        $this->assertSame(0, $this->_model->getParentId());
        $this->_model->unsetData();
        $this->_model->load(4);
        $this->assertSame(3, $this->_model->getParentId());
    }

    public function testGetParentIds()
    {
        $this->assertSame([], $this->_model->getParentIds());
        $this->_model->unsetData();
        $this->_model->load(4);
    ...
    {
        $this->_model->load(3);
        $this->assertSame(array_diff([4, 13], explode(',', $this->_model->getChildren())), []);
    }
    ...
    public function testGetChildrenSorted()
    {
        ...
        sort($unsorted);
        $this->assertSame(array_diff($unsorted, explode(',', $this->_model->getChildren(true, true, true))), []);
    }

    public function testGetPathInStore()
    {
        $this->_model->load(5);
        $this->assertSame('5,4,3', $this->_model->getPathInStore());
    }

    public function testGetAllChildren()
    {
        $this->_model->load(4);
        $this->assertSame('4,5', $this->_model->getAllChildren());
        $this->_model->load(5);
        $this->assertSame('5', $this->_model->getAllChildren());
    }

    public function testGetPathIds()
    {
        $this->assertSame([''], $this->_model->getPathIds());
        $this->_model->setPathIds([1]);
        $this->assertSame([1], $this->_model->getPathIds());

        $this->_model->unsetData();
        $this->_model->setPath('1/2/3');
        $this->assertSame([1, 2, 3], $this->_model->getPathIds());
    }

    public function testGetLevel()
    {
        $this->assertSame(0, $this->_model->getLevel());
        $this->_model->setData('level', 1);
        $this->assertSame(1, $this->_model->getLevel());
    }
    ...
    public function testGetParentCategories()
    {
        ...
        $this->assertSame(3, count($parents));
    }
    ...
    public function testGetParentCategoriesEmpty()
    {
        $this->_model->load(1);
        $parents = $this->_model->getParentCategories();
        $this->assertSame(0, count($parents));
    }
    ...
    public function testGetParentDesignCategory()
    {
        ...
        $this->assertSame(5, $parent->getId());
    }
