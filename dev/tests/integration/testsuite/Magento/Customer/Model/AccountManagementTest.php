...
class AccountManagementTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * Assign default groupId based on user session and admin resource authorization
     *
    ...
    {
        return [
            [// active session but not authorized with admin resource
                true, //active session
                [
                    'websiteId' => 1,
