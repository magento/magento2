...
class SynonymGroupTest extends \PHPUnit_Framework_TestCase
{
    public function testGetByScope()
    {
        ...
        $synonymGroupModel1 = $objectManager->create('Magento\Search\Model\SynonymGroup');
        ...
        $synonymGroupModel2 = $objectManager->create('Magento\Search\Model\SynonymGroup');
        ...
        $synonymGroupModel3 = $objectManager->create('Magento\Search\Model\SynonymGroup');
        ...
        $synonymGroupModel4 = $objectManager->create('Magento\Search\Model\SynonymGroup');
        ...
        $resourceModel = $objectManager->create('Magento\Search\Model\ResourceModel\SynonymGroup');
        $this->assertEquals(
