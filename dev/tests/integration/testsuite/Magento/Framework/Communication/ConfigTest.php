...
class ConfigTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->setExpectedException(\LogicException::class, 'Service method specified in the definition of topic "customerDeletedNumbers" is not av');
    ...
    {
        $this->setExpectedException(\Magento\Framework\Exception\LocalizedException::class, 'Topic "invalidTopic" is not configured.');
    ...
    {
        $this->setExpectedException(\LogicException::class, 'Either "request" or "schema" attribute must be specified for topic "customerUpdated"');
    ...
    {
        $this->setExpectedException(\LogicException::class, 'Service method specified in the definition of topic "customerRetrieved" is not');
    ...
    {
        $this->setExpectedException(\LogicException::class, 'Either "request" or "schema" attribute must be specified for topic "customerRetrieved"');
    ...
    {
        $this->setExpectedException(\LogicException::class, 'Response schema definition for topic "customerUpdated" should reference existing');
    ...
    {
        $this->setExpectedException(\LogicException::class, 'Request schema definition for topic "customerUpdated" should reference existing');
    ...
    {
        $this->setExpectedException(\LogicException::class, 'Topic "customerDeleted" is configured for synchronous requests, that is why it must');
    ...
    {
        $this->setExpectedException(\LogicException::class, 'Service method specified in the definition of handler "customHandler" for topic "custo');
    ...
    {
        $this->setExpectedException(\LogicException::class, 'Topic name "customerAdded" and attribute "name" = "customerCreated" must be equal');
    ...
    {
        $this->setExpectedException(\LogicException::class, 'Topic "customerCreated" must contain data');
    ...
    {
        $this->setExpectedException(\LogicException::class, 'Topic "customerCreated" has missed keys: [response]');
    ...
    {
        $this->setExpectedException(\LogicException::class, 'Topic "customerCreated" has excessive keys: [some_incorrect_key]');
    ...
    {
        $this->setExpectedException(\LogicException::class, 'Topic name "customerDeleted" and attribute "name" = "customerRemoved" must be equal');
    ...
    {
        $this->setExpectedException(\LogicException::class, 'Request schema definition for topic "customerCreated" should reference existing service');
    ...
    {
        $this->setExpectedException(\LogicException::class, 'Response schema definition for topic "customerCreated" should reference existing type o');
    ...
    {
        $this->setExpectedException(\LogicException::class, 'Service method specified in the definition of handler "customerCreatedFirst" for topic');
    ...
    {
        $this->setExpectedException(\LogicException::class, 'Disabled handler "default" for topic "customerCreated" cannot be added to the config fi');
    ...
    {
        $this->setExpectedException(\LogicException::class, 'Request schema type for topic "customerCreated" must be "object_interface" or "service_');
    ...
    {
        $this->setExpectedException(\LogicException::class, 'The attribute "is_synchronous" for topic "customerCreated" should have the value of the');
