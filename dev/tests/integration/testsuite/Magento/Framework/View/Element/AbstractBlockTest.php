...
class AbstractBlockTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testSetGetUnsetChild()
    {
        ...
        $this->assertStringContainsString($nameOne, $parent->getChildNames());
    ...
    public function testInsertBlockWithoutName()
    {
        ...
        $this->assertStringContainsString('abstractblockmock_0', $parent->getChildNames());
    }
    ...
    public function testInsertBlockWithAlias()
    {
        ...
        $this->assertStringContainsString('block_name', $parent->getChildNames());
    ...
    public function testInsertWithSibling()
    {
        ...
        $this->assertStringContainsString($name1, $parent->getChildNames());
    ...
    public function testAddToParentGroup()
    {
        ...
        $this->assertStringContainsString('block1', $group);
        $this->assertStringContainsString('block2', $group);
