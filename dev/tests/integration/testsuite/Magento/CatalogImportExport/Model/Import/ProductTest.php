...
class ProductTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSaveProductsVisibility()
    {
        ...
        $this->assertTrue($this->_model->getErrorsCount() == 0);
     ...
     * @return array
     */
    protected function getActualOptionsData(\Magento\Catalog\Model\Resource\Product\Option\Collection $options)
    {
        $actualOptionId = 0;
        $actualOptions = [];
        // array of type and title types, key is element ID
    ...
    public function testInvalidSkuLink()
    {
        ...
        $this->assertTrue($this->_model->getErrorsCount() == 1);
        ...
        $this->assertArrayHasKey("simple1", $products, "Simple Product should not have been imported");
        $this->assertArrayHasKey("simple3", $products, "Simple Product 3 should not have been imported");
