...
(
    ...
    'section_id_not_unique' => array(
        ...
        array("Element 'section': Duplicate key-sequence ['section1'] ".
    ...
    'field_element_id_not_expected' => array(
        ...
        array("Element 'field': This element is not expected. Expected is one of ( label, class, tab, header_css, "
        . "resource, group ).")),
    ...
    'id_minimum length' => array(
        ...
        array("Element 'section', attribute 'id': [facet 'minLength'] The value 's' has a length of '1'; this "
        . "underruns the allowed minimum length of '2'.", "Element 'section', attribute 'id': 's' is not a valid value "
        . "of the atomic type 'typeId'.", "Element 'section', attribute 'id': Warning: No precomputed "
        . "value available, the value was either invalid or something strange happend.", "Element 'field', attribute "
        . "'id': [facet 'minLength'] The value 'f' has a length of '1'; this underruns the allowed minimum length "
        . "of '2'.", "Element 'field', attribute 'id': 'f' is not a valid value of the atomic type 'typeId'.", "Element"
        . " 'field', attribute 'id': Warning: No precomputed value available, the value was either invalid or something"
        . " strange happend.", "Element 'tab', attribute 'id': [facet 'minLength'] The value 'h' has a length of '1'; "
        . "this underruns the allowed minimum length of '2'.", "Element 'tab', attribute 'id': 'h' is not a valid value"
        . " of the atomic type 'typeId'.", "Element 'tab', attribute 'id': Warning: No precomputed value available, "
    ...
    'source_model_with_invalid_type' => array(
        ...
        . '</field></group>' .
        '<group id="group2"><label>Label_One</label></group></section></system></config>',
        array("Element 'source_model': [facet 'minLength'] The value has a length of '4'; this underruns the allowed "
        . "minimum length of '5'.", "Element 'source_model': 'Sour' is not a valid value of the atomic"
        . " type 'typeModel'.")),
    'base_url_with_invalid_type' => array(
        ...
        . '<group id="group2"><label>Label_One</label></group></section></system></config>',
        array("Element 'resource': [facet 'minLength'] The value has a length of '4'; this underruns the allowed "
        . "minimum length of '8'.", "Element 'resource': [facet 'pattern'] The value 'One:' is not accepted by the "
        . "pattern '[A-Z]+[a-z0-9]{1,}_[A-Z]+[A-Z0-9a-z]{1,}::[A-Za-z_0-9]{1,}'.", "Element 'resource': 'One:' is not "
        . "a valid value of the atomic type 'typeAclResourceId'.")),
    ...
    'section_with_only_one_allowed_element' => array(
        ...
        array("Element 'section': Missing child element(s). Expected is one of ( label, class, tab, header_css, "
        . "resource, group ).")),
    ...
    'config_without_required_attributes' => array(
        ...
        . '</config>',
        array("Element 'section': The attribute 'id' is required but missing.", "Element 'group': The attribute 'id' "
        . "is required but missing.", "Element 'attribute': The attribute 'type' is "
        . "required but missing.", "Element 'field': The attribute 'id' is required but missing.", "Element "
        . "'field': The attribute 'id' is required but missing.", "Element 'option': The attribute 'label' is "
        . "required but missing.", "Element 'tab': The attribute 'id' is required but missing.")
    ),
    'attribute_type_is_unique' => array(
        ...
        . '</config>',
        array("Element 'attribute': Duplicate key-sequence ['one'] in unique identity-constraint "
        . "'uniqueAttributeType'.")
    ),
);
