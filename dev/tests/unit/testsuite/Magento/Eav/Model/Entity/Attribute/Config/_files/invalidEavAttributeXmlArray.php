...
return array(
    ...
    'field_code_must_be_unique' => array(
        ...
        array("Element 'field': Duplicate key-sequence ['code_one_one'] in unique identity-constraint "
        . "'uniqueFieldCode'.")),
    ...
    'field_node_without_required_attributes' => array(
        ...
        array("Element 'field': The attribute 'locked' is required but missing.", "Element 'field': The attribute "
        . "'code' is required but missing.")),
    'locked_attribute_with_invalid_value' => array(
        ...
        array("Element 'field', attribute 'locked': '7' is not a valid value of the atomic type 'xs:boolean'.",
    ...
    'attribute_with_type_identifierType_with_invalid_value' => array(
        ...
        array("Element 'entity', attribute 'type': [facet 'pattern'] The value 'Name' is not accepted by the pattern "
        . "'[a-z_]+'.", "Element 'entity', attribute 'type': 'Name' is not a valid value of the atomic type "
        . "'identifierType'.", "Element 'entity', attribute 'type': Warning: No precomputed value available, the value"
        . " was either invalid or something strange happend.", "Element 'attribute', attribute 'code': [facet "
        . "'pattern'] The value 'code1' is not accepted by the pattern '[a-z_]+'.", "Element 'attribute', attribute "
        . "'code': 'code1' is not a valid value of the atomic type 'identifierType'.", "Element 'attribute', attribute "
        ...
        . "[a-z_]+'.", "Element 'field', attribute 'code': 'code::one' is not a valid value of the atomic type "
        . "'identifierType'.", "Element 'field', attribute 'code': Warning: No precomputed value available, the value "
