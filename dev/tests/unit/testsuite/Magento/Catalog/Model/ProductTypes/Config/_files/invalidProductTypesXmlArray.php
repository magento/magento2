...
(
    ...
    'type_indexpriority_invalid_value' => array(
        ...
        array("Element 'type', attribute 'indexPriority': '-1' is not a valid value of the atomic "
    ...
    'type_canuseqtydecimals_invalid_value' => array(
        ...
        array("Element 'type', attribute 'canUseQtyDecimals': 'string' is not a valid value of the atomic".
            " type 'xs:boolean'.")),
