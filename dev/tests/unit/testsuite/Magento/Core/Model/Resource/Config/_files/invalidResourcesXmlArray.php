...
return array
    ...
    'resource_name_attribute_invalid_value' => array(
        ...
        array("Element 'resource', attribute 'name': [facet 'pattern'] The value 'testinvalidname1' is not accepted"
    ...
    'resource_extends_attribute_invalid_value' => array(
        ...
        array("Element 'resource', attribute 'extends': [facet 'pattern'] The value 'test1' is not accepted "
            . "by the pattern '[A-Za-z_]+'.",
    ...
    'resource_connection_attribute_invalid_value' => array(
        ...
        array("Element 'resource', attribute 'connection': [facet 'pattern'] The value 'test1' is not accepted "
            . "by the pattern '[A-Za-z_]+'.",
    ...
    'resource_with_same_name_value' => array(
        ...
        array("Element 'resource': Duplicate key-sequence ['test_name'] in unique "
