...
class ObserverTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->collectionFactory = $this->getMock('Magento\GoogleShopping\Model\Resource\Item\CollectionFactory', [], [], '', false);
        $this->massOperationsFactory = $this->getMock('Magento\GoogleShopping\Model\MassOperationsFactory', [], [], '', false);
