...
(
    ...
    'disabled_attribute_wrong_type_value' => array(
        ...
        array("Element 'resource', attribute 'disabled': 'notBool' is not a valid value of the atomic type "
            . "'xs:boolean'.")),
    'double_acl' => array(
    ...
    'less_minLength_title_attribute' => array(
        ...
        array("Element 'resource', attribute 'title': [facet 'minLength'] The value 'Sh' has a length of '2'; "
    ...
    'more_maxLength_title_attribute' => array(
        ...
        array("Element 'resource', attribute 'title': [facet 'maxLength'] The value 'Lorem ipsum dolor sit amet, "
    ...
    'notvalid_id_attribute_value_regexp1' => array(
        ...
        array("Element 'resource', attribute 'id': [facet 'pattern'] The value 'test_Value::show_toolbar' is "
    ...
    'notvalid_id_attribute_value_regexp2' => array(
        '<?xml version="1.0"?><config><acl><resources><resource id="Test_value::show_toolbar"/>'
            . '</resources></acl></config>',
        array("Element 'resource', attribute 'id': [facet 'pattern'] The value 'Test_value::show_toolbar' is not "
    ...
    'notvalid_id_attribute_value_regexp3' => array(
        '<?xml version="1.0"?><config><acl><resources><resource id="M@#$%^*_Value::show_toolbar"/>'
            . '</resources></acl></config>',
        array("Element 'resource', attribute 'id': [facet 'pattern'] The value 'M@#$%^*_Value::show_toolbar' is not "
            . "accepted by the pattern '[A-Z]+[a-z0-9]{1,}_[A-Z]+[A-Z0-9a-z]{1,}::[A-Za-z_0-9]{1,}'.",
    ...
    'notvalid_id_attribute_value_regexp4' => array(
        '<?xml version="1.0"?><config><acl><resources><resource id="_Value::show_toolbar"/>'
            . '</resources></acl></config>',
        array("Element 'resource', attribute 'id': [facet 'pattern'] The value '_Value::show_toolbar' is not "
            . "accepted by the pattern '[A-Z]+[a-z0-9]{1,}_[A-Z]+[A-Z0-9a-z]{1,}::[A-Za-z_0-9]{1,}'.",
    ...
    'notvalid_id_attribute_value_regexp5' => array(
        '<?xml version="1.0"?><config><acl><resources><resource id="Value_::show_toolbar"/></resources>'
            . '</acl></config>',
        array("Element 'resource', attribute 'id': [facet 'pattern'] The value 'Value_::show_toolbar' is not "
            . "accepted by the pattern '[A-Z]+[a-z0-9]{1,}_[A-Z]+[A-Z0-9a-z]{1,}::[A-Za-z_0-9]{1,}'.",
    ...
    'notvalid_id_attribute_value_regexp7' => array(
        '<?xml version="1.0"?><config><acl><resources><resource id="Test_Value::"/></resources>'
            . '</acl></config>',
        array("Element 'resource', attribute 'id': [facet 'pattern'] The value 'Test_Value::' is not accepted by "
    ...
    'sortOrder_attribute_empty_value' => array(
        ...
        array("Element 'resource', attribute 'sortOrder': 'stringValue' is not a valid value of the atomic "
            ."type 'xs:int'.")),
    ...
    'with_two_same_id' => array(
        '<?xml version="1.0"?><config><acl><resources><resource id="Test_Value::show_toolbar" '
            ...
            '</resources></acl></config>',
        array("Element 'resource': Duplicate key-sequence ['Test_Value::show_toolbar'] in unique identity-constraint "
            . "'uniqueResourceId'.")),
    'without_acl' => array(
