...
/**
 * Test class for Mage_ImportExport_Model_Import_Entity_V2_Eav_Customer
 */
class Mage_ImportExport_Model_Import_Entity_V2_Eav_CustomerTest extends PHPUnit_Framework_TestCase
{
    ...
    protected $_inputRows = array(
        'create' => array(
            Mage_ImportExport_Model_Import_Entity_V2_Eav_Customer::COLUMN_ACTION  => 'create',
            Mage_ImportExport_Model_Import_Entity_V2_Eav_Customer::COLUMN_EMAIL   => 'create@email.com',
            Mage_ImportExport_Model_Import_Entity_V2_Eav_Customer::COLUMN_WEBSITE => 'website1',
        ),
        'update' => array(
            Mage_ImportExport_Model_Import_Entity_V2_Eav_Customer::COLUMN_ACTION  => 'update',
            Mage_ImportExport_Model_Import_Entity_V2_Eav_Customer::COLUMN_EMAIL   => 'update@email.com',
            Mage_ImportExport_Model_Import_Entity_V2_Eav_Customer::COLUMN_WEBSITE => 'website1',
        ),
        'delete' => array(
            Mage_ImportExport_Model_Import_Entity_V2_Eav_Customer::COLUMN_ACTION
                => Mage_ImportExport_Model_Import_Entity_V2_Eav_Customer::COLUMN_ACTION_VALUE_DELETE,
            Mage_ImportExport_Model_Import_Entity_V2_Eav_Customer::COLUMN_EMAIL   => 'delete@email.com',
            Mage_ImportExport_Model_Import_Entity_V2_Eav_Customer::COLUMN_WEBSITE => 'website1',
        ),
    );
     ...
     *
     * @return Mage_ImportExport_Model_Import_Entity_V2_Eav_Customer|PHPUnit_Framework_MockObject_MockObject
     */
    protected function _getModelMockForTestImportDataWithCustomBehaviour()
    {
        // entity adapter mock
        $modelMock = $this->getMock(
            'Mage_ImportExport_Model_Import_Entity_V2_Eav_Customer',
            array(
                'validateRow',
                '_getCustomerId',
    ...
    public function prepareForUpdateMock(array $rowData)
    {
        $preparedResult = array(
            Mage_ImportExport_Model_Import_Entity_V2_Eav_Customer::ENTITIES_TO_CREATE_KEY => array(),
            Mage_ImportExport_Model_Import_Entity_V2_Eav_Customer::ENTITIES_TO_UPDATE_KEY => array(),
            Mage_ImportExport_Model_Import_Entity_V2_Eav_Customer::ATTRIBUTES_TO_SAVE_KEY => array('table' => array())
        );

        $actionColumnKey = Mage_ImportExport_Model_Import_Entity_V2_Eav_Customer::COLUMN_ACTION;
        if ($rowData[$actionColumnKey] == 'create') {
            $preparedResult[Mage_ImportExport_Model_Import_Entity_V2_Eav_Customer::ENTITIES_TO_CREATE_KEY] = array(
                array('entity_id' => $this->_customerIds['create'])
            );
        } elseif ($rowData[$actionColumnKey] == 'update') {
            $preparedResult[Mage_ImportExport_Model_Import_Entity_V2_Eav_Customer::ENTITIES_TO_UPDATE_KEY] = array(
