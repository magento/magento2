...
/**
 * Test class for Mage_ImportExport_Model_Import_Entity_Eav_CustomerAbstract
 *
 * @todo fix in the scope of https://wiki.magento.com/display/MAGE2/Technical+Debt+%28Team-Donetsk-B%29
 */
class Mage_ImportExport_Model_Import_Entity_Eav_CustomerAbstractTest extends PHPUnit_Framework_TestCase
{
    /**
     * Abstract customer export model
     *
     * @var Mage_ImportExport_Model_Import_Entity_Eav_CustomerAbstract|PHPUnit_Framework_MockObject_MockObject
     */
    protected $_model;
     ...
     *
     * @return Mage_ImportExport_Model_Import_Entity_Eav_CustomerAbstract|PHPUnit_Framework_MockObject_MockObject
     */
    ...
    public function checkUniqueKeyDataProvider()
    {
        return array(
            ...
            'no website' => array(
                ...
                '$errors' => array(
                    Mage_ImportExport_Model_Import_Entity_Eav_CustomerAbstract::ERROR_WEBSITE_IS_EMPTY => array(
                        array(1, Mage_ImportExport_Model_Import_Entity_Eav_CustomerAbstract::COLUMN_WEBSITE)
                    )
                ),
            ),
            'empty website' => array(
            ...
            'no email' => array(
                ...
                '$errors' => array(
                    Mage_ImportExport_Model_Import_Entity_Eav_CustomerAbstract::ERROR_EMAIL_IS_EMPTY => array(
                        array(1, Mage_ImportExport_Model_Import_Entity_Eav_CustomerAbstract::COLUMN_EMAIL)
                    )
                ),
            ),
            'empty email' => array(
            ...
            'invalid email' => array(
                ...
                '$errors' => array(
                    Mage_ImportExport_Model_Import_Entity_Eav_CustomerAbstract::ERROR_INVALID_EMAIL => array(
                        array(1, Mage_ImportExport_Model_Import_Entity_Eav_CustomerAbstract::COLUMN_EMAIL)
                    )
                ),
            ),
            'invalid website' => array(
                ...
                '$errors' => array(
                    Mage_ImportExport_Model_Import_Entity_Eav_CustomerAbstract::ERROR_INVALID_WEBSITE => array(
                        array(1, Mage_ImportExport_Model_Import_Entity_Eav_CustomerAbstract::COLUMN_WEBSITE)
                    )
                ),
            ),
    ...
    /**
     * Test Mage_ImportExport_Model_Import_Entity_Eav_CustomerAbstract::_checkUniqueKey() with different values
     *
     * @covers Mage_ImportExport_Model_Import_Entity_Eav_CustomerAbstract::_checkUniqueKey
    ...
    public function testCheckUniqueKey(array $rowData, array $errors, $isValid = false)
    {
        $checkUniqueKey = new ReflectionMethod(
            'Mage_ImportExport_Model_Import_Entity_Eav_CustomerAbstract',
            '_checkUniqueKey'
        );
    ...
    /**
     * Test for Mage_ImportExport_Model_Import_Entity_Eav_CustomerAbstract::validateRow for add/update action
     *
