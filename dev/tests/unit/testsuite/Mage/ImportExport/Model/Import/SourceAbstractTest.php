 ...
 */
class Mage_ImportExport_Model_Import_SourceAbstractTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Mage_ImportExport_Model_Import_SourceAbstract|PHPUnit_Framework_MockObject_MockObject
     */
    protected $_model = null;

    protected function setUp()
    {
        $this->_model = $this->getMockForAbstractClass('Mage_ImportExport_Model_Import_SourceAbstract', array(array(
            'key1', 'key2', 'key3'
        )));
    }
    ...
    {
        $this->getMockForAbstractClass('Mage_ImportExport_Model_Import_SourceAbstract', array($argument));
    }
