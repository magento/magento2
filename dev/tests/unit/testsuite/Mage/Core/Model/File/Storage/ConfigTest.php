 ...
 */
class Mage_Core_Model_File_Storage_ConfigTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Mage_Core_Model_File_Storage_Config
     */
    protected $_model;
    ...
    {
        $this->_fileStorageMock = $this->getMock('Mage_Core_Model_File_Storage', array(), array(), '', false);
        ...
        $this->_model = new Mage_Core_Model_File_Storage_Config(
            $this->_fileStorageMock,
            $this->_streamFactoryMock,
            'cacheFile'
        );
