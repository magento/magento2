...
class Mage_Core_Model_Design_Fallback_FactoryTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public function setUp()
    {
        ...
        $this->_model = new Mage_Core_Model_Design_Fallback_Factory($dirs);
    ...
    public function testCreateLocaleFileRule()
    {
        ...
        $this->assertInstanceOf('Mage_Core_Model_Design_Fallback_Rule_RuleInterface', $actualResult);
