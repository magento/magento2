...
class Mage_Core_Model_Design_Fallback_Rule_ModularSwitchTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Mage_Core_Model_Design_Fallback_Rule_ModularSwitch
     */
    protected $_object;
    ...
    {
        $this->_ruleNonModular = $this->getMockForAbstractClass('Mage_Core_Model_Design_Fallback_Rule_RuleInterface');
        $this->_ruleModular = $this->getMockForAbstractClass('Mage_Core_Model_Design_Fallback_Rule_RuleInterface');
        $this->_object = new Mage_Core_Model_Design_Fallback_Rule_ModularSwitch(
