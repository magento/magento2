 ...
 */
class Mage_GoogleAdwords_Model_ObserverTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    /**
     * @var Mage_GoogleAdwords_Model_Observer
     */
    protected $_model;
    ...
    public function testSetConversionValueWhenAdwordsActiveWithOrdersIds()
    {
        ...
        $this->_registryMock->expects($this->once())->method('register')
            ->with(Mage_GoogleAdwords_Helper_Data::CONVERSION_VALUE_REGISTRY_NAME, $conversionValue);
