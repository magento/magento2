...
class Mage_Backend_Model_Config_Structure_Mapper_ExtendsTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Mage_Backend_Model_Config_Structure_Mapper_Extends
     */
    protected $_sut;

    public function setUp()
    {
        $this->_sut = new Mage_Backend_Model_Config_Structure_Mapper_Extends(
