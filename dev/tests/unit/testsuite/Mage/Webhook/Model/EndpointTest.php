...
class Mage_Webhook_Model_EndpointTest extends PHPUnit_Framework_TestCase
{
    ...
    /** @var PHPUnit_Framework_MockObject_MockObject|Mage_Webhook_Model_Endpoint */
    protected $_endpoint;
    ...
    {
        $this->_mockResourceEndpnt = $this->getMockBuilder('Mage_Webhook_Model_Resource_Endpoint')
    ...
    public function testGetters()
    {
        ...
        $mockWebhookUser = $this->getMockBuilder('Mage_Webhook_Model_User')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->_endpoint = $this->getMockBuilder('Mage_Webhook_Model_Endpoint')
            ->setConstructorArgs(
