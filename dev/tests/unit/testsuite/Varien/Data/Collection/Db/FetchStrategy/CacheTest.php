...
class Varien_Data_Collection_Db_FetchStrategy_CacheTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Varien_Data_Collection_Db_FetchStrategy_Cache
     */
    private $_object;
    ...
    protected function setUp()
    {
        ...
        $this->_fetchStrategy = $this->getMockForAbstractClass('Varien_Data_Collection_Db_FetchStrategyInterface');

        $this->_object = new Varien_Data_Collection_Db_FetchStrategy_Cache(
