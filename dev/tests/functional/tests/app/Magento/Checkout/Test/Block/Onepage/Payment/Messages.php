...
/**
 * Onepage checkout messages block.
 */
class Messages extends Block
{
     ...
     * @var string
     */
    private $lastSuccessMessage = '[data-ui-id$=message-success]:last-child';
     ...
     * @var string
     */
    private $messageLink = "//a[contains(.,'%s')]";
     ...
     * @var string
     */
    private $noticeMessage = '[data-ui-id$=message-notice]';
     ...
     * @var string
     */
    private $warningMessage = '[data-ui-id$=message-warning]';
